// ENGINE_MERGE_PLAN.md Phase 0.5 gap #7 — a per-resource-unit-consumed damage scalar. Denia's Dark Core
...
describe('per-resource-consumed scalar (ENGINE_MERGE_PLAN.md Phase 0.5 gap #7)', () => {
