...
// engine/dotReactions.js's resolveDotReactionDps instead of calling calcFrazzleDmg/calcErosionDmg/
...
describe('calcTeamStats — DOT wiring via dotReactions.js (Stage 4 step 3)', () => {
  ...
  it('a team with no DOT-applying members reports zero DOT contribution and no flags set', () => {
