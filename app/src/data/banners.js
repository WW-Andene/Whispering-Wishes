...
const OTHER_BACKGROUNDS = [
  ...
  { id: '1-2-moon-chasing-festival', name: '1.2 Moon Chasing Festival @mafuin_da', art: 'https://i.ibb.co/RpGJqyZ8/1-2-Moon-Chasing-Festival.jpg', pos: { header: '50% 30%', nav: '50% 30%', bg: '50% 50%' } },
  { id: '1st-anniv-festival-akihabara', name: '1st Anniv Festival Akihabara', art: 'https://i.ibb.co/F42TkkHd/1st-Anniv-Festival-Akihabara.jpg', pos: { header: '50% 10%', nav: '50% 12%', bg: '50% 50%' } },
  { id: '2nd-anniv', name: '2nd Anniv', art: 'https://i.ibb.co/jZsNnRMr/2nd-Anniv.jpg', pos: { header: '50% 44%', nav: '50% 40%', bg: '50% 50%' } },
  { id: '3-3-star-bouncing-event', name: '3.3 Star Bouncing Event', art: 'https://i.ibb.co/cKPbbBP0/3-3-Star-Bouncing-Event.jpg', pos: { header: '50% 34%', nav: '50% 30%', bg: '50% 50%' } },
  { id: 'augusta-iuno-mooncake-collab', name: 'Augusta Iuno Mooncake Collab', art: 'https://i.ibb.co/G4ybQ1C3/Augusta-Iuno-Mooncake-Collab.jpg', pos: { header: '50% 16%', nav: '50% 16%', bg: '50% 50%' } },
  { id: 'augusta-iuno', name: 'Augusta Iuno', art: 'https://i.ibb.co/rD2tj0n/Augusta-Iuno.jpg', pos: { header: '50% 30%', nav: '50% 74%', bg: '50% 50%' } },
  { id: 'brant-phoebe-rover', name: 'Brant Phoebe Rover', art: 'https://i.ibb.co/pHpKGmv/Brant-Phoebe-Rover.jpg', pos: { header: '50% 50%', nav: '50% 50%', bg: '50% 50%' } },
  { id: 'brant-roccia-liyuliyuzhou', name: 'Brant Roccia @liyuliyuzhou', art: 'https://i.ibb.co/Tqr1rS8p/Brant-Roccia-liyuliyuzhou.jpg', pos: { header: '50% 20%', nav: '50% 26%', bg: '50% 50%' } },
  { id: 'brant-roccia-chibi', name: 'Brant Roccia Chibi', art: 'https://i.ibb.co/8Q2gf5C/Brant-Roccia-Chibi.jpg', pos: { header: '50% 52%', nav: '50% 46%', bg: '50% 50%' } },
  { id: 'brant-roccia-sweets-paradise', name: 'Brant Roccia Sweets Paradise', art: 'https://i.ibb.co/9H7XDQ95/Brant-Roccia-Sweets-Paradise.jpg', pos: { header: '50% 20%', nav: '50% 20%', bg: '50% 50%' } },
  { id: 'camellya-shorekeeper-christmas', name: 'Camellya Shorekeeper Christmas', art: 'https://i.ibb.co/LD8FBskH/Camellya-Shorekeeper-Christmas.jpg', pos: { header: '50% 44%', nav: '50% 48%', bg: '50% 50%' } },
  { id: 'cantarella-shorekeeper-korean-collab', name: 'Cantarella Shorekeeper Korean Collab', art: 'https://i.ibb.co/cXMYHSfc/Cantarella-Shorekeeper-Korean-Collab.jpg', pos: { header: '50% 20%', nav: '50% 34%', bg: '50% 50%' } },
  { id: 'carlotta-changli-chisa-lynae-beach', name: 'Carlotta Changli Chisa Lynae Beach', art: 'https://i.ibb.co/F40fkS0h/Carlotta-Changli-Chisa-Lynae-Beach.jpg', pos: { header: '50% 28%', nav: '50% 28%', bg: '50% 50%' } },
  { id: 'carlotta-roccia-brant-phoebe-zani-mafuinda', name: 'Carlotta Roccia Brant Phoebe Zani @mafuin_da', art: 'https://i.ibb.co/39RTN21t/Carlotta-Roccia-Brant-Phoebe-Zani-mafuin-da.jpg', pos: { header: '50% 30%', nav: '50% 30%', bg: '50% 50%' } },
  { id: 'carlotta-zani-montelli-family', name: 'Carlotta Zani Montelli Family', art: 'https://i.ibb.co/fYxMMjPt/Carlotta-Zani-Montelli-Family.jpg', pos: { header: '50% 8%', nav: '50% 6%', bg: '50% 50%' } },
  { id: 'chisa-galbrena-coco-collab', name: 'Chisa Galbrena Coco Collab', art: 'https://i.ibb.co/ZpXZQkQn/Chisa-Galbrena-Coco-Collab.jpg', pos: { header: '50% 20%', nav: '50% 22%', bg: '50% 50%' } },
  { id: 'denia-hiyuki-mrover-fireworks', name: 'Denia Hiyuki MRover Fireworks', art: 'https://i.ibb.co/cKpjwtp0/Denia-Hiyuki-MRover-Fireworks.jpg', pos: { header: '50% 22%', nav: '50% 24%', bg: '50% 50%' } },
  { id: 'echoes-of-reciprocal-tides-secretfj520', name: 'Echoes of Reciprocal Tides @SecretFj520', art: 'https://i.ibb.co/6VkqfBD/Echoes-of-Reciprocal-Tides-Secret-Fj520.jpg', pos: { header: '50% 8%', nav: '50% 16%', bg: '50% 50%' } },
  { id: 'echoes-of-the-stars-daymera0', name: 'Echoes of the Stars @daymera_0', art: 'https://i.ibb.co/hRNmd3Fx/Echoes-of-the-Stars-daymera-0.jpg', pos: { header: '50% 20%', nav: '50% 22%', bg: '50% 50%' } },
  { id: 'encore-aalto-evolution', name: 'Encore Aalto @E_Volution_', art: 'https://i.ibb.co/cSwH6xx9/Encore-Aalto-E-Volution.jpg', pos: { header: '50% 30%', nav: '50% 30%', bg: '50% 50%' } },
  { id: 'jinhsi-changli-sanhua-summer', name: 'Jinhsi Changli Sanhua Summer', art: 'https://i.ibb.co/H55JZTD/Jinhsi-Changli-Sanhua-Summer.jpg', pos: { header: '50% 48%', nav: '50% 48%', bg: '50% 50%' } },
  { id: 'jinhsi-sanhua-changli', name: 'Jinhsi Sanhua Changli', art: 'https://i.ibb.co/GvCR62Rv/Jinhsi-Sanhua-Changli.jpg', pos: { header: '50% 16%', nav: '50% 14%', bg: '50% 50%' } },
  { id: 'jiyan-yinlin-encore-yangyang-summer-tunmengtun', name: 'Jiyan Yinlin Encore Yangyang Summer @Tunmengtun', art: 'https://i.ibb.co/Kj3M6DCn/Jiyan-Yinlin-Encore-Yangyang-Summer-Tunmengtun.jpg', pos: { header: '50% 26%', nav: '50% 26%', bg: '50% 50%' } },
  { id: 'kirabase-collab', name: 'Kirabase Collab', art: 'https://i.ibb.co/BVW4Jyfz/Kirabase-Collab.jpg', pos: { header: '50% 30%', nav: '50% 30%', bg: '50% 50%' } },
  { id: 'kurofest-concert-tunmengtun', name: 'Kurofest Concert @Tunmengtun', art: 'https://i.ibb.co/FLx5q2nn/Kurofest-Concert-Tunmengtun.jpg', pos: { header: '50% 32%', nav: '50% 34%', bg: '50% 50%' } },
  { id: 'log-3-0', name: 'Log 3.0', art: 'https://i.ibb.co/ynHpJQsH/log-3-0.png', pos: { header: '50% 54%', nav: '50% 48%', bg: '50% 50%' } },
  { id: 'log-2-0', name: 'Log 2.0', art: 'https://i.ibb.co/Kc8q8mYt/Log-2-0.jpg', pos: { header: '50% 36%', nav: '50% 30%', bg: '50% 50%' } },
];
