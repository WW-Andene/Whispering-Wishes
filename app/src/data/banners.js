...
// [SECTION:BANNERS]
// v3.5 Phase 2 — confirmed live via wuwatracker.com/fr/timeline (fetched 2026-08-14):
// "Voices on Azure Feather - Yangyang: Xuanling Banner" / "Blessings From Dewy Winds - Suisui Banner",
// grouped together as the current banner, July 30, 2026 - August 19, 2026. (Supersedes an earlier,
// incorrect game8.co-sourced "Suisui and Aemeath" reading — Aemeath actually reran alongside Luuk
// Herssen in the prior phase, v3.5-p1, per the same tracker fetch.)
...
const CURRENT_BANNERS = {
  ...
  characters: [
    { id: 'yangyang-xuanling', name: 'Yangyang: Xuanling', title: 'Havoc Overture', element: 'Havoc', weaponType: 'Sword', isNew: false, featured4Stars: ['Baizhi', 'Mortefi', 'Lumi'], imageUrl: PLACEHOLDER_IMAGE, imagePosition: 'center 15%' },
  ...
  weapons: [
    { id: 'azure-oath', name: 'Azure Oath', title: 'Absolute Pulsation', type: 'Sword', forCharacter: 'Yangyang: Xuanling', element: 'Havoc', isNew: false, featured4Stars: ['Variation', 'Endless Collapse', 'Relativistic Jet'], imageUrl: PLACEHOLDER_IMAGE },
...
const BANNER_HISTORY = [
  ...
  // Version 3.5 — confirmed live via wuwatracker.com/fr/timeline (fetched 2026-08-14). p2 is the
  // current banner (Yangyang: Xuanling + Suisui). p1 was Luuk Herssen + Aemeath (rerun), NOT bundled
  // with Yangyang: Xuanling as previously guessed — the tracker lists them as a separate prior banner.
  { id: 'v3.5-p2', version: '3.5', phase: 2, characters: ['Yangyang: Xuanling', 'Suisui'], weapons: ['Azure Oath', "Firstlight's Herald"], startDate: '2026-07-30', endDate: '2026-08-19', bannerArt: PLACEHOLDER_IMAGE },
  { id: 'v3.5-p1', version: '3.5', phase: 1, characters: ['Luuk Herssen', 'Aemeath'], weapons: ["Daybreaker's Spine", 'Everbright Polestar'], startDate: '2026-07-10', endDate: '2026-07-30', bannerArt: 'https://i.ibb.co/23dF1tWT/Luuk-Herssen-Full-Sprite.webp' },
  ...
  // p2 (Lynae solo, weapon Spectrum Blaster) confirmed via wuwatracker.com/fr/timeline — it's the
  // banner immediately preceding Luuk Herssen + Aemeath (v3.5-p1). That displaces Rebecca/Lucilla/
  // Lucy/Rover: Electro (all confirmed v3.4-cast via prydwen.gg, kits verified) into p1 together;
  // their exact sub-phase split isn't confirmed by any source, so p1 stays marked predicted.
  { id: 'v3.4-p2', version: '3.4', phase: 2, characters: ['Lynae'], weapons: ['Spectrum Blaster'], startDate: '2026-06-30', endDate: '2026-07-10', bannerArt: 'https://i.ibb.co/h1Kwq7Vj/lynae-banner.jpg' },
  { id: 'v3.4-p1', version: '3.4', phase: 1, characters: ['Rebecca', 'Lucilla', 'Lucy', 'Rover: Electro'], weapons: ['Skull Thrasher', 'Freeze Frame', 'Spectral Trigger'], startDate: '2026-06-10', endDate: '2026-06-30', bannerArt: PLACEHOLDER_IMAGE, predicted: true },
  // Version 3.3
