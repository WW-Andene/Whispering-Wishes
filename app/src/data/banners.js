...
const OTHER_BACKGROUNDS = [
  ...
  { id: '1st-anniv-festival-akihabara', name: '1st Anniv Festival Akihabara', art: 'https://i.ibb.co/F42TkkHd/1st-Anniv-Festival-Akihabara.jpg', pos: { header: '50% 30%', nav: '50% 30%', bg: '50% 50%' } },
  { id: '2nd-anniv', name: '2nd Anniv', art: 'https://i.ibb.co/jZsNnRMr/2nd-Anniv.jpg', pos: { header: '50% 30%', nav: '50% 30%', bg: '50% 50%' } },
  { id: '3-3-star-bouncing-event', name: '3.3 Star Bouncing Event', art: 'https://i.ibb.co/cKPbbBP0/3-3-Star-Bouncing-Event.jpg', pos: { header: '50% 30%', nav: '50% 30%', bg: '50% 50%' } },
  { id: 'augusta-iuno-mooncake-collab', name: 'Augusta Iuno Mooncake Collab', art: 'https://i.ibb.co/G4ybQ1C3/Augusta-Iuno-Mooncake-Collab.jpg', pos: { header: '50% 30%', nav: '50% 30%', bg: '50% 50%' } },
  { id: 'augusta-iuno', name: 'Augusta Iuno', art: 'https://i.ibb.co/rD2tj0n/Augusta-Iuno.jpg', pos: { header: '50% 30%', nav: '50% 30%', bg: '50% 50%' } },
  { id: 'brant-phoebe-rover', name: 'Brant Phoebe Rover', art: 'https://i.ibb.co/pHpKGmv/Brant-Phoebe-Rover.jpg', pos: { header: '50% 30%', nav: '50% 30%', bg: '50% 50%' } },
  { id: 'brant-roccia-liyuliyuzhou', name: 'Brant Roccia @liyuliyuzhou', art: 'https://i.ibb.co/Tqr1rS8p/Brant-Roccia-liyuliyuzhou.jpg', pos: { header: '50% 30%', nav: '50% 30%', bg: '50% 50%' } },
  { id: 'brant-roccia-chibi', name: 'Brant Roccia Chibi', art: 'https://i.ibb.co/8Q2gf5C/Brant-Roccia-Chibi.jpg', pos: { header: '50% 30%', nav: '50% 30%', bg: '50% 50%' } },
  { id: 'brant-roccia-sweets-paradise', name: 'Brant Roccia Sweets Paradise', art: 'https://i.ibb.co/9H7XDQ95/Brant-Roccia-Sweets-Paradise.jpg', pos: { header: '50% 30%', nav: '50% 30%', bg: '50% 50%' } },
  { id: 'camellya-shorekeeper-christmas', name: 'Camellya Shorekeeper Christmas', art: 'https://i.ibb.co/LD8FBskH/Camellya-Shorekeeper-Christmas.jpg', pos: { header: '50% 30%', nav: '50% 30%', bg: '50% 50%' } },
  { id: 'cantarella-shorekeeper-korean-collab', name: 'Cantarella Shorekeeper Korean Collab', art: 'https://i.ibb.co/cXMYHSfc/Cantarella-Shorekeeper-Korean-Collab.jpg', pos: { header: '50% 30%', nav: '50% 30%', bg: '50% 50%' } },
  { id: 'carlotta-changli-chisa-lynae-beach', name: 'Carlotta Changli Chisa Lynae Beach', art: 'https://i.ibb.co/F40fkS0h/Carlotta-Changli-Chisa-Lynae-Beach.jpg', pos: { header: '50% 30%', nav: '50% 30%', bg: '50% 50%' } },
  ...
  { id: 'carlotta-zani-montelli-family', name: 'Carlotta Zani Montelli Family', art: 'https://i.ibb.co/fYxMMjPt/Carlotta-Zani-Montelli-Family.jpg', pos: { header: '50% 30%', nav: '50% 30%', bg: '50% 50%' } },
  { id: 'chisa-galbrena-coco-collab', name: 'Chisa Galbrena Coco Collab', art: 'https://i.ibb.co/ZpXZQkQn/Chisa-Galbrena-Coco-Collab.jpg', pos: { header: '50% 30%', nav: '50% 30%', bg: '50% 50%' } },
  { id: 'denia-hiyuki-mrover-fireworks', name: 'Denia Hiyuki MRover Fireworks', art: 'https://i.ibb.co/cKpjwtp0/Denia-Hiyuki-MRover-Fireworks.jpg', pos: { header: '50% 30%', nav: '50% 30%', bg: '50% 50%' } },
  { id: 'echoes-of-reciprocal-tides-secretfj520', name: 'Echoes of Reciprocal Tides @SecretFj520', art: 'https://i.ibb.co/6VkqfBD/Echoes-of-Reciprocal-Tides-Secret-Fj520.jpg', pos: { header: '50% 30%', nav: '50% 30%', bg: '50% 50%' } },
  { id: 'echoes-of-the-stars-daymera0', name: 'Echoes of the Stars @daymera_0', art: 'https://i.ibb.co/hRNmd3Fx/Echoes-of-the-Stars-daymera-0.jpg', pos: { header: '50% 30%', nav: '50% 30%', bg: '50% 50%' } },
  ...
  { id: 'jinhsi-changli-sanhua-summer', name: 'Jinhsi Changli Sanhua Summer', art: 'https://i.ibb.co/H55JZTD/Jinhsi-Changli-Sanhua-Summer.jpg', pos: { header: '50% 30%', nav: '50% 30%', bg: '50% 50%' } },
  { id: 'jinhsi-sanhua-changli', name: 'Jinhsi Sanhua Changli', art: 'https://i.ibb.co/GvCR62Rv/Jinhsi-Sanhua-Changli.jpg', pos: { header: '50% 30%', nav: '50% 30%', bg: '50% 50%' } },
  { id: 'jiyan-yinlin-encore-yangyang-summer-tunmengtun', name: 'Jiyan Yinlin Encore Yangyang Summer @Tunmengtun', art: 'https://i.ibb.co/Kj3M6DCn/Jiyan-Yinlin-Encore-Yangyang-Summer-Tunmengtun.jpg', pos: { header: '50% 30%', nav: '50% 30%', bg: '50% 50%' } },
  ...
  { id: 'kurofest-concert-tunmengtun', name: 'Kurofest Concert @Tunmengtun', art: 'https://i.ibb.co/FLx5q2nn/Kurofest-Concert-Tunmengtun.jpg', pos: { header: '50% 30%', nav: '50% 30%', bg: '50% 50%' } },
