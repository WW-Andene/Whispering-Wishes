...
const ECHO_DATA = {
  ...
  // ── 1-Cost Echoes ──
  'Electro Predator':                { sets: ['Molten Rift', 'Void Thunder'], buff: 'Electro DMG', desc: 'A nimble humanoid Tacet Discord with electrical projectiles. Skill summons Electro Predator to shoot 5 times: first 4 deal 17% Electro DMG, last deals 46% Electro DMG.' , imageUrl: 'https://i.ibb.co/jkjdT6qT/Electro-Predator.png'},
  'Fusion Dreadmane':                { sets: ['Molten Rift', 'Rejuvenating Glow'], buff: 'Fusion DMG', desc: 'A fiery lion-like Howler Tacet Discord. Skill summons Fusion Dreadmane to fiercely strike the enemy dealing 32% + 64 Fusion DMG.' , imageUrl: 'https://i.ibb.co/QjMNrcNz/Fusion-Dreadmane.png'},
  'Lava Larva':                      { sets: ['Molten Rift', 'Lingering Tunes'], buff: 'Fusion DMG', desc: 'A small molten creature that persistently burns. Skill summons Lava Larva to continuously attack enemies dealing 38% Fusion DMG per hit. Disappears when summoner switches out or moves too far.' , imageUrl: 'https://i.ibb.co/cKW5xrys/Lava-Larva.png'},
  'Whiff Whaff':                     { sets: ['Sierra Gale', 'Rejuvenating Glow', 'Moonlit Clouds'], buff: 'Aero DMG', desc: 'A hovering humanoid TD that manipulates wind. Skill summons Whiff Whaff for an air explosion (51% Aero DMG) creating a Low-pressure Zone that pulls enemies in for 2s, dealing 19% Aero DMG up to 6 times.', imageUrl: 'https://i.ibb.co/4nmqLgQf/1775170547988.png', noBgProcess: true },
  'Cruisewing':                      { sets: ['Celestial Light', 'Rejuvenating Glow', 'Moonlit Clouds'], buff: 'Healing', desc: 'A gentle avian Tacet Discord. Skill summons Cruisewing to heal all team members for 1.8% Max HP + 80 HP, up to 4 times.' , imageUrl: 'https://i.ibb.co/gMqJ3BgQ/Cruisewing.png'},
  'Chirpuff':                        { sets: ['Sierra Gale', 'Havoc Eclipse'], buff: 'Aero DMG', desc: 'A small puffball creature that inflates with air. Skill summons Chirpuff to blast a powerful gust forward 3 times, each dealing 38% Aero DMG and pushing enemies back.' , imageUrl: 'https://i.ibb.co/LXW0sxPK/Chirpuff.png'},
  'Fusion Warrior':                  { sets: ['Molten Rift', 'Void Thunder', 'Sierra Gale'], buff: 'Fusion DMG', desc: 'A humanoid Tacet Discord wreathed in flames. Skill transforms into Fusion Warrior to perform a Counterattack. Successful counter reduces cooldown by 70% and deals 288% Fusion DMG.' , imageUrl: 'https://i.ibb.co/x83Jc7KK/Fusion-Warrior.png'},
  'Havoc Warrior':                   { sets: ['Celestial Light', 'Havoc Eclipse'], buff: 'Havoc DMG', desc: 'A humanoid Tacet Discord wreathed in Havoc energy. Skill transforms into Havoc Warrior to perform a Counterattack. Successful counter reduces cooldown by 70% and deals 288% Havoc DMG.' , imageUrl: 'https://i.ibb.co/kgB2Zc3g/Havoc-Warrior.png'},

  'Snip Snap':                       { sets: ['Molten Rift', 'Rejuvenating Glow', 'Lingering Tunes'], buff: 'Fusion DMG', desc: 'An immature humanoid TD that exudes small amounts of magma. Skill summons Snip Snap to throw fireballs dealing 32% + 64 Fusion DMG on hit.' , imageUrl: 'https://i.ibb.co/b5w0y6Fm/Snip-Snap.png'},
  'Zig Zag':                         { sets: ['Celestial Light', 'Moonlit Clouds', 'Lingering Tunes'], buff: 'Spectro DMG', desc: 'An immature humanoid TD that emits focused light rays with a "zig zag" sound. Skill summons Zig Zag to detonate Spectro energy dealing 48% + 96 Spectro DMG, creating a Stagnation Zone for 1.8s.' , imageUrl: 'https://i.ibb.co/NgB1CXPx/Zig-Zag.png'},
  'Hooscamp':                        { sets: ['Sierra Gale', 'Lingering Tunes'], buff: 'Aero DMG', desc: 'A small primate-like Tacet Discord. Skill transforms into Hooscamp Flinger and pounces at enemies dealing 48% + 96 Aero DMG.' , imageUrl: 'https://i.ibb.co/rGXJB3ZF/Hooscamp.png'},
  'Fusion Prism':                    { sets: ['Freezing Frost', 'Molten Rift', 'Lingering Tunes'], buff: 'Fusion DMG', desc: 'A mineral TD filled with thermal energy. Skill summons Fusion Prism to fire a crystal shard dealing 32% + 64 Fusion DMG.' , imageUrl: 'https://i.ibb.co/F4m58zj0/Fusion-Prism.png'},
  'Glacio Prism':                    { sets: ['Freezing Frost', 'Havoc Eclipse', 'Moonlit Clouds'], buff: 'Glacio DMG', desc: 'A mineral TD filled with freezing energy. Skill summons Glacio Prism to fire 3 crystal shards, each dealing 38% Glacio DMG.' , imageUrl: 'https://i.ibb.co/DPxd7hnh/Glacio-Prism.png'},
  'Aero Prism':                      { sets: ['Tidebreaking Courage', 'Eternal Radiance'], buff: 'Aero DMG', desc: 'A mineral TD filled with powerful air currents. Skill summons Aero Prism to attack enemies dealing 19% Aero DMG.' , imageUrl: 'https://i.ibb.co/tpFvDp6x/Aero-Prism.png'},
  'Havoc Prism':                     { sets: ['Void Thunder', 'Celestial Light', 'Havoc Eclipse'], buff: 'Havoc DMG', desc: 'A mineral TD filled with Havoc energy. Skill summons Havoc Prism to fire 5 crystal shards, each dealing 23% Havoc DMG.' , imageUrl: 'https://i.ibb.co/FbrRCM3j/Havoc-Prism.png'},
  'Spectro Prism':                   { sets: ['Molten Rift', 'Void Thunder', 'Celestial Light'], buff: 'Spectro DMG', desc: 'A mineral TD that emits Spectro light to buff nearby allies. Skill summons Spectro Prism to emit a laser hitting up to 8 times for 14% Spectro DMG each.' , imageUrl: 'https://i.ibb.co/zH8vmSfM/Spectro-Prism.png'},
  'Baby Viridblaze Saurian':         { sets: ['Molten Rift', 'Void Thunder', 'Lingering Tunes'], buff: 'Fusion DMG', desc: 'A small amphibian-like creature found in forests. Skill transforms into Baby Viridblaze Saurian to rest in place and slowly restore HP.' , imageUrl: 'https://i.ibb.co/mrn1KCwW/Baby-Viridblaze-Saurian.png'},
  'Young Roseshroom':                { sets: ['Sierra Gale', 'Havoc Eclipse'], buff: 'Havoc DMG', desc: 'A young fungal Tacet Discord. Skill summons Baby Roseshroom to fire a laser dealing 32% + 64 Havoc DMG.' , imageUrl: 'https://i.ibb.co/VpcMk58f/Young-Roseshroom.png'},
  'Clang Bang':                      { sets: ['Freezing Frost', 'Celestial Light'], buff: 'Glacio DMG', desc: 'An immature humanoid TD with ice crystals that make a "clang bang" sound. Skill summons Clang Bang that follows the enemy and self-combusts, dealing 32% + 64 Glacio DMG.' , imageUrl: 'https://i.ibb.co/sp8bnWqS/Clang-Bang.png'},
  'Dwarf Cassowary':                 { sets: ['Sierra Gale', 'Rejuvenating Glow'], buff: 'Physical DMG', desc: 'A small flightless bird-like Tacet Discord. Skill summons Dwarf Cassowary to track and attack the enemy dealing 38% Physical DMG x3.' , imageUrl: 'https://i.ibb.co/N64L3hhD/Dwarf-Cassowary.png'},
  'Excarat':                         { sets: ['Freezing Frost', 'Havoc Eclipse'], buff: 'Physical DMG', desc: 'A burrowing rodent-like Tacet Discord. Skill transforms into Excarat and tunnels underground to advance, immune to damage while burrowed. Can change direction freely.' , imageUrl: 'https://i.ibb.co/fYHBj9f0/Excarat.png'},
  'Lottie Lost':                     { sets: ['Tidebreaking Courage', 'Frosty Resolve'], buff: 'Spectro DMG', desc: 'A small whimsical Tacet Discord that wanders aimlessly. Skill summons Lottie Lost to attack enemies dealing 129% Spectro DMG.' , imageUrl: 'https://i.ibb.co/934LYmQz/Lottie-Lost.png'},
  'Chest Mimic':                     { sets: ['Empyrean Anthem', 'Frosty Resolve', 'Midnight Veil'], buff: 'Spectro DMG', desc: 'A deceptive Tacet Discord disguised as a treasure chest. Skill summons Chest Mimic to attack with 3 consecutive strikes, each dealing 64% Spectro DMG.' , imageUrl: 'https://i.ibb.co/x8fy6r6N/Chest-Mimic.png'},
  'Aero Predator':                   { sets: ['Void Thunder', 'Sierra Gale'], buff: 'Aero DMG', desc: 'A nimble humanoid Tacet Discord that fires air projectiles. Skill summons Aero Predator to shoot 5 times: first 4 deal 17% Aero DMG, last deals 46% Aero DMG.' , imageUrl: 'https://i.ibb.co/Xx3y7Qdn/Aero-Predator.png'},
  'Glacio Predator':                 { sets: ['Freezing Frost', 'Celestial Light'], buff: 'Glacio DMG', desc: 'A nimble humanoid Tacet Discord that fires ice projectiles. Skill summons Glacio Predator to shoot 5 times: first 4 deal 17% Glacio DMG, last deals 46% Glacio DMG.' , imageUrl: 'https://i.ibb.co/TDFLmb4R/Glacio-Predator.png'},
  'Gulpuff':                         { sets: ['Freezing Frost', 'Celestial Light'], buff: 'Glacio DMG', desc: 'A bubble-blowing Tacet Discord. Skill summons Gulpuff to blow 3 frost bubbles that float toward enemies, each dealing 38% Glacio DMG on contact and slowing targets by 15% for 2s.' , imageUrl: 'https://i.ibb.co/bj9N6GyJ/Gulpuff.png'},
  'Aero Drake':                      { sets: ['Tidebreaking Courage', 'Gusts of Welkin', 'Flaming Clawprint'], buff: 'Aero DMG', desc: 'A wind-elemental drake. Skill summons Aero Drake to swoop forward dealing 48% Aero DMG, then flap its wings to release a gust dealing 48% Aero DMG and knocking enemies back.' , imageUrl: 'https://i.ibb.co/V0vHP6mR/Aero-Drake.png'},
  'Electro Drake':                   { sets: ['Midnight Veil', 'Gusts of Welkin', 'Flaming Clawprint'], buff: 'Electro DMG', desc: 'A lightning-elemental drake. Skill summons Electro Drake to swoop forward dealing 48% Electro DMG, then discharge a bolt from its jaws dealing 48% Electro DMG that chains to 1 nearby enemy.' , imageUrl: 'https://i.ibb.co/SDH285Pc/Electro-Drake.png'},
  'Fusion Drake':                    { sets: ['Windward Pilgrimage', 'Flaming Clawprint'], buff: 'Fusion DMG', desc: 'A fire-elemental drake. Skill summons Fusion Drake to swoop forward dealing 48% Fusion DMG, then breathe a flame jet dealing 24% Fusion DMG x3.' , imageUrl: 'https://i.ibb.co/4gZtg5nn/Fusion-Drake.png'},
  'Glacio Drake':                    { sets: ['Gusts of Welkin', 'Windward Pilgrimage'], buff: 'Glacio DMG', desc: 'An ice-elemental drake. Skill summons Glacio Drake to swoop forward dealing 48% Glacio DMG, then exhale a frost blast dealing 48% Glacio DMG with a 20% chance to freeze for 1.5s.' , imageUrl: 'https://i.ibb.co/gbw1jyD1/Glacio-Drake.png'},
  'Havoc Drake':                     { sets: ['Windward Pilgrimage', 'Flaming Clawprint', 'Thread of Severed Fate'], buff: 'Havoc DMG', desc: 'A havoc-elemental drake. Skill summons Havoc Drake to swoop forward dealing 48% Havoc DMG, then release a corrosive orb dealing 48% Havoc DMG that reduces enemy Havoc RES by 5% for 6s.' , imageUrl: 'https://i.ibb.co/nsNDkVLc/Havoc-Drake.png'},
  'Spectro Drake':                   { sets: ['Windward Pilgrimage', 'Flaming Clawprint'], buff: 'Spectro DMG', desc: 'A spectro-elemental drake. Skill summons Spectro Drake to swoop forward dealing 48% Spectro DMG, then fire a light beam dealing 48% Spectro DMG in a line.' , imageUrl: 'https://i.ibb.co/tTWghQ5k/Spectro-Drake.png'},
  ...
  'Sacerdos':                        { sets: ['Gusts of Welkin', 'Windward Pilgrimage'], buff: 'Aero DMG', desc: 'A priestly creature that chants wind hymns. Skill summons Sacerdos to release a spiraling wind prayer dealing 32% Aero DMG x3, healing the active Resonator for 0.5% Max HP per hit.' , imageUrl: 'https://i.ibb.co/xpqtmS6/Sacerdos.png'},
  'Sagittario':                      { sets: ['Eternal Radiance', 'Gusts of Welkin', 'Flaming Clawprint'], buff: 'Spectro DMG', desc: 'An archer-like creature that fires arrows of light. Skill summons Sagittario to fire 3 spectral arrows dealing 28% Spectro DMG each, with the last arrow piercing through enemies.' , imageUrl: 'https://i.ibb.co/pj7ZdDDx/Sagittario.png'},
  'La Guardia':                      { sets: ['Midnight Veil', 'Gusts of Welkin', 'Flaming Clawprint'], buff: 'Physical DMG', desc: 'A vigilant guard creature wielding a stone shield. Skill summons La Guardia to bash forward with its shield dealing 64% Physical DMG, then thrust its spear for 32% Physical DMG.' , imageUrl: 'https://i.ibb.co/C3Dv1xF7/La-Guardia.png'},
  'Calcified Junrock':               { sets: ['Empyrean Anthem', 'Tidebreaking Courage', 'Crown of Valor'], buff: 'Healing', desc: 'A calcified junrock variant hardened by mineral deposits. Skill summons Calcified Junrock to release a restorative pulse, healing the active Resonator for 2.0% Max HP + 80.' , imageUrl: 'https://i.ibb.co/WNDSq6JG/Calcified-Junrock.png'},
  'Fission Junrock':                 { sets: ['Void Thunder', 'Rejuvenating Glow', 'Moonlit Clouds'], buff: 'Healing', desc: 'A fission-powered junrock that radiates warm energy. Skill summons Fission Junrock to split into 2 fragments, each healing a nearby ally for 1.5% Max HP + 60 on contact.' , imageUrl: 'https://i.ibb.co/8gzmzV1g/Fission-Junrock.png'},
  'Golden Junrock':                  { sets: ['Frosty Resolve', 'Eternal Radiance', 'Law of Harmony'], buff: 'Spectro DMG', desc: 'A golden junrock variant gleaming with spectral light. Skill summons Golden Junrock to roll into enemies dealing 48% Spectro DMG, then burst in a flash dealing 48% Spectro DMG in an area.' , imageUrl: 'https://i.ibb.co/B5vmCfcH/Golden-Junrock.png'},
  'Vanguard Junrock':                { sets: ['Void Thunder', 'Rejuvenating Glow', 'Lingering Tunes'], buff: 'Physical DMG', desc: 'A vanguard junrock variant armored with rocky plates. Skill summons Vanguard Junrock to charge headfirst into enemies dealing 64% Physical DMG, then spin and scatter debris for 32% Physical DMG.' , imageUrl: 'https://i.ibb.co/gMFSqGZt/Vanguard-Junrock.png'},
  'Diamondclaw':                     { sets: ['Moonlit Clouds', 'Lingering Tunes'], buff: 'Physical DMG', desc: 'A diamond-clawed creature with razor-sharp crystalline talons. Skill summons Diamondclaw to slash twice dealing 38% Physical DMG each, with a 30% chance to inflict Bleed for 24% Physical DMG over 4s.' , imageUrl: 'https://i.ibb.co/HLXTGZwZ/Diamondclaw.png'},
  'Diggy Duggy':                     { sets: ['Eternal Radiance', 'Tidebreaking Courage'], buff: 'Physical DMG', desc: 'A burrowing creature that attacks from underground. Skill summons Diggy Duggy to tunnel beneath the target and erupt upward dealing 96% Physical DMG, launching hit enemies airborne.' , imageUrl: 'https://i.ibb.co/xKzKn59P/Diggy-Duggy.png'},
  'Fae Ignis':                       { sets: ['Eternal Radiance', 'Midnight Veil', 'Dream of the Lost'], buff: 'Havoc DMG', desc: 'A fairy flame creature flickering with dark fire. Skill summons Fae Ignis to orbit the Resonator for 5s, shooting will-o-wisps at nearby enemies dealing 19% Havoc DMG per hit, up to 5 hits.' , imageUrl: 'https://i.ibb.co/TDNHnbP5/Fae-Ignis.png'},
  'Frostscourge Stalker':            { sets: ['Eternal Radiance', 'Midnight Veil'], buff: 'Glacio DMG', desc: 'A frost-infused stalker that hunts in frozen terrain. Skill summons Frostscourge Stalker to pounce and bite dealing 64% Glacio DMG, then claw twice for 19% Glacio DMG each.' , imageUrl: 'https://i.ibb.co/672Pj7yR/Frostscourge-Stalker.png'},
  'Voltscourge Stalker':             { sets: ['Midnight Veil', 'Empyrean Anthem'], buff: 'Electro DMG', desc: 'A voltage-infused stalker crackling with static. Skill summons Voltscourge Stalker to pounce and bite dealing 64% Electro DMG, then discharge a shock pulse for 32% Electro DMG in an area.' , imageUrl: 'https://i.ibb.co/MDNfkd8C/Voltscourge-Stalker.png'},
  'Galescourge Stalker':             { sets: ['Frosty Resolve', 'Empyrean Anthem'], buff: 'Aero DMG', desc: 'A gale-infused stalker that moves with the wind. Skill summons Galescourge Stalker to dash through enemies dealing 48% Aero DMG, then circle back for a second pass dealing 48% Aero DMG.' , imageUrl: 'https://i.ibb.co/dw4DtP2J/Galescourge-Stalker.png'},
  'Hocus Pocus':                     { sets: ['Frosty Resolve', 'Empyrean Anthem'], buff: 'Havoc DMG', desc: 'A magical trickster creature wreathed in dark illusions. Skill summons Hocus Pocus to conjure 3 havoc orbs that home in on enemies, each dealing 32% Havoc DMG on impact.' , imageUrl: 'https://i.ibb.co/V0K3W3c3/Hocus-Pocus.png'},
  'Nimbus Wraith':                   { sets: ['Midnight Veil', 'Empyrean Anthem', "Flamewing's Shadow"], buff: 'Healing', desc: 'A cloud-like wraith that drifts through mist. Skill summons Nimbus Wraith to envelope the active Resonator in healing fog for 4s, restoring 1.0% Max HP + 50 per second.' , imageUrl: 'https://i.ibb.co/VpwHYqLj/Nimbus-Wraith.png'},
  'Hoartoise':                       { sets: ['Freezing Frost', 'Celestial Light'], buff: 'Healing', desc: 'A hoary tortoise creature with a frost-covered shell. Skill summons Hoartoise to retract into its shell and emit a restorative aura, healing the active Resonator for 2.0% Max HP + 80.' , imageUrl: 'https://i.ibb.co/rfKhG5D9/Hoartoise.png'},
  'Sabyr Boar':                      { sets: ['Freezing Frost', 'Sierra Gale', 'Moonlit Clouds'], buff: 'Physical DMG', desc: 'A tusked boar creature that charges with reckless force. Skill summons Sabyr Boar to gore enemies with a charging headbutt dealing 96% Physical DMG. Hits from behind deal +25% bonus DMG.' , imageUrl: 'https://i.ibb.co/Tx5sZfc7/Sabyr-Boar.png'},
  'Traffic Illuminator':             { sets: ['Molten Rift', 'Void Thunder', 'Sierra Gale'], buff: 'Electro DMG', desc: 'A traffic-light-like construct that flashes warning signals. Skill summons Traffic Illuminator to fire 3 colored beams in sequence: red (32% Electro DMG), yellow (32% Electro DMG), green (32% Electro DMG). Red beam staggers enemies.' , imageUrl: 'https://i.ibb.co/5WJs28pZ/Traffic-Illuminator.png'},
  'Tick Tack':                       { sets: ['Havoc Eclipse', 'Rejuvenating Glow', 'Lingering Tunes'], buff: 'Havoc DMG', desc: 'A clock-like creature whose hands spin erratically. Skill summons Tick Tack to wind up and strike with its clock hands dealing 48% Havoc DMG x2. On the 2nd hit, briefly slows enemy action speed by 10% for 3s.' , imageUrl: 'https://i.ibb.co/5xv8bZQw/Tick-Tack.png'},
  'Chop Chop: Headless':             { sets: ['Eternal Radiance', 'Tidebreaking Courage'], buff: 'Fusion DMG', desc: 'The headless body of Chop Chop, swinging blindly. Skill summons Chop Chop: Headless to flail its arms wildly dealing 24% Fusion DMG x4 in a wide arc around it.' , imageUrl: 'https://i.ibb.co/QSVwGFv/Chop-Chop-Headless.png'},
  'Chop Chop: Leftless':             { sets: ['Frosty Resolve', 'Tidebreaking Courage'], buff: 'Spectro DMG', desc: 'Chop Chop missing its left arm, compensating with spectral energy. Skill summons Chop Chop: Leftless to deliver a right-arm overhead chop for 64% Spectro DMG, then fire a spectral bolt from its stump for 32% Spectro DMG.' , imageUrl: 'https://i.ibb.co/DfzWYrQx/Chop-Chop-Leftless.png'},
  'Chop Chop: Rightless':            { sets: ['Frosty Resolve', 'Tidebreaking Courage'], buff: 'Havoc DMG', desc: 'Chop Chop missing its right arm, leaking havoc energy. Skill summons Chop Chop: Rightless to deliver a left-arm sweeping slash for 64% Havoc DMG, then release a havoc burst from its stump for 32% Havoc DMG.' , imageUrl: 'https://i.ibb.co/5h2mJXR5/Chop-Chop-Rightless.png'},
  'Geospider S4':                    { sets: ['Pact of Neonlight Leap', 'Halo of Starry Radiance', 'Trailblazing Star'], buff: 'Spectro DMG', desc: 'A mechanical spider from Lahai-Roi. Skill summons Geospider S4 to fire a web mine that latches onto enemies dealing 32% Spectro DMG, detonating after 2s for 64% Spectro DMG.' , imageUrl: 'https://i.ibb.co/NdMp0LFy/Geospider-S4.png'},
  'Flora Drone':                     { sets: ['Pact of Neonlight Leap', 'Rite of Gilded Revelation', 'Sound of True Name'], buff: 'Aero DMG', desc: 'A botanical drone from Lahai-Roi. Skill summons Flora Drone to release pollen that heals the active Resonator for 1.5% Max HP + 60 and grants +10% ATK for 6s.' , imageUrl: 'https://i.ibb.co/YCxCSv5/Flora-Drone.png'},
  'Mining Drone':                    { sets: ['Halo of Starry Radiance', 'Rite of Gilded Revelation', 'Sound of True Name'], buff: 'Havoc DMG', desc: 'A mining drone from Lahai-Roi. Skill summons Mining Drone to fire a focused drill beam dealing 19% Havoc DMG x5 to a single target.' , imageUrl: 'https://i.ibb.co/93Y2P7v9/Mining-Drone.png'},
  'Zip Zap':                         { sets: ['Pact of Neonlight Leap', 'Rite of Gilded Revelation', 'Chromatic Foam'], buff: 'Electro DMG', desc: 'An electrical creature from Lahai-Roi that zips between targets. Skill summons Zip Zap to dash between up to 3 enemies dealing 32% Electro DMG to each, leaving a static trail that shocks followers for 17% Electro DMG.' , imageUrl: 'https://i.ibb.co/60M6Y63d/Zip-Zap.png'},
  'Iceglint Dancer':                 { sets: ['Trailblazing Star'], buff: 'Glacio DMG', desc: 'A crystalline dancer that spins on blades of ice. Skill summons Iceglint Dancer to perform a spinning ice kick dealing 48% Glacio DMG, then scatter frost shards dealing 24% Glacio DMG x2.' , imageUrl: 'https://i.ibb.co/rfF0WbMB/Iceglint-Dancer.png'},
  'Shadow Stepper':                  { sets: ['Trailblazing Star', 'Chromatic Foam'], buff: 'Havoc DMG', desc: 'A shadow-walking creature that phases through darkness. Skill summons Shadow Stepper to teleport behind the target and backstab for 96% Havoc DMG. If the target is facing away, deals +30% bonus DMG.' , imageUrl: 'https://i.ibb.co/KzQQgJv9/Shadow-Stepper.png'},
  'Tremor Warrior':                  { sets: ['Halo of Starry Radiance', 'Chromatic Foam', 'Sound of True Name'], buff: 'Electro DMG', desc: 'A tremor-inducing warrior that channels seismic electricity. Skill summons Tremor Warrior to slam the ground dealing 48% Electro DMG x2, sending shockwaves outward for 38% Electro DMG.' , imageUrl: 'https://i.ibb.co/LddgyQDf/Tremor-Warrior.png'},
  'Nightmare: Aero Predator':        { sets: ['Crown of Valor'], buff: 'Aero DMG', desc: 'A nightmare variant of the Aero Predator with enhanced wind projectiles. Skill summons Nightmare: Aero Predator to shoot 5 times: first 4 deal 23% Aero DMG, last deals 57% Aero DMG.' , imageUrl: 'https://i.ibb.co/4ZC70TkJ/Nightmare-Aero-Predator.png'},
  'Nightmare: Electro Predator':     { sets: ['Crown of Valor'], buff: 'Electro DMG', desc: 'A nightmare variant of the Electro Predator with overcharged bolts. Skill summons Nightmare: Electro Predator to shoot 5 times: first 4 deal 23% Electro DMG, last deals 57% Electro DMG.' , imageUrl: 'https://i.ibb.co/PGXJrqTV/Nightmare-Electro-Predator.png'},
  'Nightmare: Glacio Predator':      { sets: ['Dream of the Lost'], buff: 'Glacio DMG', desc: 'A nightmare variant of the Glacio Predator with piercing ice shards. Skill summons Nightmare: Glacio Predator to shoot 5 times: first 4 deal 23% Glacio DMG, last deals 57% Glacio DMG.' , imageUrl: 'https://i.ibb.co/fd7LMp6b/Nightmare-Glacio-Predator.png'},
  'Nightmare: Baby Roseshroom':      { sets: ["Flamewing's Shadow"], buff: 'Havoc DMG', desc: 'A nightmare variant of the Baby Roseshroom with amplified spores. Skill summons Nightmare: Baby Roseshroom to fire an enhanced laser dealing 48% + 96 Havoc DMG, then release toxic mist for 19% Havoc DMG x2.' , imageUrl: 'https://i.ibb.co/vpHJJmp/Nightmare-Baby-Roseshroom.png'},
  'Nightmare: Baby Viridblaze Saurian': { sets: ["Flamewing's Shadow"], buff: 'Fusion DMG', desc: 'A nightmare variant of the Baby Viridblaze Saurian wreathed in dark flame. Skill transforms into the saurian to spit an enhanced fireball dealing 48% + 96 Fusion DMG, leaving a burn patch for 19% Fusion DMG x2.' , imageUrl: 'https://i.ibb.co/4nvDs4BM/Nightmare-Baby-Viridblaze-Saurian.png'},
  'Nightmare: Chirpuff':             { sets: ['Law of Harmony'], buff: 'Aero DMG', desc: 'A nightmare variant of Chirpuff overinflated with nightmare wind. Skill summons Nightmare: Chirpuff to blast an enhanced gust 3 times, each dealing 48% Aero DMG and pulling enemies inward.' , imageUrl: 'https://i.ibb.co/NdvTSMqn/Nightmare-Chirpuff.png'},
  'Nightmare: Dwarf Cassowary':      { sets: ['Thread of Severed Fate'], buff: 'Physical DMG', desc: 'A nightmare variant of the Dwarf Cassowary with razor-edged feathers. Skill summons Nightmare: Dwarf Cassowary to track and kick the enemy dealing 48% Physical DMG x3.' , imageUrl: 'https://i.ibb.co/Q72cVTkv/Nightmare-Dwarf-Cassowary.png'},
  'Nightmare: Gulpuff':              { sets: ['Law of Harmony'], buff: 'Glacio DMG', desc: 'A nightmare variant of Gulpuff exhaling freezing mist. Skill summons Nightmare: Gulpuff to launch 3 frost bubbles dealing 48% Glacio DMG each. Bubbles explode on contact, freezing enemies for 1s.' , imageUrl: 'https://i.ibb.co/XxFttBYH/Nightmare-Gulpuff.png'},
  'Nightmare: Havoc Warrior':        { sets: ['Dream of the Lost'], buff: 'Havoc DMG', desc: 'A nightmare variant of the Havoc Warrior radiating dark energy. Skill transforms into Nightmare: Havoc Warrior to perform a Counter. Successful counter deals 336% Havoc DMG and reduces enemy Havoc RES by 10% for 5s.' , imageUrl: 'https://i.ibb.co/XZsKpLsF/Nightmare-Havoc-Warrior.png'},
  'Nightmare: Tick Tack':            { sets: ['Thread of Severed Fate'], buff: 'Havoc DMG', desc: 'A nightmare variant of Tick Tack whose ticking distorts time. Skill summons Nightmare: Tick Tack to swing its pendulum dealing 64% Havoc DMG x2, then chime to slow all nearby enemies by 35% for 3s.' , imageUrl: 'https://i.ibb.co/GvfLmp2P/Nightmare-Tick-Tack.png'},
};
