...
const ECHO_DATA = {
  ...
  'Abyssal Mercator':                { sets: ['Frosty Resolve', 'Eternal Radiance'], buff: 'Glacio DMG', desc: 'A battle-hardened combatant from the depths. Skill summons Abyssal Mercator to slash twice for 84% Glacio DMG each, then thrust forward for 120% Glacio DMG. Enemies hit by all 3 strikes are afflicted with Frostbite for 5s.' , iconUrl: 'https://i.ibb.co/chV4vWNJ/Abyssal-Mercator-Icon.webp' },
  'Twin Nova - Collapsar Blade':      { sets: ['Rite of Gilded Revelation', 'Trailblazing Star', 'Sound of True Name'], buff: 'Electro DMG', desc: 'The melee model of a Spacetrek Collective combat mech pair. Skill transforms to deliver 2 electrified slashes dealing 96% Electro DMG each, then a finishing thrust for 144% Electro DMG. Pairing with Nebulous Cannon enables combo attacks and Dyad Origins stacks (+10% Echo Skill DMG each, up to 6).' , iconUrl: 'https://i.ibb.co/rK7B4PM5/Twin-Nova-Collapsar-Blade-Icon.webp' },
  'Sabercat Prowler':                { sets: ['Pact of Neonlight Leap', 'Rite of Gilded Revelation', 'Sound of True Name'], buff: 'Fusion DMG', desc: 'A stealthy feline predator from Lahai-Roi. Skill summons Sabercat Prowler to pounce from stealth dealing 168% Fusion DMG, then rake with both claws for 55% Fusion DMG x2. Pounce hit from behind deals +50% bonus DMG.' , iconUrl: 'https://i.ibb.co/JWchKx7x/Sabercat-Prowler-Icon.webp' },
  'Sabercat Reaver':                 { sets: ['Pact of Neonlight Leap', 'Rite of Gilded Revelation', 'Sound of True Name'], buff: 'Fusion DMG', desc: 'A fierce feline combatant from Lahai-Roi. Skill summons Sabercat Reaver to perform a spinning claw assault dealing 48% Fusion DMG x4, finishing with a fiery bite for 96% Fusion DMG. On hit, reduces target Fusion RES by 10% for 8s.' , iconUrl: 'https://i.ibb.co/JWMcgRY4/Sabercat-Reaver-Icon.webp' },
  'Spacetrek Explorer':              { sets: ['Halo of Starry Radiance', 'Chromatic Foam', 'Sound of True Name'], buff: 'Healing', desc: 'A spacefaring support unit from the Spacetrek Collective. Skill summons Spacetrek Explorer to deploy a Repair Field lasting 6s, healing all team members for 2.0% Max HP + 120 per second. On deployment, grants +15% ATK to nearby allies for 10s.' , iconUrl: 'https://i.ibb.co/4nh1N91b/Spacetrek-Explorer-Icon.webp' },
  'Flora Reindeer':                  { sets: ['Rite of Gilded Revelation'], buff: 'Aero DMG', desc: 'A gentle reindeer-like creature from Lahai-Roi. Skill summons Flora Reindeer to charge forward scattering pollen for 145% Aero DMG, then kick up a Bloom Gust dealing 123% Aero DMG to enemies behind.' , iconUrl: 'https://i.ibb.co/LDv0brpC/Flora-Reindeer-Icon.webp' },
  'Windlash Coleoid':                { sets: ['Rite of Gilded Revelation'], buff: 'Aero DMG', desc: 'A wind-infused cephalopod creature. Skill summons Windlash Coleoid to lash out with 4 tentacle strikes dealing 36% Aero DMG each, then release a pressurized gust for 144% Aero DMG that knocks enemies back.' , iconUrl: 'https://i.ibb.co/1yKLmnC/Windlash-Coleoid-Icon.webp' },
  'Frostbite Coleoid':               { sets: ['Halo of Starry Radiance'], buff: 'Glacio DMG', desc: 'A frost-infused cephalopod creature. Skill summons Frostbite Coleoid to spray a freezing ink cloud dealing 57% Glacio DMG x3, then constrict a target for 117% Glacio DMG. Ink cloud lingers for 3s, slowing enemies by 30%.' , iconUrl: 'https://i.ibb.co/5gdNHqbG/Frostbite-Coleoid-Icon.webp' },
  'Glommoth':                        { sets: ['Trailblazing Star'], buff: 'Glacio DMG', desc: 'A glowing moth-like creature from Lahai-Roi. Skill summons Glommoth to scatter luminous frost scales dealing 28% Glacio DMG x8. Scales linger on the ground for 4s, detonating when enemies step on them for 35% Glacio DMG each.' , iconUrl: 'https://i.ibb.co/yBX17MGF/Glommoth-Icon.webp' },
  'Ironhoof':                        { sets: ['Pact of Neonlight Leap'], buff: 'Fusion DMG', desc: 'A heavy hoofed beast from Lahai-Roi. Skill summons Ironhoof to stampede forward dealing 168% Fusion DMG, then rear up and slam down with molten hooves for 120% Fusion DMG. Slam creates a lava pool lasting 3s dealing 17% Fusion DMG per tick.' , iconUrl: 'https://i.ibb.co/bRNS0DKF/Ironhoof-Icon.webp' },
  'Mining Reindeer':                 { sets: ['Pact of Neonlight Leap'], buff: 'Electro DMG', desc: 'A reindeer-like creature used in mining operations. Skill summons Mining Reindeer to charge forward with electrified antlers dealing 145% Electro DMG, then discharge a static pulse for 72% Electro DMG x2. Struck enemies are Shocked for 4s.' , iconUrl: 'https://i.ibb.co/8gc61bfT/Mining-Reindeer-Icon.webp' },
  'Reminiscence - Kronaclaw':         { sets: ['Trailblazing Star', 'Chromatic Foam'], buff: 'Aero DMG', desc: 'A reminiscence of the fearsome Kronaclaw. Skill summons Reminiscence: Kronaclaw to perform a diving slash for 168% Aero DMG, then follow up with 3 wind-claw swipes dealing 40% Aero DMG each. Final swipe launches enemies airborne.', iconUrl: 'https://i.ibb.co/KxrLYyzN/T-Icon-Monster-Head-32060-UI.webp' },
  'Kronablight':                     { sets: ['Trailblazing Star', 'Chromatic Foam'], buff: 'Electro DMG', desc: 'A blighted variant of the Kronaclaw. Skill summons Kronablight to slam the ground with electrified claws dealing 192% Electro DMG, releasing 3 lightning bolts that chain between enemies for 36% Electro DMG each.' , iconUrl: 'https://i.ibb.co/4ZJ1Kzwb/Kronablight-Icon.webp' },
  'Pilgrim\'s Shell':                { sets: ['Windward Pilgrimage', 'Flaming Clawprint'], buff: 'Aero DMG', desc: 'A shell-bearing pilgrim creature. Skill summons Pilgrim\'s Shell to retract into its shell and spin forward dealing 48% Aero DMG x4, then pop out with a shockwave for 96% Aero DMG. Spinning hits pull nearby enemies inward.', iconUrl: 'https://i.ibb.co/4ZHwcHT6/Pilgrims-Shell.webp' },
  'Kerasaur':                        { sets: ['Windward Pilgrimage', 'Flaming Clawprint', "Flamewing's Shadow"], buff: 'Aero DMG', desc: 'A horned saurian from the Sanguis Plateaus. Skill summons Kerasaur to gore enemies with a charging headbutt for 192% Aero DMG, then sweep its tail for 96% Aero DMG in a wide arc behind it.' , iconUrl: 'https://i.ibb.co/tP81d0f5/Kerasaur-Icon.webp' },
  'Hurriclaw':                       { sets: ['Tidebreaking Courage', 'Gusts of Welkin', 'Crown of Valor'], buff: 'Aero DMG', desc: 'A wind-wielding claw beast. Skill summons Hurriclaw to unleash a 5-hit claw flurry dealing 34% Aero DMG each, finishing with a tornado uppercut for 118% Aero DMG that launches enemies.' , iconUrl: 'https://i.ibb.co/RG3XwmV5/Hurriclaw-Icon.webp' },
  'Nightmare: Viridblaze Saurian':   { sets: ["Flamewing's Shadow"], buff: 'Fusion DMG', desc: 'A nightmare variant of the fire-breathing saurian. Skill summons Nightmare: Viridblaze Saurian to unleash an enhanced flame breath dealing 24% Fusion DMG x8, then spit a magma glob for 96% Fusion DMG that leaves a burning zone for 4s.' , iconUrl: 'https://i.ibb.co/C5Q01c2x/Nightmare-Viridblaze-Saurian-Icon.webp' },
  ...
  'Nightmare: Cyan-Feathered Heron': { sets: ['Law of Harmony'], buff: 'Aero DMG', desc: 'A nightmare variant of the cyan-winged heron. Skill transforms into a Parry Stance; counterattack deals 272% Aero DMG. If attacked during parry, counters early with a gale-force wing slash and recovers 5 Concerto Energy.' , iconUrl: 'https://i.ibb.co/v6WJ0dJd/Nightmare-Cyan-Feathered-Heron-Icon.webp' },
  'Nightmare: Roseshroom':           { sets: ['Thread of Severed Fate'], buff: 'Havoc DMG', desc: 'A nightmare variant of the dark fungal creature. Skill summons Nightmare: Roseshroom to fire an enhanced spore beam dealing 48% Havoc DMG x5, then detonate spore clouds on hit targets for 68% Havoc DMG.' , iconUrl: 'https://i.ibb.co/yn41d4Vx/Nightmare-Roseshroom-Icon.webp' },
  'Nightmare: Tambourinist':         { sets: ['Dream of the Lost'], buff: 'Havoc DMG', desc: 'A nightmare variant of the rhythmic sound-weaponizer. Skill summons Nightmare: Tambourinist to beat a havoc-infused rhythm dealing 72% Havoc DMG x3. Each beat applies a Dissonance stack; at 3 stacks enemies take 96% bonus Havoc DMG.' , iconUrl: 'https://i.ibb.co/rfw6xZrR/Nightmare-Tambourinist-Icon.webp' },
  'Diurnus Knight':                  { sets: ['Eternal Radiance', 'Tidebreaking Courage'], buff: 'Spectro DMG', desc: 'A daytime knight of the Order. Skill summons Diurnus Knight to deliver a radiant sword combo: 2 slashes at 84% Spectro DMG each, followed by a piercing thrust for 120% Spectro DMG. Hits on shielded enemies deal +30% bonus DMG.' , iconUrl: 'https://i.ibb.co/CpyL99C5/Diurnus-Knight-Icon.webp' },
  'Nocturnus Knight':                { sets: ['Midnight Veil', 'Empyrean Anthem'], buff: 'Havoc DMG', desc: 'A nighttime knight of the Order. Skill summons Nocturnus Knight to perform a shadow-step slash for 168% Havoc DMG, then plant a Dark Sigil on hit enemies that detonates after 2s for 120% Havoc DMG.' , iconUrl: 'https://i.ibb.co/M5V9hjW5/Nocturnus-Knight-Icon.webp' },
  'Questless Knight':                { sets: ['Frosty Resolve', 'Midnight Veil'], buff: 'Electro DMG', desc: 'A wandering knight without a quest. Skill summons Questless Knight to hurl an electrified lance dealing 144% Electro DMG, which chains lightning to up to 3 nearby enemies for 48% Electro DMG each.' , iconUrl: 'https://i.ibb.co/vC2Mqzqc/Questless-Knight-Icon.webp' },
  'Abyssal Gladius':                 { sets: ['Midnight Veil', 'Tidebreaking Courage', 'Thread of Severed Fate'], buff: 'Glacio DMG', desc: 'A blade-wielding warrior from the abyss. Skill summons Abyssal Gladius to execute a 3-hit frost blade combo dealing 72%/72%/144% Glacio DMG. The final strike creates an ice fissure that persists for 3s dealing 24% Glacio DMG per tick.' , iconUrl: 'https://i.ibb.co/PZ4WLJ1g/Abyssal-Gladius-Icon.webp' },
  'Abyssal Patricius':               { sets: ['Frosty Resolve', 'Empyrean Anthem'], buff: 'Glacio DMG', desc: 'A noble warrior from the abyss. Skill summons Abyssal Patricius to conjure a frost barrier that blocks projectiles for 3s, then shatter it outward dealing 240% Glacio DMG to all enemies in range. Blocked attacks increase shatter DMG by 15% each.' , iconUrl: 'https://i.ibb.co/nqM5wjZc/Abyssal-Patricius-Icon.webp' },
  'Rage Against the Statue':         { sets: ['Eternal Radiance', 'Gusts of Welkin', 'Law of Harmony'], buff: 'Spectro DMG', desc: 'An animated statue filled with rage. Skill summons Rage Against the Statue to slam both fists downward dealing 192% Spectro DMG, sending shockwaves outward dealing 48% Spectro DMG x2. Enemies hit are staggered for 1.5s.' , iconUrl: 'https://i.ibb.co/JWzHhr1H/Rage-Against-the-Statue-Icon.webp' },
  'Vitreum Dancer':                  { sets: ['Eternal Radiance', 'Empyrean Anthem'], buff: 'Electro DMG', desc: 'A glass-like dancer that channels electricity. Skill summons Vitreum Dancer to perform a pirouette releasing 6 crystal shards dealing 32% Electro DMG each. Shards converge after 1.5s dealing 96% Electro DMG at the focal point.' , iconUrl: 'https://i.ibb.co/HpXcqH2X/Vitreum-Dancer-Icon.webp' },
  'Cuddle Wuddle':                   { sets: ['Frosty Resolve', 'Midnight Veil'], buff: 'Physical DMG', desc: 'A deceptively cuddly creature. Skill summons Cuddle Wuddle to lunge and bear-hug the target dealing 144% Physical DMG with a 2s bind, then body-slam for 144% Physical DMG. Bound enemies cannot dodge.' , iconUrl: 'https://i.ibb.co/C4kjd33/Cuddle-Wuddle-Icon.webp' },
  'Chop Chop':                       { sets: ['Empyrean Anthem', 'Tidebreaking Courage', 'Dream of the Lost'], buff: 'Fusion DMG', desc: 'A multi-armed chopping construct. Skill summons Chop Chop to rapidly chop with all arms dealing 36% Fusion DMG x6, then combine arms for an overhead cleave dealing 144% Fusion DMG. If all 6 chops connect, cleave DMG is doubled.' , iconUrl: 'https://i.ibb.co/8LRFvBW4/Chop-Chop-Icon.webp' },
  'Lightcrusher':                    { sets: ['Celestial Light'], buff: 'Spectro DMG', desc: 'A light-infused crushing construct. Skill summons Lightcrusher to charge up and slam a radiant hammer down for 216% Spectro DMG. Hold to extend charge for up to +50% bonus DMG. Fully charged slam creates a light pillar dealing 72% Spectro DMG to nearby enemies.' , iconUrl: 'https://i.ibb.co/RpYdQddL/Lightcrusher-Icon.webp' },
  'Rocksteady Guardian':             { sets: ['Celestial Light', 'Rejuvenating Glow'], buff: 'Spectro DMG', desc: 'A steadfast rock guardian. Skill summons Rocksteady Guardian to plant a Luminous Ward lasting 8s that grants nearby allies a shield absorbing DMG equal to 15% of caster Max HP. Ward pulses every 2s dealing 36% Spectro DMG to nearby enemies.' , iconUrl: 'https://i.ibb.co/8LG9k4bn/Rocksteady-Guardian-Icon.webp' },
  // ── 1-Cost Echoes ──
  ...
  'Lottie Lost':                     { sets: ['Tidebreaking Courage', 'Frosty Resolve'], buff: 'Spectro DMG', desc: 'A small whimsical Tacet Discord that wanders aimlessly. Skill summons Lottie Lost to attack enemies dealing 129% Spectro DMG.' , imageUrl: 'https://i.ibb.co/cSTS6Mqq/Lottie-Lost.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/C3SrXNVJ/Lottie-Lost-Icon.webp' },
  'Chest Mimic':                     { sets: ['Empyrean Anthem', 'Frosty Resolve', 'Midnight Veil'], buff: 'Spectro DMG', desc: 'A deceptive Tacet Discord disguised as a treasure chest. Skill summons Chest Mimic to attack with 3 consecutive strikes, each dealing 64% Spectro DMG.' , imageUrl: 'https://i.ibb.co/6RnrK82j/Chest-Mimic.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/8DgC4tmx/Chest-Mimic-Icon.webp' },
  'Aero Predator':                   { sets: ['Void Thunder', 'Sierra Gale'], buff: 'Aero DMG', desc: 'A nimble humanoid Tacet Discord that fires air projectiles. Skill summons Aero Predator to shoot 5 times: first 4 deal 17% Aero DMG, last deals 46% Aero DMG.' , imageUrl: 'https://i.ibb.co/k2qMgVKq/Aero-Predator.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/7tyC2t4T/Aero-Predator-Icon.webp' },
  'Glacio Predator':                 { sets: ['Freezing Frost', 'Celestial Light'], buff: 'Glacio DMG', desc: 'A nimble humanoid Tacet Discord that fires ice projectiles. Skill summons Glacio Predator to shoot 5 times: first 4 deal 17% Glacio DMG, last deals 46% Glacio DMG.' , imageUrl: 'https://i.ibb.co/jZ5pXHvK/Glacio-Predator.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/nqxnCjR3/Glacio-Predator-Icon.webp' },
  'Gulpuff':                         { sets: ['Freezing Frost', 'Celestial Light'], buff: 'Glacio DMG', desc: 'A bubble-blowing Tacet Discord. Skill summons Gulpuff to blow 3 frost bubbles that float toward enemies, each dealing 38% Glacio DMG on contact and slowing targets by 15% for 2s.' , imageUrl: 'https://i.ibb.co/TDX9tTPt/Gulpuff.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/zhxwmLGT/Gulpuff-Icon.webp' },
  'Aero Drake':                      { sets: ['Tidebreaking Courage', 'Gusts of Welkin', 'Flaming Clawprint'], buff: 'Aero DMG', desc: 'A wind-elemental drake. Skill summons Aero Drake to swoop forward dealing 48% Aero DMG, then flap its wings to release a gust dealing 48% Aero DMG and knocking enemies back.' , imageUrl: 'https://i.ibb.co/1YfjCKtz/Aero-Drake.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/4RFLGcTZ/Aero-Drake-Icon.webp' },
  'Electro Drake':                   { sets: ['Midnight Veil', 'Gusts of Welkin', 'Flaming Clawprint'], buff: 'Electro DMG', desc: 'A lightning-elemental drake. Skill summons Electro Drake to swoop forward dealing 48% Electro DMG, then discharge a bolt from its jaws dealing 48% Electro DMG that chains to 1 nearby enemy.' , imageUrl: 'https://i.ibb.co/tfKbcQW/Electro-Drake.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/Xx06HgcD/Electro-Drake-Icon.webp' },
  'Fusion Drake':                    { sets: ['Windward Pilgrimage', 'Flaming Clawprint'], buff: 'Fusion DMG', desc: 'A fire-elemental drake. Skill summons Fusion Drake to swoop forward dealing 48% Fusion DMG, then breathe a flame jet dealing 24% Fusion DMG x3.' , imageUrl: 'https://i.ibb.co/WvbT01pq/Fusion-Drake.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/jP5ctBKj/Fusion-Drake-Icon.webp' },
  'Glacio Drake':                    { sets: ['Gusts of Welkin', 'Windward Pilgrimage'], buff: 'Glacio DMG', desc: 'An ice-elemental drake. Skill summons Glacio Drake to swoop forward dealing 48% Glacio DMG, then exhale a frost blast dealing 48% Glacio DMG with a 20% chance to freeze for 1.5s.' , imageUrl: 'https://i.ibb.co/DH0Xc9ds/Glacio-Drake.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/jvDRpdWG/Glacio-Drake-Icon.webp' },
  'Havoc Drake':                     { sets: ['Windward Pilgrimage', 'Flaming Clawprint', 'Thread of Severed Fate'], buff: 'Havoc DMG', desc: 'A havoc-elemental drake. Skill summons Havoc Drake to swoop forward dealing 48% Havoc DMG, then release a corrosive orb dealing 48% Havoc DMG that reduces enemy Havoc RES by 5% for 6s.' , imageUrl: 'https://i.ibb.co/cS7gy29z/Havoc-Drake.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/PGM9yxdS/Havoc-Drake-Icon.webp' },
  'Spectro Drake':                   { sets: ['Windward Pilgrimage', 'Flaming Clawprint'], buff: 'Spectro DMG', desc: 'A spectro-elemental drake. Skill summons Spectro Drake to swoop forward dealing 48% Spectro DMG, then fire a light beam dealing 48% Spectro DMG in a line.' , imageUrl: 'https://i.ibb.co/Cp8qVJBw/Spectro-Drake.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/sr68RKk/Spectro-Drake-Icon.webp' },
  ...
  'Sacerdos':                        { sets: ['Gusts of Welkin', 'Windward Pilgrimage'], buff: 'Aero DMG', desc: 'A priestly creature that chants wind hymns. Skill summons Sacerdos to release a spiraling wind prayer dealing 32% Aero DMG x3, healing the active Resonator for 0.5% Max HP per hit.' , imageUrl: 'https://i.ibb.co/xKZsHqWy/Sacerdos.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/DfyWdfrm/Sacerdos-Icon.webp' },
  'Sagittario':                      { sets: ['Eternal Radiance', 'Gusts of Welkin', 'Flaming Clawprint'], buff: 'Spectro DMG', desc: 'An archer-like creature that fires arrows of light. Skill summons Sagittario to fire 3 spectral arrows dealing 28% Spectro DMG each, with the last arrow piercing through enemies.' , imageUrl: 'https://i.ibb.co/k6394kjK/Sagittario.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/mrzscNny/Sagittario-Icon.webp' },
  'La Guardia':                      { sets: ['Midnight Veil', 'Gusts of Welkin', 'Flaming Clawprint'], buff: 'Physical DMG', desc: 'A vigilant guard creature wielding a stone shield. Skill summons La Guardia to bash forward with its shield dealing 64% Physical DMG, then thrust its spear for 32% Physical DMG.' , imageUrl: 'https://i.ibb.co/S4RZBG3x/La-Guardia.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/j9wYBLjD/La-Guardia-Icon.webp' },
  'Calcified Junrock':               { sets: ['Empyrean Anthem', 'Tidebreaking Courage', 'Crown of Valor'], buff: 'Healing', desc: 'A calcified junrock variant hardened by mineral deposits. Skill summons Calcified Junrock to release a restorative pulse, healing the active Resonator for 2.0% Max HP + 80.' , imageUrl: 'https://i.ibb.co/jk4DB35N/Calcified-Junrock.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/HkprCbb/Calcified-Junrock-Icon.webp' },
  'Fission Junrock':                 { sets: ['Void Thunder', 'Rejuvenating Glow', 'Moonlit Clouds'], buff: 'Healing', desc: 'A fission-powered junrock that radiates warm energy. Skill summons Fission Junrock to split into 2 fragments, each healing a nearby ally for 1.5% Max HP + 60 on contact.' , imageUrl: 'https://i.ibb.co/QjD2Dcgs/Fission-Junrock.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/yBhnf1nj/Fission-Junrock-Icon.webp' },
  'Golden Junrock':                  { sets: ['Frosty Resolve', 'Eternal Radiance', 'Law of Harmony'], buff: 'Spectro DMG', desc: 'A golden junrock variant gleaming with spectral light. Skill summons Golden Junrock to roll into enemies dealing 48% Spectro DMG, then burst in a flash dealing 48% Spectro DMG in an area.' , imageUrl: 'https://i.ibb.co/N6mw8bb1/Golden-Junrock.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/R4Mtj1t6/Golden-Junrock-Icon.webp' },
  'Vanguard Junrock':                { sets: ['Void Thunder', 'Rejuvenating Glow', 'Lingering Tunes'], buff: 'Physical DMG', desc: 'A vanguard junrock variant armored with rocky plates. Skill summons Vanguard Junrock to charge headfirst into enemies dealing 64% Physical DMG, then spin and scatter debris for 32% Physical DMG.' , imageUrl: 'https://i.ibb.co/2J94GwJ/Vanguard-Junrock.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/zVGNLzdt/Vanguard-Junrock-Icon.webp' },
  'Diamondclaw':                     { sets: ['Moonlit Clouds', 'Lingering Tunes'], buff: 'Physical DMG', desc: 'A diamond-clawed creature with razor-sharp crystalline talons. Skill summons Diamondclaw to slash twice dealing 38% Physical DMG each, with a 30% chance to inflict Bleed for 24% Physical DMG over 4s.' , imageUrl: 'https://i.ibb.co/tTRpPm5m/Diamondclaw.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/FbjnCjz4/Diamondclaw-Icon.webp' },
  'Diggy Duggy':                     { sets: ['Eternal Radiance', 'Tidebreaking Courage'], buff: 'Physical DMG', desc: 'A burrowing creature that attacks from underground. Skill summons Diggy Duggy to tunnel beneath the target and erupt upward dealing 96% Physical DMG, launching hit enemies airborne.' , imageUrl: 'https://i.ibb.co/9HRrnmvf/Diggy-Duggy.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/DPQc8hqb/Diggy-Duggy-Icon.webp' },
  'Fae Ignis':                       { sets: ['Eternal Radiance', 'Midnight Veil', 'Dream of the Lost'], buff: 'Havoc DMG', desc: 'A fairy flame creature flickering with dark fire. Skill summons Fae Ignis to orbit the Resonator for 5s, shooting will-o-wisps at nearby enemies dealing 19% Havoc DMG per hit, up to 5 hits.' , imageUrl: 'https://i.ibb.co/zWRyGSZm/Fae-ignis.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/ZzcvGGGx/Fae-Ignis-Icon.webp' },
  'Frostscourge Stalker':            { sets: ['Eternal Radiance', 'Midnight Veil'], buff: 'Glacio DMG', desc: 'A frost-infused stalker that hunts in frozen terrain. Skill summons Frostscourge Stalker to pounce and bite dealing 64% Glacio DMG, then claw twice for 19% Glacio DMG each.' , imageUrl: 'https://i.ibb.co/fdqK7Myt/Frostscourge-Stalker.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/KcsfTX4n/Frostscourge-Stalker-Icon.webp' },
  'Voltscourge Stalker':             { sets: ['Midnight Veil', 'Empyrean Anthem'], buff: 'Electro DMG', desc: 'A voltage-infused stalker crackling with static. Skill summons Voltscourge Stalker to pounce and bite dealing 64% Electro DMG, then discharge a shock pulse for 32% Electro DMG in an area.' , imageUrl: 'https://i.ibb.co/pBFBn0fC/Voltscourge-Stalker.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/V0XSnvpX/Voltscourge-Stalker-Icon.webp' },
  ...
  'Hocus Pocus':                     { sets: ['Frosty Resolve', 'Empyrean Anthem'], buff: 'Havoc DMG', desc: 'A magical trickster creature wreathed in dark illusions. Skill summons Hocus Pocus to conjure 3 havoc orbs that home in on enemies, each dealing 32% Havoc DMG on impact.' , imageUrl: 'https://i.ibb.co/v4SQcJGL/Hocus-Pocus.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/6cN2yBFt/Hocus-Pocus-Icon.webp' },
  ...
  'Hoartoise':                       { sets: ['Freezing Frost', 'Celestial Light'], buff: 'Healing', desc: 'A hoary tortoise creature with a frost-covered shell. Skill summons Hoartoise to retract into its shell and emit a restorative aura, healing the active Resonator for 2.0% Max HP + 80.' , imageUrl: 'https://i.ibb.co/B5j9Znwc/Hoartoise.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/N29nQrMF/Hoartoise-Icon.webp' },
  'Sabyr Boar':                      { sets: ['Freezing Frost', 'Sierra Gale', 'Moonlit Clouds'], buff: 'Physical DMG', desc: 'A tusked boar creature that charges with reckless force. Skill summons Sabyr Boar to gore enemies with a charging headbutt dealing 96% Physical DMG. Hits from behind deal +25% bonus DMG.' , imageUrl: 'https://i.ibb.co/SDmW9Jwy/Sabyr-Boar.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/DHG4d72n/Sabyr-Boar-Icon.webp' },
  ...
  'Tick Tack':                       { sets: ['Havoc Eclipse', 'Rejuvenating Glow', 'Lingering Tunes'], buff: 'Havoc DMG', desc: 'A clock-like creature whose hands spin erratically. Skill summons Tick Tack to wind up and strike with its clock hands dealing 48% Havoc DMG x2. On the 2nd hit, briefly slows enemy action speed by 10% for 3s.' , imageUrl: 'https://i.ibb.co/zTw28r3t/Tick-Tack.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/jKXRM4g/Tick-Tack-Icon.webp' },
  'Chop Chop: Headless':             { sets: ['Eternal Radiance', 'Tidebreaking Courage'], buff: 'Fusion DMG', desc: 'The headless body of Chop Chop, swinging blindly. Skill summons Chop Chop: Headless to flail its arms wildly dealing 24% Fusion DMG x4 in a wide arc around it.' , imageUrl: 'https://i.ibb.co/KC74nDj/Chop-Chop-Headless.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/RpGDpLHH/Chop-Chop-Headless-Icon.webp' },
  'Chop Chop: Leftless':             { sets: ['Frosty Resolve', 'Tidebreaking Courage'], buff: 'Spectro DMG', desc: 'Chop Chop missing its left arm, compensating with spectral energy. Skill summons Chop Chop: Leftless to deliver a right-arm overhead chop for 64% Spectro DMG, then fire a spectral bolt from its stump for 32% Spectro DMG.' , imageUrl: 'https://i.ibb.co/7JDFGhXw/Chop-Chop-Leftless.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/spG4w7rH/Chop-Chop-Leftless-Icon.webp' },
  'Chop Chop: Rightless':            { sets: ['Frosty Resolve', 'Tidebreaking Courage'], buff: 'Havoc DMG', desc: 'Chop Chop missing its right arm, leaking havoc energy. Skill summons Chop Chop: Rightless to deliver a left-arm sweeping slash for 64% Havoc DMG, then release a havoc burst from its stump for 32% Havoc DMG.' , imageUrl: 'https://i.ibb.co/Q7kSy8xG/Chop-Chop-Rightless.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/VYQ3QPP2/Chop-Chop-Rightless-Icon.webp' },
  'Geospider S4':                    { sets: ['Pact of Neonlight Leap', 'Halo of Starry Radiance', 'Trailblazing Star'], buff: 'Spectro DMG', desc: 'A mechanical spider from Lahai-Roi. Skill summons Geospider S4 to fire a web mine that latches onto enemies dealing 32% Spectro DMG, detonating after 2s for 64% Spectro DMG.' , imageUrl: 'https://i.ibb.co/fYySnfX0/Geospider-S4.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/P7x6wBm/Geospider-S4-Icon.webp' },
  'Flora Drone':                     { sets: ['Pact of Neonlight Leap', 'Rite of Gilded Revelation', 'Sound of True Name'], buff: 'Aero DMG', desc: 'A botanical drone from Lahai-Roi. Skill summons Flora Drone to release pollen that heals the active Resonator for 1.5% Max HP + 60 and grants +10% ATK for 6s.' , imageUrl: 'https://i.ibb.co/jYgz8DL/Flora-Drone.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/yccgwMG1/Flora-Drone-Icon.webp' },
  ...
  'Nightmare: Chirpuff':             { sets: ['Law of Harmony'], buff: 'Aero DMG', desc: 'A nightmare variant of Chirpuff overinflated with nightmare wind. Skill summons Nightmare: Chirpuff to blast an enhanced gust 3 times, each dealing 48% Aero DMG and pulling enemies inward.' , imageUrl: 'https://i.ibb.co/bgjSz4hN/Nightmare-Chirpuff.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/ZzyktnkP/Nightmare-Chirpuff-Icon.webp' },
  'Nightmare: Dwarf Cassowary':      { sets: ['Thread of Severed Fate'], buff: 'Physical DMG', desc: 'A nightmare variant of the Dwarf Cassowary with razor-edged feathers. Skill summons Nightmare: Dwarf Cassowary to track and kick the enemy dealing 48% Physical DMG x3.' , imageUrl: 'https://i.ibb.co/VWhV8chg/Nightmare-Dwarf-Cassowary.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/n85hWpT6/Nightmare-Dwarf-Cassowary-Icon.webp' },
  'Nightmare: Gulpuff':              { sets: ['Law of Harmony'], buff: 'Glacio DMG', desc: 'A nightmare variant of Gulpuff exhaling freezing mist. Skill summons Nightmare: Gulpuff to launch 3 frost bubbles dealing 48% Glacio DMG each. Bubbles explode on contact, freezing enemies for 1s.' , imageUrl: 'https://i.ibb.co/ksZkkZHf/Nightmare-Gulpuff.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/2H3QWGB/Nightmare-Gulpuff-Icon.webp' },
  'Nightmare: Havoc Warrior':        { sets: ['Dream of the Lost'], buff: 'Havoc DMG', desc: 'A nightmare variant of the Havoc Warrior radiating dark energy. Skill transforms into Nightmare: Havoc Warrior to perform a Counter. Successful counter deals 336% Havoc DMG and reduces enemy Havoc RES by 10% for 5s.' , imageUrl: 'https://i.ibb.co/pBBX7ZXS/Nightmare-Havoc-Warrior.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/WvdsKkCT/Nightmare-Havoc-Warrior-Icon.webp' },
  'Nightmare: Tick Tack':            { sets: ['Thread of Severed Fate'], buff: 'Havoc DMG', desc: 'A nightmare variant of Tick Tack whose ticking distorts time. Skill summons Nightmare: Tick Tack to swing its pendulum dealing 64% Havoc DMG x2, then chime to slow all nearby enemies by 35% for 3s.' , imageUrl: 'https://i.ibb.co/yc0hSd53/Nightmare-Tick-Tack.png', noBgProcess: true, iconUrl: 'https://i.ibb.co/Y4FwmGSW/Nightmare-Tick-Tack-Icon.webp' },
};
