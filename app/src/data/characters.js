...
const CHARACTER_DATA = {
  ...
  'Chisa': { rarity: 5, element: 'Havoc', weapon: 'Broadblade', role: 'Support/Healer',
    desc: 'Startorch Academy student who binds fate upon a crimson thread. Havoc support/healer who deals heavy Resonance Liberation DMG, heals and shields the team, and shreds enemy DEF via Unseen Snare + Havoc Bane.',
...
const CHAR_BUFF_TABLE = {
  ...
  'Rebecca': {
    ...
    note: 'Outro: deploys a turret for 14s and grants the next Resonator 15% All DMG Amp (14s), ramping to 35% Heavy ATK DMG Amp via stacking Overlimit. Both buffs target the incoming Resonator only, not the whole team. Huntress/Guts mode swap grants self Crit DMG or DEF Ignore.',
  },
  'Denia': {
