...
const CHARACTER_DATA = {
  ...
  'Jianxin': { rarity: 5, element: 'Aero', weapon: 'Gauntlets', role: 'Support',
    // desc corrected 2026-09-08 (full-kit audit): "holds Basic Attack to cast Primordial Chi Spiral"
    // was the exact same Basic-ATK/Heavy-ATK mistranscription already found and fixed in
  ...
  'Yinlin': { rarity: 5, element: 'Electro', weapon: 'Rectifier', role: 'Sub DPS',
    ...
    desc: 'Enforcer Puppet — a skilled Patroller and powerful Natural Resonator of Jinzhou; after being suspended from her duties at the Public Security Bureau, she must now pursue hidden evils in secrecy. Electro sub-DPS/hybrid who applies Sinner\'s Mark and spends Magnetic Roar to enter Execution Mode, chaining extra Electromagnetic Blast procs onto her Basic ATK/Dodge Counter combo; once her Judgment Points meter fills, her Heavy Attack upgrades into Chameleon Cipher, escalating the Mark into an auto-triggering Coordinated Attack finisher. Her Outro amplifies the incoming Resonator\'s Electro and Liberation DMG.',
  ...
  'Changli': { rarity: 5, element: 'Fusion', weapon: 'Sword', role: 'Main DPS',
    desc: 'Eternal Blaze, counselor serving the Jinzhou Magistrate and former Secretary-General in the capital — shrouded in flames, she\'s fated to burn brightly until her final embers, rising to power with fiery determination and a strategic mindset always thinking ahead. On-field Fusion DPS who opens True Sight windows through her Basic Attacks, Skill, or Intro, then follows up to build Enflamement stacks; at 4 stacks her Heavy Attack becomes the enhanced Flaming Sacrifice nuke. Her Outro Strategy of Duality boosts the incoming Resonator\'s Fusion and Liberation DMG.',
  ...
  'Roccia': { rarity: 5, element: 'Havoc', weapon: 'Gauntlets', role: 'Sub DPS',
    desc: 'Stage in the Box, assistant, prop master, and improv comedian of the Troupe of Fools — always there to make sure the Troupe is at the ready, carrying a Magic Box that appears to hold the world, or perhaps a world she recreated inside it. Havoc sub-DPS/buffer built around her Imagination gauge, spent while airborne in Beyond Imagination to chain bouncing Real Fantasy attacks capped off by a Liberation finisher that grants the team a Crit-Rate-scaling ATK buff. Swapping out automatically fires her Outro, boosting the incoming Resonator\'s Havoc and Basic ATK DMG and lending them her pull-in Magic Box utility.',
  ...
  'Phoebe': { rarity: 5, element: 'Spectro', weapon: 'Rectifier', role: 'Sub DPS',
    ...
    desc: 'Graceful Luminescence, Acolyte of the Order of the Deep — a young woman of quiet devotion who fulfills her duties with unwavering diligence, her prayers offering comfort and peace like the light she carries. Dual-mode Spectro Hybrid whose passively-filling Prayer gauge lets her enter either self-buffed Absolution (Main DPS) or Frazzle-applying Confession (support) mode — the two are mutually exclusive, and each fuels her separate Divine Voice gauge powering an empowered Heavy Attack. Confession Phoebe is built specifically to empower Zani, her key Frazzle-DPS partner, via her Outro buff.',
  ...
  'Ciaccona': { rarity: 5, element: 'Aero', weapon: 'Pistols', role: 'Sub DPS',
    desc: 'Woven Melodies, a wandering bard from Rinascita — she sings not only for the Divinity, but also for the common folk, recording stories along her journeys and turning them into songs that evoke laughter, emotion, and tears in both the storytellers and the audience. Aero Hybrid who chains quick Basic ATK and Mid-air cancels to summon near-permanent Ensemble Sylph clones that boost team Aero DMG, then enters an extended Recital state via her Liberation to apply repeating waves of Aero Erosion or Spectro Frazzle even while off-field — buffing the incoming Resonator\'s Aero Erosion DMG through her Outro.',
  ...
  'Lupa': { rarity: 5, element: 'Fusion', weapon: 'Broadblade', role: 'Sub DPS',
    desc: 'Howling Flame, a Gladiator of Septimont and a radiant star of the arena — fiery and straightforward, Lupa lives like a wild lone wolf, and as long as she can savor the adrenaline rush of battle, she doesn\'t mind if that same fire ends up consuming her whole. Fusion Hybrid buffer who dumps her Liberation (Fire-Kissed Glory) immediately to grant the whole team an ATK buff and a Fusion RES-ignore buff that scales with Fusion teammate count, builds Wolfaith through Heavy and Mid-air Attacks toward her Forte finisher, then buffs the incoming Resonator\'s Fusion and Basic ATK DMG through her Outro — built around powering mono-Fusion teams.',
...
const CHAR_BUFF_TABLE = {
  ...
  'Lucilla': {
    ...
    note: 'Dual Resonance Mode: Glacio Chafe mode Outro amplifies team Glacio Chafe DMG by 60% (30s); Echo mode Outro grants next Resonator +50% Echo Skill DMG Amp (14s). Inherent Skill Slow Motion (on casting Spotlight): Chafe mode -8% Glacio RES near the active Resonator (30s); Echo mode team +25% Echo Skill DMG Bonus (30s) — ends early on mode switch either way. Forte Circuit Film Roll (Chafe mode: consumes 1 stack whenever another active teammate inflicts Glacio Chafe, to inflict Chafe 2x more herself) is modeled as a real ally-action-reactive block in lucilla.blocks.js (2026-09-08) — its payoff is an extra Chafe application, not a %-value, so it lives there rather than as a numeric row in this table.',
  },
  'Mornye': {
