...
const SKILL_MULTIPLIERS = {
  ...
  'Luuk Herssen': [
    ['Basic ATK', 'Stage 1-4', '40.56%×2 → 60.16%+90.24% → 5.02%×30 → 96.33%'],
    ['Mid-air', 'Scythe: Dissection Stage 2-3', '28.23%×2+37.63% → 42.93%×2+57.24%'],
    ['Mid-air', 'Scythe: Resection Stage 2-3', '50.42%×2 → 74.92%×2'],
    ['Skill', 'Golden Reflux', '201.20%'],
    ['Skill', 'Aureole of Execution', 'Ring 26.56%×5+88.53% / Breach 95.91%×3 / Glare 354.11%'],
    ['Skill', 'Basic Attack - Golden Impale', '155.47%'],
    ['Forte', 'Gavel of Earthshaker', '306.90%'],
    ['Liberation', "Rewritten in Winter's Margins", '745.54% + 49.71%×5'],
    ['Intro', 'Before Injection of Dawn', '72.67%×3'],
