...
export const CHARACTER_DESC_FR = {
  ...
  'Zhezhi': "Pinceau Enchanté — peintre timide et discrète de la scène artistique de Jinzhou dont les créations à l'encre prennent vie et combattent à son commandement ; sa timidité masque une dévotion farouche envers son art et ceux qu'elle appelle amis. Sous-DPS/soutien Glacio qui peint des Empreintes Fantasmagoriques durant son Attaque Normale et son combo Forte, les consomme pour déchaîner des nukes Glacio hors du terrain en Attaque Coordonnée via sa Libération de Résonance (Toile Vivante), et confère au personnage entrant un buff de DGT Glacio et DGT de Compétence via son Outro Sculpture et Dessin.",
  ...
  'Zani': "Éclat Calciné, membre de l'équipe de sécurité du Caveau d'Averardo et sa « Meilleure Employée » de longue date — elle a plein de projets pour son temps libre, mais pour l'instant sa plus grande mission est simple : pointer sa sortie à l'heure. DPS principal Spectro sur le terrain qui convertit le Spectro Frazzle des coéquipières en sa propre Braise Héliaque et Blaze dès qu'il se pose, accumule de l'Énergie Résiduelle via l'Attaque Normale et les parades pour débloquer sa Compétence renforcée, puis déverse tout en Mode Enfer via sa Libération pour une série de combos massifs de Frappes Lourdes marqués à la fois DGT d'Attaque Lourde et DGT de Spectro Frazzle — entièrement dépendante d'une coéquipière appliquant le Frazzle qu'elle convertit.",
...
export const CHAR_BUFF_NOTE_FR = {
  ...
  'Hiyuki': "DPS Glacio sur le terrain. L'Outro confère +20 % DGT Glacio au reste de l'équipe contre les cibles affectées par Givre Glaçant (20 s). Neige Fine Inhérente : personnel +40 % Dégâts Critiques à 1 cumul de Givre Rouillé, +30 %/+30 % Amplification de DGT Morsure Glacio à 1/3 cumuls. Nécessite des coéquipiers appliquant Givre Glaçant ou Havoc Fléau pour atteindre les cumuls max.",
...
export const CHARACTER_ROTATION_NOTE_FR = {
  ...
  'Lucilla': [
    'Changez pour elle — se déclenche automatiquement, restaure 100 des 150 points de Trace et inflige 1 cumul de Givre Glaçant.',
    ...
    'En mode Givre Glaçant, son Invocation d\'Écho peut être utilisée à tout moment de la rotation ; en équipes Compétence d\'Écho/Phrolova, utilisez-la et annulez par changement juste après Laisser Filer, avant l\'Outro.',
    'Se déclenche au changement de personnage. En mode Givre Glaçant, amplifie les DGT de Givre Glaçant près du Résonateur actif de +60 % pendant 30 s (persiste à travers le changement). En mode Écho, confère plutôt au Résonateur entrant +50 % d\'Amplification de DGT de Compétence d\'Écho pendant 14 s (perdu s\'il change de personnage).',
  ],
  'Rebecca': [
  ...
  'Hiyuki': [
    'Changez pour elle — se déclenche automatiquement, restaure 200 des 300 points de Dévotion et applique 1 cumul de Givre Glaçant.',
    'Appuyez UNE FOIS sur Attaque Basique — comme l\'Intro l\'a laissée préparée, ceci déclenche directement l\'Étape 3, restaurant les 100 derniers points de Dévotion (maintenant 300/300) et appliquant un autre cumul de Givre Glaçant.',
    'Une fois la Dévotion plafonnée, MAINTENEZ Attaque Basique (son Attaque Lourde est remplacée automatiquement) — tire 3 flèches d\'affilée, immunisée aux interruptions tout du long, appliquant Givre Glaçant sur le dernier coup. Annulez sa fin dès que possible en appuyant sur Libération.',
    'Appuyez sur Libération juste après les flèches — sans coût en Énergie, inflige un coup appliquant 4 cumuls de Givre Glaçant, confère 3 Iai du Givre Endurci, consomme toute la Dévotion et le Cœur de Givre (300), et entre en Soi Préordonné en restaurant 50 Cœur de Givre.',
    'Appuyez 3 fois sur Attaque Basique — son Attaque Basique est auto-remplacée par ce combo plus puissant (compté comme DGT de Libération), accumulant du Cœur de Givre ; l\'Étape 3 applique Givre Glaçant. Annulez la récupération de l\'Étape 3 en appuyant immédiatement sur Compétence.',
    ...
    'Appuyez 3 fois de plus sur Attaque Basique — l\'Étape 3 applique de nouveau Givre Glaçant. Annulez sa récupération en appuyant sur Esquive.',
    'Une fois le Cœur de Givre à 100+, appuyez sur Esquive pour revenir en arrière et entrer en Posture Iai, puis appuyez jusqu\'à 3 fois de suite sur Attaque Basique (chaque lancer coûte 100 Cœur de Givre, compté comme DGT de Libération) — chaque lancer consomme 1 cumul d\'Iai du Givre Endurci pour 3 cumuls de Givre Glaçant de plus et confère 1 Amertume Blanche, plafonnée à 3.',
    'Une fois Amertume Blanche à 3/3, MAINTENEZ Attaque Basique (Attaque Lourde remplacée automatiquement) — consomme l\'Endurance et les 3 Amertumes Blanches pour un coup qui applique Givre Glaçant et confère 1 Lame Givrée.',
    ...
    'Changez de personnage pour déclencher ceci automatiquement. Pendant 20 s, les coéquipiers proches autres que Hiyuki infligent +20 % d\'Amplification de DGT Glacio contre les cibles affectées par Givre Glaçant.',
  ],
  'Sigrika': [
  ...
  'Suisui': [
    'Changez pour elle — se déclenche automatiquement, inflige 1 cumul de Givre Glaçant, consomme tout le Souffle du Nuage pour attirer les cibles proches, et entre immédiatement en Posture de Bruine.',
    ...
    'Appuyez 4 fois sur Attaque Basique — chaque coup restaure plus d\'Épître Florale vers le maximum de 600 ; l\'Étape 4 inflige aussi Givre Glaçant. Annulez la récupération de l\'Étape 4 en appuyant immédiatement sur Libération.',
...
export const SKILL_NAME_FR = {
  ...
  'Sigrika': {
    ...
    'Soliskin to the Aid': 'Soliskin à la Rescousse',
  ...
  'Zani': {
    ...
    'Stage 3': 'Étape 3',
    'Standard': 'Standard',
    'Standard Defense Protocol': 'Protocole de Défense Standard',
    'Pinpoint Strike': 'Frappe Précise',
    'Targeted Action / Forcible Riposte': 'Action Ciblée / Riposte Forcée',
    'Heavy Slash: Daybreak': 'Coup Lourd : Aube',
    'Heavy Slash: Dawning': 'Coup Lourd : Éveil',
    'Heavy Slash: Nightfall': 'Coup Lourd : Ténèbres',
    'Heavy Slash: Daybreak → Dawning → Nightfall': 'Coup Lourd : Aube → Éveil → Ténèbres',
    'Heavy Slash: Lightsmash': 'Coup Lourd : Éclat Lumineux',
    'Rekindle': 'Réignition',
...
export const MULT_DESC_FR = {
  ...
  'Zani': {
    'Heavy Slash: Nightfall': '135,2 % + 262,4 % (+9,95 % par Blaze)',
    'Heavy Slash: Daybreak → Dawning → Nightfall': '198,8 % + 424,1 % + 135,2 %+262,4 %(+9,95 %/Blaze)',
    'Beacon For the Future': '150 % (+10 % par cumul de Blaze)',
  },
  'Zhezhi': {
...
export const SKILL_DESC_FR = {
  ...
  'Sigrika': {
    'Stage 1-4': "Enchaînement standard. Se termine en état Décrypter pour des suivis de type Écho.",
    'Elucidated': "Finisseur de type Écho depuis l'état Décrypter. Accumule des Runes.",
    'Decipher': "Finisseur de type Écho après Esquive depuis l'état Décrypter, mêmes multiplicateurs qu'Élucidée. Accumule des Runes.",
    'BOOMY BOOM!': "Accumule des Runes. La version renforcée inflige des DGT de Compétence d'Écho.",
    'BIG BOOMY BOOM!': "Compétence améliorée en état Décrypter, comptée comme DGT de Compétence d'Écho.",
    'Soliskin to the Aid': "Compétence améliorée en état Décrypter à 50+ Point Final, comptée comme DGT de Compétence d'Écho, met fin à Décrypter.",
    'Runic Outburst': "Attaque Lourde consommant des Runes (Confiance+Réponse) : DGT bonus purs, sans effet supplémentaire.",
    'Runic Chain Whip': "Attaque Lourde consommant des Runes (2× Confiance) : immobilise les cibles proches, DGT Aero.",
    'Runic Soliskin': "Attaque Lourde consommant des Runes (2× Réponse) : attire les cibles proches, DGT Aero. Non utilisée dans la rotation standard.",
    'Learn My True Name': "Gros nuke de type Écho une fois Point Final au maximum.",
  ...
  'Zani': {
    'Stage 1-4': "Enchaînement standard.",
    'Stage 3': "Sort manuellement de la posture de blocage du Protocole de Défense Standard.",
    'Standard': "Coup d'enchaînement chargé.",
    'Standard Defense Protocol': "Coup de base de Compétence de Résonance avant le suivi en posture de blocage.",
    'Pinpoint Strike': "Gain de parade du Protocole de Défense Standard.",
    'Targeted Action / Forcible Riposte': "Les deux ont la même valeur : Action Ciblée (relâchement sans coup subi) et Riposte Forcée (variante de parade) du Protocole de Réponse de Crise.",
    'Heavy Slash: Daybreak': "Première étape de son Attaque Lourde renforcée par le Forte. Consomme 10 Blaze.",
    'Heavy Slash: Dawning': "Deuxième étape, plus puissante, de l'Attaque Lourde de Forte. Consomme 20 Blaze.",
    'Heavy Slash: Nightfall': "Finisseur de Forte, consomme jusqu'à 40 Blaze. Monte en puissance avec le Blaze consommé.",
    'Heavy Slash: Daybreak → Dawning → Nightfall': "2e passage complet de l'enchaînement à 3 coups, mêmes valeurs par coup que le 1er passage.",
    'Heavy Slash: Lightsmash': "Contre-attaque de parade lancée automatiquement si Zani est touchée pendant la Posture Prête de Lumière Brûlante, avant de relâcher vers Aube.",
    'Rekindle': "Ultime qui augmente le Blaze maximal et entre en état Enfer.",
    'The Last Stand': "Second lancer d'Ultime en état Enfer, monte en puissance avec le Blaze consommé.",
    'Beacon For the Future': "Finisseur de changement de personnage qui confère aussi aux alliés touchant la cible marquée une Amplification de DGT Spectro.",
  },
  'Zhezhi': {
    'Standard': "Ne réinitialise pas le cycle d'Attaque Normale.",
    'Manifestation': "Recharge de 6 s. À 60+ Afflatus, invoque des Empreintes Fantasmagoriques (Gauche/Droite).",
    'Heavy ATK: Conjuration': "Suivi alternatif d'Attaque Lourde depuis plusieurs fenêtres de combo. Peut invoquer une Empreinte Centrale à 30+ Afflatus.",
