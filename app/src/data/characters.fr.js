...
export const GENERIC_SKILL_DESC_FR = {
  ...
  'Confirmed 2026-09-08 against the dump\'s own "Heavy Attack Damage: 41.36%×5" row (exact match). Do not confuse with the Deathblade Gear row below.':
    'Confirmée le 2026-09-08 contre la ligne « Heavy Attack Damage: 41.36%×5 » du dump (correspondance exacte). Ne pas confondre avec la ligne Équipement de Lame de Mort ci-dessous.',
  'Confirmed 2026-08-31 against the wiki Lv.10 "Heavy Attack DMG" row under Phantom Etching. While in Deathblade Gear (11s after Phantom Etching), Heavy Attack deals this boosted value instead of the normal-state row above, and is counted as Resonance Liberation DMG, not Heavy ATK DMG.':
    "Confirmée le 2026-08-31 contre la ligne « Heavy Attack DMG » du wiki Niv.10 sous Gravure Fantôme. En Équipement de Lame de Mort (11 s après Gravure Fantôme), l'Attaque Lourde inflige cette valeur renforcée au lieu de la ligne à l'état normal ci-dessus, et est comptée comme DGT de Libération de Résonance, pas DGT d'Attaque Lourde.",
  'Confirmed 2026-09-08 against the dump\'s own "Dodge Counter Damage: 66.48%×3+85.47%" row (exact match). Do not confuse with the Deathblade Gear row below.':
    'Confirmée le 2026-09-08 contre la ligne « Dodge Counter Damage: 66.48%×3+85.47% » du dump (correspondance exacte). Ne pas confondre avec la ligne Équipement de Lame de Mort ci-dessous.',
  'Confirmed 2026-08-31 against the wiki Lv.10 "Dodge Counter DMG" row under Phantom Etching. While in Deathblade Gear, Dodge Counter deals this boosted value instead of the normal-state row above, and is counted as Resonance Liberation DMG, not Dodge Counter DMG.':
    "Confirmée le 2026-08-31 contre la ligne « Dodge Counter DMG » du wiki Niv.10 sous Gravure Fantôme. En Équipement de Lame de Mort, la Contre-attaque d'Esquive inflige cette valeur renforcée au lieu de la ligne à l'état normal ci-dessus, et est comptée comme DGT de Libération de Résonance, pas DGT de Contre-attaque d'Esquive.",
};
...
export const SKILL_DESC_FR = {
  ...
  'Augusta': {
    ...
    'Dodge Counter': "Attaque Normale après Esquive ; confirmée inutilisée dans sa vraie rotation.",
    'Mid-air Dodge Counter': "Attaque Plongeante après Esquive Aérienne ; confirmée inutilisée dans sa vraie rotation.",
    'Steelclash': 'Enchaînement chargé de base.',
    'Dodge Counter - Steelclash': "Remplace la Contre-attaque d'Esquive à Prouesse maximale ; confirmée inutilisée dans sa vraie rotation.",
    'Thunderoar': "Enchaînement d'Attaque Lourde renforcé, débloqué à Ascendance maximale.",
    'Dodge Counter - Thunderoar: Backstep': "Remplace la Contre-attaque d'Esquive et sa variante Choc d'Acier à Ascendance maximale ; confirmée inutilisée dans sa vraie rotation.",
  ...
  'Calcharo': {
    'Gnawing Fangs Stage 1-4': "Confirmée le 2026-09-08 contre les lignes de Dégâts Partie 1-4 de Data dump/Calcharo/Calcharo.md (correspondance exacte).",
    'Plunging Attack': "Confirmée le 2026-09-08 contre la ligne « Mid-Air Attack Damage: 123.27% » du dump (correspondance exacte).",
    'Extermination Order Stage 1-3': "Correspondance exacte confirmée le 2026-08-31 contre les lignes de Dégâts Partie 1/2/3 du wiki Niv.10 (et à nouveau le 2026-09-08 contre les lignes correspondantes du dump). Temps de recharge de 10 s ; n'interrompt pas le cycle d'Attaque Normale. Chaque coup de Compétence confère 1 Cruauté (plafond 3) — gelée en Équipement de Lame de Mort.",
    'Heavy ATK: "Mercy"': 'Confirmée le 2026-09-08 contre la ligne « Mercy Damage: 39.11%×8+78.22% » du dump (correspondance exacte). À 3 Cruauté, l\'Attaque Lourde devient « Pitié » — consomme les 3 cumuls de Cruauté, restaure de l\'Énergie de Résonance/Concerto, comptée comme DGT d\'Attaque Lourde.',
    'Heavy ATK: "Death Messenger"': 'Confirmée le 2026-09-08 contre la ligne « Death Messenger Damage: 97.77%×8+195.53% » du dump (correspondance exacte). En Équipement de Lame de Mort, à 5 Intention Meurtrière, l\'Attaque Normale devient « Messager de la Mort » — consomme les 5 cumuls d\'Intention Meurtrière, restaure de l\'Énergie de Résonance/Concerto, comptée comme DGT de Libération de Résonance.',
    'Phantom Etching → Hounds Roar': "Correspondance exacte confirmée le 2026-08-31 contre les lignes de DGT de Compétence du wiki Niv.10 / Hurlement des Chiens Étape 1-5 (et à nouveau le 2026-09-08 contre le dump). Entre en Équipement de Lame de Mort (11 s, coût de 125 Énergie de Résonance, régén de 20 Énergie de Concerto) : l'Attaque Normale est remplacée par Hurlement des Chiens (chaque coup confère 1 Intention Meurtrière, plafond 5), l'Attaque Lourde/Contre-attaque d'Esquive infligent des DGT de Libération (voir les lignes Équipement de Lame de Mort ci-dessus).",
