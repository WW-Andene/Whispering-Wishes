...
const WEAPON_DATA = {
  ...
  'Freeze Frame': { rarity: 5, type: 'Rectifier', stat: 'Crit Rate', baseAtk: 588, subStatValue: '+24.3%',
    ...
    pv: { atkPct: 12, elemDmg: 30 }, bestFor: ['Lucilla'],
  ...
  'Verdant Summit': { rarity: 5, type: 'Broadblade', stat: 'Crit DMG', baseAtk: 587, subStatValue: '+48.6%',
    ...
    passive: 'Heavy Attack hits grant Resonance Skill DMG +20%', pv: { heavyDmg: 20 }, bestFor: ['Jiyan', 'Calcharo'],
  ...
  'Lustrous Razor': { rarity: 5, type: 'Broadblade', stat: 'ATK%', baseAtk: 587, subStatValue: '+36.4%',
    ...
    passive: 'ATK +12%, Electro DMG +12% on combo finisher', pv: { atkPct: 12, elemDmg: 12 }, bestFor: ['Calcharo', 'Jiyan'],
    ascensionMaterials: { forgery: 'Waveworn Residue', common: 'Whisperin Core' } },
  'Emerald of Genesis': { rarity: 5, type: 'Sword', stat: 'Crit Rate', baseAtk: 587, subStatValue: '+24.3%',
    ...
    passive: 'Resonance Skill use grants ATK +12%', pv: { atkPct: 12 }, bestFor: ['Danjin', 'Yangyang', 'Rover'],
  ...
  'Cosmic Ripples': { rarity: 5, type: 'Rectifier', stat: 'ATK%', baseAtk: 500, subStatValue: '+53.9%',
    ...
    passive: 'Basic Attack DMG +12%, stacks on hit', pv: { basicDmg: 12 }, bestFor: ['Encore', 'Verina', 'Yinlin'],
  ...
  'Stellar Symphony': { rarity: 5, type: 'Rectifier', stat: 'Energy Regen', baseAtk: 412, subStatValue: '+77.0%',
    ...
    passive: 'HP +12%, heal Skill → team ATK +14% for 30s', pv: { hpPct: 12 }, tv: { atkPct: 14, duration: 30 }, bestFor: ['Shorekeeper'],
    ascensionMaterials: { forgery: 'Helix', common: 'Ring' } },
  'Red Spring': { rarity: 5, type: 'Sword', stat: 'Crit Rate', baseAtk: 587, subStatValue: '+24.3%',
    ...
    passive: 'ATK +12%, Basic ATK DMG +10% per stack (max x3), +40% Basic DMG on Concerto consumed', pv: { atkPct: 12, basicDmg: 50 }, bestFor: ['Camellya', 'Rover'],
    ascensionMaterials: { forgery: 'Metallic Drip', common: 'Howler Core' } },
  ...
  'Waltz in Masquerade': { rarity: 4, type: 'Rectifier', stat: 'ATK%', baseAtk: 462, subStatValue: '+18.2%',
    ...
    passive: 'DMG to Negative Status enemies → ATK +4% (max x4, 10s)', pv: { atkPct: 16 }, bestFor: ['Rectifier DPS', 'Yinlin'] },
  ...
  'Call of the Abyss': { rarity: 4, type: 'Rectifier', stat: 'Energy Regen', baseAtk: 337, subStatValue: '+51.8%',
    ...
    passive: 'Liberation → Healing Bonus +16% for 15s', pv: { healingBonus: 16 }, bestFor: ['Rectifier healers'] },
  ...
  'Fusion Accretion': { rarity: 4, type: 'Rectifier', stat: 'ATK%', baseAtk: 462, subStatValue: '+18.2%',
    ...
    passive: 'Resonance Skill → +6 Resonance Energy, ATK +10% for 16s (20s CD)', pv: { atkPct: 10 }, bestFor: ['Rectifier DPS'] },
  'Celestial Spiral': { rarity: 4, type: 'Gauntlets', stat: 'ATK%', baseAtk: 462, subStatValue: '+18.2%',
    ...
    passive: 'Resonance Skill → +6 Resonance Energy, ATK +10% for 16s (20s CD)', pv: { atkPct: 10 }, bestFor: ['Gauntlet DPS'] },
  ...
  'Endless Collapse': { rarity: 4, type: 'Sword', stat: 'ATK%', baseAtk: 462, subStatValue: '+18.2%',
    ...
    passive: 'Resonance Skill → +6 Resonance Energy, ATK +10% for 16s (20s CD)', pv: { atkPct: 10 }, bestFor: ['Sword DPS', 'Rover'] },
  'Waning Redshift': { rarity: 4, type: 'Broadblade', stat: 'ATK%', baseAtk: 462, subStatValue: '+18.2%',
    ...
    passive: 'Resonance Skill → +6 Resonance Energy, ATK +10% for 16s (20s CD)', pv: { atkPct: 10 }, bestFor: ['Broadblade DPS', 'Jiyan', 'Calcharo'] },
  'Lumingloss': { rarity: 4, type: 'Sword', stat: 'ATK%', baseAtk: 387, subStatValue: '+36.4%',
    ...
    passive: 'Resonance Skill → Basic & Heavy ATK DMG +20% for 10s (1 stack max, 1s trigger interval)', pv: { basicDmg: 20, heavyDmg: 20 }, bestFor: ['Sword DPS'] },
  ...
  'Augment': { rarity: 4, type: 'Rectifier', stat: 'Crit Rate', baseAtk: 412, subStatValue: '+20.3%',
    ...
    passive: 'Liberation → ATK +15% for 15s', pv: { atkPct: 15 }, bestFor: ['Rectifier DPS', 'Yinlin'] },
  'Hollow Mirage': { rarity: 4, type: 'Gauntlets', stat: 'ATK%', baseAtk: 412, subStatValue: '+30.4%',
    ...
    passive: 'Liberation → 3 Iron Armor stacks, each +3% ATK and +3% DEF (max 3 stacks, no duration; lose 1 stack on taking damage)', pv: { atkPct: 9, defPct: 9 }, bestFor: ['Gauntlet users'] },
  ...
  'Autumntrace': { rarity: 4, type: 'Broadblade', stat: 'Crit Rate', baseAtk: 412, subStatValue: '+20.3%',
    ...
    passive: 'Basic/Heavy ATK DMG → ATK +4% per stack (max x5, 7s per stack, 1s trigger interval)', pv: { atkPct: 20 }, bestFor: ['Broadblade DPS', 'Jiyan', 'Calcharo'] },
