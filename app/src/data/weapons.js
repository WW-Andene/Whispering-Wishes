...
const WEAPON_DATA = {
  ...
  'Azure Oath': { rarity: 5, type: 'Sword', stat: 'Crit Rate', baseAtk: 588, subStatValue: '+24.3%',
    ...
    pv: { allDmg: 12, heavyDmg: 36, defIgnore: 12 }, bestFor: ['Yangyang: Xuanling'],
  ...
  'Ages of Harvest': { rarity: 5, type: 'Broadblade', stat: 'Crit Rate', baseAtk: 587, subStatValue: '+24.3%',
    ...
    passive: 'Attr DMG +12%, Intro/Skill → Res. Skill DMG +24% each (stacks)', pv: { elemDmg: 12, skillDmg: 48 }, bestFor: ['Jinhsi'],
    ascensionMaterials: { forgery: 'Waveworn Residue', common: 'Whisperin Core' } },
  ...
  'Red Spring': { rarity: 5, type: 'Sword', stat: 'Crit Rate', baseAtk: 587, subStatValue: '+24.3%',
    ...
    passive: 'ATK +12%, Basic ATK DMG +10% per stack (max x3), +40% Basic DMG on Concerto consumed', pv: { atkPct: 12, basicDmg: 50 }, bestFor: ['Camellya'],
    ascensionMaterials: { forgery: 'Metallic Drip', common: 'Howler Core' } },
  ...
  'Lunar Cutter': { rarity: 4, type: 'Sword', stat: 'ATK%', baseAtk: 412, subStatValue: '+30.4%',
    ...
    passive: 'Swap-in → 6 Oath stacks, each +2% ATK (max 6 stacks/+12%). Loses 1 stack every 2s. On kill: regain 6 stacks. 12s CD on swap-in trigger.', pv: { atkPct: 12 }, bestFor: ['Sword users'],
    ascensionMaterials: { forgery: 'Metallic Drip', common: 'Howler Core' } },
  ...
  'Endless Collapse': { rarity: 4, type: 'Sword', stat: 'ATK%', baseAtk: 462, subStatValue: '+18.2%',
    ...
    passive: 'Resonance Skill → +6 Resonance Energy, ATK +10% for 16s (20s CD)', pv: { atkPct: 10 }, bestFor: ['Sword DPS'] },
  'Waning Redshift': { rarity: 4, type: 'Broadblade', stat: 'ATK%', baseAtk: 462, subStatValue: '+18.2%',
    ...
    passive: 'Resonance Skill → +6 Resonance Energy, ATK +10% for 16s (20s CD)', pv: { atkPct: 10 }, bestFor: ['Broadblade DPS'] },
  ...
  'Autumntrace': { rarity: 4, type: 'Broadblade', stat: 'Crit Rate', baseAtk: 412, subStatValue: '+20.3%',
    ...
    passive: 'Basic/Heavy ATK DMG → ATK +4% per stack (max x5, 7s per stack, 1s trigger interval)', pv: { atkPct: 20 }, bestFor: ['Broadblade DPS'] },
