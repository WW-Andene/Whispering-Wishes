...
export const LUCY_BLOCKS = [
  // ── Damage blocks (from SKILL_MULTIPLIERS) ──
  {
    ...
    // as Aalto/Calcharo/Encore/Denia/Galbrena/Iuno/Jiyan/Lucilla's own Intro blocks.
    damage: { hits: parseSkillMultiplierHits('69.14%×2'), basis: 'ATK' },
  ...
  },
  {
    ...
    damage: { hits: parseSkillMultiplierHits('20.05%+10.03%+40.09%+10.03%+20.05%'), category: 'skillDmg', basis: 'ATK' },
  ...
  },
  {
    ...
    timing: {}, target: { scope: 'self' }, effects: [],
    damage: { hits: parseSkillMultiplierHits('30.86%×2+61.72%×3+61.72%'), category: 'skillDmg', basis: 'ATK' },
  ...
  },
  {
    ...
    damage: { hits: parseSkillMultiplierHits('20.66%+20.05%×2 → 36.06%×2+48.08% → 31.02%+15.51%×3+38.77%×2'), category: 'basicDmg', basis: 'ATK' },
  ...
  },
  {
    ...
    damage: { hits: parseSkillMultiplierHits('51.70%+206.77%'), category: 'heavyDmg', basis: 'ATK' },
  ...
  },
  {
    ...
    damage: { hits: parseSkillMultiplierHits('19.49%×4 → 22.27%×5 → 28.12%×5 → 25.06%×5'), category: 'heavyDmg', basis: 'ATK' },
  ...
  },
  {
    ...
    // Added 2026-09-02: previously not modeled (no matching SKILL_MULTIPLIERS row at all — this real
    // rotation step was silently 0 DMG), now sourced from a real .mht snapshot.
    damage: { hits: parseSkillMultiplierHits('33.41%×5'), category: 'heavyDmg', basis: 'ATK' },
  ...
  },
  {
    ...
    damage: { hits: parseSkillMultiplierHits('1789.29%'), category: 'heavyDmg', basis: 'ATK' },
  ...
  },
  {
    ...
    trigger: { type: 'cast', on: 'Skill:Pulse Interference' },
    timing: {}, target: { scope: 'self' }, effects: [],
    damage: { hits: [{ atkPct: 450 }], category: 'heavyDmg', basis: 'ATK' },
  ...
  },
  {
    ...
    timing: {}, target: { scope: 'self' },
    effects: [
      { stat: 'heavyDmg', value: 50, scopedToBlockId: 'lucy.liberation.old-net-deep-dive', source: 'self-kit' },
      { stat: 'critDmg', value: 100, scopedToBlockId: 'lucy.liberation.old-net-deep-dive', source: 'self-kit' },
    ],
