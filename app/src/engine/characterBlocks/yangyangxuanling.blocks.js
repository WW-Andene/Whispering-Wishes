...
export const YANGYANG_XUANLING_BLOCKS = [
  // ── Damage blocks (from SKILL_MULTIPLIERS) ──
  {
    ...
    damage: { hits: parseSkillMultiplierHits('116.59%') },
  ...
  },
  {
    ...
    damage: { hits: parseSkillMultiplierHits('47.72% → 20.14%×2+60.41% → 30.21%+70.48% → 18.57%×2+148.49%'), category: 'basicDmg' },
  ...
  },
  {
    ...
    damage: { hits: parseSkillMultiplierHits('69.95%+15.55%×3'), category: 'skillDmg' },
  ...
  },
  {
    ...
    timing: {}, target: { scope: 'self' }, effects: [],
    damage: { hits: parseSkillMultiplierHits('135.16%×2+180.21%'), category: 'heavyDmg' },
  ...
  },
  {
    ...
    timing: { duration: 4 },
    target: { scope: 'self' },
    effects: [{ stat: 'critDmg', value: 25, stacking: 'stacking', maxStacks: 6 }],
  ...
  },
  {
    ...
    target: { scope: 'self' },
    effects: [{ stat: 'critDmg', value: 160 }],
  ...
  },
  {
    ...
    effects: [{ stat: 'heavyDmg', value: 100 }],
