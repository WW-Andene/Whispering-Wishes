...
export const SHOREKEEPER_BLOCKS = [
  ...
  //    own kit text — correctly no damage block for either). ──
  {
    ...
    target: { scope: 'self' },
    effects: [],
    damage: { hits: parseSkillMultiplierHits('31.78% → 23.86%×2 → 23.32%×3 → 72.72%'), category: 'basicDmg', basis: 'ATK' },
  ...
  },
  {
    ...
    target: { scope: 'self' },
    effects: [],
    damage: { hits: parseSkillMultiplierHits('31.31%×5'), category: 'skillDmg', basis: 'ATK' },
  ...
  },
  {
    ...
    damage: { hits: parseSkillMultiplierHits('18.97%×5'), category: 'heavyDmg', basis: 'ATK' },
  ...
  },
  {
    ...
    target: { scope: 'self' },
    effects: [],
    damage: { hits: Array.from({ length: 4 }, () => ({ atkPct: 37.29 })), category: 'skillDmg', basis: 'ATK' },
  ...
  },
  {
    ...
    target: { scope: 'whole-team' },
    effects: [
      { stat: 'critRate', value: 12.5, stacking: 'refresh', source: 'self-kit' },
      { stat: 'critDmg', value: 25, stacking: 'refresh', source: 'self-kit' },
    ],
  ...
  },
  {
    ...
    timing: { duration: 30 },
    target: { scope: 'whole-team' },
    effects: [{ stat: 'atkPct', value: 40, stacking: 'refresh', source: 'self-kit' }],
  ...
  },
  {
    ...
    target: { scope: 'self' },
    effects: [
      { stat: 'totalMult', value: 42, source: 'self-kit' },
