...
export const REBECCA_BLOCKS = [
  // ── Damage blocks (from SKILL_MULTIPLIERS) ──
  {
    ...
    damage: { hits: parseSkillMultiplierHits('27.04%×6+40.56%+67.60%'), category: 'basicDmg', basis: 'ATK' },
  ...
  },
  {
    ...
    timing: {}, target: { scope: 'self' }, effects: [],
    damage: { hits: parseSkillMultiplierHits('61.69%×2 → 84.50% → 33.77%×2+157.57%'), category: 'basicDmg', basis: 'ATK' },
  ...
  },
  {
    ...
    timing: {}, target: { scope: 'self' }, effects: [],
    damage: { hits: parseSkillMultiplierHits('23.66%×4+35.49%×4'), category: 'skillDmg', basis: 'ATK' },
  ...
  },
  {
    ...
    damage: { hits: parseSkillMultiplierHits('10.00%×3+160.00%+10.00%'), category: 'basicDmg', basis: 'ATK' },
  ...
  },
  {
    ...
    timing: {}, target: { scope: 'self' }, effects: [],
    damage: { hits: parseSkillMultiplierHits('63.62%+572.58%'), category: 'basicDmg', basis: 'ATK' },
  ...
  // ── Buff blocks (from CHAR_BUFF_TABLE) ──
  {
    ...
    effects: [
      { stat: 'heavyDmg', value: 35, stacking: 'refresh', source: 'teammate-ally-action' },
  ...
  },
  {
    ...
    trigger: { type: 'cast', on: 'Liberation:BOOM! Fireworks!' },
    timing: {}, target: { scope: 'self' },
    effects: [{ stat: 'libDmg', value: 60, source: 'self-kit' }],
  ...
  // active), a buff-to-a-buff with no flat-schema equivalent — zeroed per the audit's own reasoning.
  {
    ...
    timing: { duration: 8 },
    target: { scope: 'self' },
    effects: [{ stat: 'basicDmg', value: 20, source: 'self-kit' }],
  ...
  },
  {
    ...
    trigger: { type: 'passive' },
    timing: {}, target: { scope: 'self' },
    effects: [{ stat: 'basicDmg', value: 40, source: 'self-kit' }],
  ...
  },
  {
    ...
    trigger: { type: 'cast', on: 'Forte:Rat-tat-tat!: Huntress' },
    timing: {}, target: { scope: 'self' }, effects: [],
    damage: { hits: [{ atkPct: 900 }], category: 'basicDmg', basis: 'ATK' },
