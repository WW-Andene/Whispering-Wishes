...
export const AEMEATH_BLOCKS = [
  ...
  },
  {
    ...
    timing: {}, target: { scope: 'self' }, effects: [],
    damage: { hits: parseSkillMultiplierHits('17.90%×4+35.79%×3+178.93%'), category: 'libDmg' },
  ...
  },
  {
    ...
    timing: {}, target: { scope: 'self' }, effects: [],
    damage: { hits: parseSkillMultiplierHits('17.90%+14.92%×6+23.86%×3+59.65%×3'), category: 'skillDmg' },
  ...
  },
  {
    ...
    timing: {}, target: { scope: 'self' }, effects: [],
    damage: { hits: parseSkillMultiplierHits('232.00%'), category: 'libDmg' },
  ...
  // ── Buff blocks (from CHAR_BUFF_TABLE) ──
  {
    ...
    effects: [{ stat: 'allDmg', value: 10, stacking: 'refresh' }],
