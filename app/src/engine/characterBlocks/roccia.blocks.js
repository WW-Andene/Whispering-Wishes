...
export const ROCCIA_BLOCKS = [
  ...
  },
  {
    ...
    damage: { hits: parseSkillMultiplierHits('104.19%×2'), category: 'basicDmg' },
  ...
  },
  {
    ...
    timing: {}, target: { scope: 'self' }, effects: [],
    damage: { hits: parseSkillMultiplierHits('61.47%×8'), category: 'skillDmg' },
  ...
  },
  {
    ...
    timing: {}, target: { scope: 'self' }, effects: [],
    damage: { hits: parseSkillMultiplierHits('322.08% → 339.97% → 357.86%'), category: 'heavyDmg' },
  ...
  },
  {
    ...
    timing: {}, target: { scope: 'self' }, effects: [],
    damage: { hits: parseSkillMultiplierHits('278.34%×3'), category: 'heavyDmg' },
  ...
  },
  {
    ...
    timing: { duration: 12 },
    target: { scope: 'self' },
    effects: [{ stat: 'defIgnore', value: 60 }],
