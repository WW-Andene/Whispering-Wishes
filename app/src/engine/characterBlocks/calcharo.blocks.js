...
export const CALCHARO_BLOCKS = [
  ...
  },
  {
    ...
    timing: {}, target: { scope: 'self' }, effects: [],
    damage: { hits: parseSkillMultiplierHits('88.07%→35.23%×2+52.84%×2→163.84%→34.82%×6→150.19%×2'), category: 'basicDmg' , basis: 'ATK' },
  ...
  },
  {
    ...
    trigger: { type: 'resource-threshold', resource: 'Killing Intent', threshold: 5, resourceStepOn: 'Forte:Heavy ATK: "Death Messenger"' },
    timing: {}, target: { scope: 'self' }, effects: [],
    damage: { hits: [{ atkPct: 100 }, { atkPct: 100 }], category: 'libDmg', basis: 'ATK' },
  ...
  { id: 'calcharo.chain.s3', source: SOURCE, kind: 'buff', section: 'Chain', trigger: { type: 'passive' }, timing: {}, target: { scope: 'self' }, effects: [{ stat: 'elemDmg', value: 25, source: 'self-kit' }] },
  {
