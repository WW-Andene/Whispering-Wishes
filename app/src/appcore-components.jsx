...
const IMPORT_GUIDE_DATA = {
  ...
  ps5: {
    ...
    steps: [
      ...
      <>Use the <span className="text-gray-100 font-medium">camera scan</span> below to capture the URL from your TV</>,
      <>Or type the <span className="text-gray-100 font-medium">IDs manually</span> from the URL</>,
    ],
