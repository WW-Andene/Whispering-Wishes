...
const ToastProvider = ({ children }) => {
  ...
  return (
    <ToastContext.Provider value={contextValue}>
      ...
      <div className="fixed bottom-20 left-3 right-3 z-[9500] flex flex-col gap-2 pointer-events-none" role="status" aria-live="polite" aria-atomic="true" style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}>
        {toasts.map(toast => (
