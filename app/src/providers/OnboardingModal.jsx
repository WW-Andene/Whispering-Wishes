...
const OnboardingModal = ({ onComplete }) => {
  ...
  const steps = [
    ...
    { title: "Import Your History", icon: <Upload size={32} />, desc: "Go to the Profile tab to import your Convene history.", gradient: 'from-neutral-900/30 via-neutral-900/20 to-cyan-900/30', border: 'border-cyan-500/30', bg: 'bg-cyan-500/20', color: '#22d3ee' },
