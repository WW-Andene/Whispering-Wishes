...
// (overflow-y: auto), not on the document/body — see getFrameEl() below,
// used by anything that used to assume document/body/window scrolling
// (scroll-position memory, IntersectionObserver roots, modal scroll locks,
// portals needing the scaled coordinate space).
// ═══════════════════════════════════════════════════════════════════════════════
