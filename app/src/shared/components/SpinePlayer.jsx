...
export const SPINE_CHARACTERS = {
  ...
  zanni:       { name: 'Zani',         element: 'Electro', scale: 2.2, tx: -1,  ty: 0 },
  feibi:       { name: 'Phoebe',       element: 'Spectro', scale: 2.1, tx: 5,   ty: 0 },
  linnai:      { name: 'Lynae',        element: 'Spectro', scale: 2.1, tx: 9,   ty: 0 },
