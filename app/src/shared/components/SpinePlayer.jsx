...
export const SPINE_CHARACTERS = {
  ...
  zanni:       { name: 'Zani',         element: 'Electro', scale: 2.2, tx: 0,   ty: -1 },
  feibi:       { name: 'Phoebe',       element: 'Spectro', scale: 2.2, tx: 6,   ty: -2 },
  linnai:      { name: 'Lynae',        element: 'Spectro', scale: 2.2, tx: 8,   ty: -2 },
