...
export const SPINE_CHARACTERS = {
  ...
  zanni:       { name: 'Zani',         element: 'Electro', scale: 2.2, tx: 0,   ty: -6 },
  feibi:       { name: 'Phoebe',       element: 'Spectro', scale: 2.0, tx: 5,   ty: -7 },
  linnai:      { name: 'Lynae',        element: 'Spectro', scale: 2.0, tx: 9,   ty: -7 },
