...
export const SPINE_CHARACTERS = {
  ...
  zanni:       { name: 'Zani',         element: 'Electro', scale: 2.0, tx: -1,  ty: -6 },
  feibi:       { name: 'Phoebe',       element: 'Spectro', scale: 1.9, tx: 5,   ty: -10 },
  linnai:      { name: 'Lynae',        element: 'Spectro', scale: 1.9, tx: 9,   ty: -12 },
