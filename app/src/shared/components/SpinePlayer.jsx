...
export const SPINE_CHARACTERS = {
  xigelika:    { name: 'Sigrika',      element: 'Aero',    scale: 2.3, tx: 1, ty: 2 },
  qiuyuan:     { name: 'Qiuyuan',      element: 'Aero',    scale: 2.3, tx: 1, ty: 2 },
  zanni:       { name: 'Zani',         element: 'Electro', scale: 2.3, tx: 1, ty: 2 },
  feibi:       { name: 'Phoebe',       element: 'Spectro', scale: 2.3, tx: 1, ty: 2 },
  linnai:      { name: 'Rinne',        element: 'Havoc',   scale: 2.3, tx: 1, ty: 2 },
  jinxi:       { name: 'Jinhsi',       element: 'Spectro', scale: 2.3, tx: 1, ty: 2 },
  luokeke:     { name: 'Lumi',         element: 'Glacio',  scale: 2.3, tx: 1, ty: 2 },
  yinlin:      { name: 'Yinlin',       element: 'Electro', scale: 2.3, tx: 1, ty: 2 },
  bulante:     { name: 'Brant',        element: 'Fusion',  scale: 2.3, tx: 1, ty: 2 },
  jiyan:       { name: 'Jiyan',        element: 'Aero',    scale: 2.3, tx: 1, ty: 2 },
  xiangliyao:  { name: 'Xiangli Yao',  element: 'Electro', scale: 2.3, tx: 1, ty: 2 },
  changli:     { name: 'Changli',      element: 'Fusion',  scale: 2.3, tx: 1, ty: 2 },
  chun:        { name: 'Chun',         element: 'Glacio',  scale: 2.3, tx: 1, ty: 2 },
};
