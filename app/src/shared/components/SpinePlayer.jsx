...
export const SPINE_CHARACTERS = {
  xigelika:    { name: 'Sigrika',      element: 'Aero',    scale: 2.3, tx: 1, ty: 1 },
  qiuyuan:     { name: 'Qiuyuan',      element: 'Aero',    scale: 2.3, tx: 1, ty: 1 },
  zanni:       { name: 'Zani',         element: 'Electro', scale: 2.3, tx: 1, ty: 1 },
  feibi:       { name: 'Phoebe',       element: 'Spectro', scale: 2.3, tx: 1, ty: 1 },
  linnai:      { name: 'Rinne',        element: 'Havoc',   scale: 2.3, tx: 1, ty: 1 },
  jinxi:       { name: 'Jinhsi',       element: 'Spectro', scale: 2.3, tx: 1, ty: 1 },
  luokeke:     { name: 'Lumi',         element: 'Glacio',  scale: 2.3, tx: 1, ty: 1 },
  yinlin:      { name: 'Yinlin',       element: 'Electro', scale: 2.3, tx: 1, ty: 1 },
  bulante:     { name: 'Brant',        element: 'Fusion',  scale: 2.3, tx: 1, ty: 1 },
  jiyan:       { name: 'Jiyan',        element: 'Aero',    scale: 2.3, tx: 1, ty: 1 },
  xiangliyao:  { name: 'Xiangli Yao',  element: 'Electro', scale: 2.3, tx: 1, ty: 1 },
  changli:     { name: 'Changli',      element: 'Fusion',  scale: 2.3, tx: 1, ty: 1 },
  chun:        { name: 'Chun',         element: 'Glacio',  scale: 2.3, tx: 1, ty: 1 },
};
