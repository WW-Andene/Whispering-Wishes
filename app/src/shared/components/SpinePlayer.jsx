...
export const SPINE_CHARACTERS = {
  ...
  zanni:       { name: 'Zani',         element: 'Electro', scale: 1.9, tx: -1,  ty: -6 },
  feibi:       { name: 'Phoebe',       element: 'Spectro', scale: 1.9, tx: 6,   ty: -10 },
  linnai:      { name: 'Lynae',        element: 'Spectro', scale: 1.9, tx: 9,   ty: -11 },
