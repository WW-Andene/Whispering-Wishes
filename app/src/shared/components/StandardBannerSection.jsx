          ...
          <div className="flex items-center gap-3">
            <div className="flex-1 flex items-center gap-3">
              <div className="text-center">
                <div className={`font-bold text-sm kuro-number ${profileData.pity5 >= HARD_PITY ? 'text-red-500 font-bold animate-pulse' : profileData.pity5 >= 75 ? 'text-red-400' : profileData.pity5 >= SOFT_PITY_START ? 'text-amber-400' : 'text-cyan-400'}`}>{profileData.pity5}<span className="text-gray-400 text-[10px]">/{HARD_PITY}</span></div>
              ...
              <div className="text-center">
                <div className="text-purple-400 font-bold text-sm kuro-number">{profileData.pity4}<span className="text-gray-400 text-[10px]">/10</span></div>
