...
const TabButton = memo(({ active, onClick, children, tabRef, tabId, accentColor }) => {
  ...
  return (
    <button
      ...
      className="relative flex flex-col items-center justify-center gap-0.5 px-3 py-1 text-sm font-medium text-white transition-all duration-300 whitespace-nowrap group active:scale-[0.97]"
    >
