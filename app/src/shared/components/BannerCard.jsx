      ...
      {imgUrl && (
        <div className="absolute inset-0" style={IMG_LAYER_STYLE}>
          <img
            ...
            style={{
              opacity: 1,
              filter: 'saturate(0) brightness(1.2) sepia(1) hue-rotate(90deg) saturate(10) contrast(1.5)',
      ...
      {debugSpine && (
        <div className="absolute inset-0" style={{ zIndex: 2 }}>
          <SpinePlayer
            ...
            style={{ opacity: 0.25, filter: 'saturate(0) brightness(1.2) sepia(1) hue-rotate(0deg) saturate(10) contrast(1.5)' }}
