  ...
  <div>
    <div className="flex items-center gap-4 mb-2">
      ...
      <div className="flex-1">
        ...
        {pity >= SOFT_PITY_START && <p className={`text-xs ${softPityClass}`} style={{ color: softColor }}><SoftPityIcon size={10} className="inline mr-1" style={{ color: softColor, filter: `drop-shadow(0 0 4px ${softColor})` }} />Soft Pity Zone!</p>}
      </div>
