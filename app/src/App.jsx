          ...
          <div className="header-top flex items-center justify-between py-1.5">
            <div className="flex items-center gap-2">
              <div className="relative group cursor-pointer" onClick={async () => {
                ...
                <div className="relative min-w-[44px] min-h-[44px] flex items-center justify-center rounded-lg overflow-visible group-hover:scale-[1.02] transition-transform" style={activeTheme ? { background: 'rgba(15,20,28,0.3)', borderRadius: 'var(--radius-lg)' } : { ...headerControlBg, border: `1px solid var(--border-medium)`, borderRadius: 'var(--radius-md)' }}>
                  <img src={HEADER_ICON} alt="Whispering Wishes logo" style={{ width: 60, height: 60, margin: -8 }} className="object-contain" />
                </div>
