                ...
                <div className="overflow-y-auto flex-1 p-2">
                  <div className="space-y-1">
                    ...
                    <button
                      ...
                      className="w-full p-2 rounded-lg border border-dashed border-white/15 text-xs text-gray-400 hover:border-red-500/30 hover:text-red-400 transition-all text-left"
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <div className="flex-1 min-w-0">
                                <div className="flex items-center gap-1.5">
                                  ...
                                  {isRec && <span className="text-xs px-1 py-0.5 rounded font-bold bg-orange-500 text-white kuro-tshadow-badge">★ REC</span>}
                                </div>
                                <div className="flex items-center gap-1 mt-0.5 flex-wrap">
                                  {buffs.map(b => <span key={b} className="text-xs text-gray-400">{b}</span>)}
                                  {ed?.sets && <span className="text-xs text-gray-500">· {ed.sets.join(', ')}</span>}
                                </div>
                              </div>
                            </div>
                          </button>
                  ...
                  {echoData && (
                    <div>
                      ...
                      <div className="kuro-detail-box">
                        ...
                        {echoData.dmg === 0 && (
                          <div className="text-xs text-gray-500 mb-1">Utility / Healing (no damage)</div>
                        )}
                        <p className="text-xs text-gray-400 leading-relaxed">{echoData.desc}</p>
                      </div>
                    </div>
                  )}
                  ...
                  {echoData?.enemyRes && (
                    <div>
                      ...
                      <div className="kuro-detail-box kuro-detail-box--danger">
                        ...
                        <p className="text-xs text-gray-500 mt-1">Boss echo — can be selected as DPS target</p>
                      </div>
                    </div>
                  )}
