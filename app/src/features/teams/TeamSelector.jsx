                            ...
                            {filteredChars.map(name => {
                              ...
                              return (
                                ...
                                >
                                  ...
                                  {/* Element dot */}
                                  <div className="absolute top-1 left-1 w-3.5 h-3.5 rounded-full text-base font-bold text-white flex items-center justify-center"
                                  ...
                                  {isRecommended && (
                                    <div className="absolute top-0.5 right-0.5 z-10">
                                      <span className="text-base px-1 py-0.5 rounded font-bold bg-orange-500 text-white kuro-tshadow-badge">★ REC</span>
                                    </div>
                                  )}
                                  {/* Role tag */}
                                  {cd?.role && (
                                    <div className="absolute bottom-4 inset-x-0 flex justify-center">
                                      <span className="text-base px-1 py-0.5 rounded bg-black/60 text-gray-300 border border-[var(--border-medium)]">{cd.role}</span>
                                    </div>
                                  )}
                                  {/* Name */}
                                  <div className="absolute bottom-0 inset-x-0 p-1 z-10">
                                    <div className="text-white text-base font-medium truncate text-center leading-tight">{name}</div>
                                  </div>
                                </button>
                              );
                            })}
