    ...
    <Card>
      ...
      <CardBody>
          ...
          {ordered.map((row, i) => {
            ...
            return (
              <div key={i} style={{ position: 'relative', height: 22, marginBottom: 2 }}>
                ...
                {/* Label */}
                <span className={`absolute text-base ${isField ? 'font-bold text-gray-300' : isEcho ? 'text-gray-400' : 'text-gray-500'}`}
                ...
                <div className={`absolute flex items-center ${isField ? 'rounded' : 'rounded-sm'}`}
                  ...
                  <span className={`truncate px-1 ${isField ? 'text-base font-bold' : 'text-base'}`}
        ...
        <div style={{ position: 'relative', height: 14, marginTop: 4 }}>
          {ticks.map(tick => (
            <span key={tick} className="absolute text-base text-gray-600 -translate-x-1/2"
