                  ...
                  <div className="flex gap-3">
                    {imgUrl && (
                      <div className="w-14 h-14 rounded-lg overflow-hidden border border-yellow-500/40 flex-shrink-0 bg-black/25">
                        <img src={imgUrl} alt="" className="w-full h-full object-cover pointer-events-none" style={{ objectPosition: 'center top', transform: 'translateY(-3.3%) scale(1.9)', transformOrigin: 'top' }} onError={hideOnError} />
                      </div>
                    )}
