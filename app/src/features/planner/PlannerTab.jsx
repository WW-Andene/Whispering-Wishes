...
function PlannerTab({
  ...
  const planData = useMemo(() => {
    ...
    // independent goal fields and a fixed 50/50 split (direct user request 2026-09-10:
    // "plan should not be wired on calc slider unless button link used... assume 50/50 by
    // default"). "By end" reruns the same allocation with astrite/lunite bumped to the
    // projected total (tides don't accrue via dailyIncome, so they stay as-is).
    const goalCalcLike = {
