  ...
  return (
    <Card className="stats-full-width">
      ...
      <CardBody>
        ...
        {chartHist.length < 10 ? (
          <p className="kuro-empty-state text-gray-400 text-sm text-center py-4">No data for this filter. Try a different banner type or time range.</p>
        ) : allData.length < 2 ? (
          <p className="kuro-empty-state text-gray-400 text-sm text-center py-4">No data for this combination. Try a different filter or time range.</p>
        ) : (
          <>
