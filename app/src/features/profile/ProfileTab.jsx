          ...
          <div className="kuro-calc space-y-3 tab-content">
            ...
            <Card>
              ...
              <CardBody className="space-y-3">
                ...
                {aboutExpanded && (<div id="about-legal-content" className="space-y-4 animate-in fade-in">
                <div className="kuro-divider" />

                {/* ── DISCLAIMER ──────────────────────────────── */}
                <div className="text-[10px] text-gray-400 space-y-1.5" style={{ background: 'var(--bg-stat)', borderRadius: 8, padding: '10px 12px' }}>
                  <p className="font-semibold text-gray-300 text-[11px]">Disclaimer</p>
                ...
                {/* ── PRIVACY POLICY ──────────────────────────── */}
                <div className="text-[10px] text-gray-400 space-y-3" style={{ background: 'var(--bg-stat)', borderRadius: 8, padding: '10px 12px' }}>
                  <p className="font-semibold text-gray-300 text-[11px]">Privacy Policy</p>
                ...
                {/* ── TERMS OF USE ────────────────────────────── */}
                <div className="text-[10px] text-gray-400 space-y-2" style={{ background: 'var(--bg-stat)', borderRadius: 8, padding: '10px 12px' }}>
                  <p className="font-semibold text-gray-300 text-[11px]">Terms of Use</p>
                ...
                {/* ── ATTRIBUTION ─────────────────────────────── */}
                <div className="text-[10px] text-gray-400 space-y-1.5" style={{ background: 'var(--bg-stat)', borderRadius: 8, padding: '10px 12px' }}>
                  <p className="font-semibold text-gray-300 text-[11px]">Data Sources</p>
                  <p>Banner schedules, event timings, and countdown data sourced from:</p>
