              ...
              <CardBody className="space-y-3">
                {googleUser ? (
                  <>
                    ...
                    {cloudBackupStatus === 'done' && <div className="text-center text-emerald-400 text-[10px]">Done!</div>}
                  </>
                ) : (
                  <button
                ...
                <p className="text-gray-600 text-[10px] text-center">Sync your Convene history across devices</p>
              </CardBody>
            </Card>
