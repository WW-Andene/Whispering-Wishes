                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="flex-shrink-0 flex flex-col items-center">
                        ...
                        {state.profile.profilePic && (
                          <p className="text-gray-500 text-center mt-1 truncate" style={{ fontSize: 'var(--font-base)', width: 'var(--size-avatar-lg)' }}>{state.profile.profilePic}</p>
                        )}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="idcard-section">
                    ...
                    {[
                      ...
                      <div key={i} className="relative rounded-lg px-2 py-1.5 text-center overflow-hidden" style={{ background: s.bg, border: `1px solid ${s.bc}` }}>
                        ...
                        <div className="text-gray-500 mt-0.5" style={{ fontSize: 'var(--font-base)', letterSpacing: '0.04em' }}>{s.label}</div>
                      </div>
                    ))}
                    </div>
                  </div>
                    ...
                    return (
                      <div className="idcard-section">
                        ...
                        <div className="flex gap-1.5">
                          {labs.map((lab, i) => (
                            <div key={i} className="flex-1 text-center" style={{ fontSize: 'var(--font-base)', color: '#6b7280' }}>{lab.split('-')[0]}</div>
                          ))}
                        </div>
                      ...
                      <div className="grid grid-cols-5 gap-1.5">
                        ...
                        {ownedCharNames.length > 16 && (
                          <div className="flex items-center justify-center rounded-lg w-full kuro-border-subtle" style={{ aspectRatio: '9/14', background: 'var(--bg-stat)' }}>
                            <span className="text-gray-500 font-mono" style={{ fontSize: 'var(--font-base)' }}>+{ownedCharNames.length - 16}</span>
                          </div>
                        )}
                      </div>
                    </div>
