  ...
  try {
    ...
    if (request.mode === 'navigate') {
      ...
      return new Response(
        ...
        <style>body{background:#080c14;color:#e2e8f0;font-family:'Exo 2',system-ui,sans-serif;display:flex;align-items:center;justify-content:center;min-height:100vh;margin:0;text-align:center}
