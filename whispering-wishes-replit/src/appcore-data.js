...
[
  ...
  ['Mourning Aix', 393, 'Spectro', { spectro: 40 }],
  ['Feilian Beringal', 514, 'Aero', { aero: 40 }],
  ['Tempest Mephis', 379, 'Electro', { electro: 40 }],
  ['Thundering Mephis', 453, 'Electro', { electro: 40 }],
  ['Inferno Rider', 806, 'Fusion', { fusion: 40 }],
  ['Bell-Borne Geochelone', 145, 'Glacio', { glacio: 40 }],
  ['Impermanence Heron', 420, 'Havoc', { havoc: 40 }],
  ['Lampylumen Myriad', 686, 'Glacio', { glacio: 40 }],
  ['Mech Abomination', 528, 'Electro', { electro: 40 }],
  ['Crownless', 435, 'Havoc', { havoc: 40 }],
  ['Jué', 287, 'Spectro', { spectro: 40 }],
  ['Fallacy of No Return', 0, 'Spectro', { spectro: 40 }],
  ['Sentry Construct', 810, 'Glacio', { glacio: 40 }],
  ['Dreamless', 540, 'Havoc', { havoc: 40 }],
  ['Nightmare: Impermanence Heron', 400, 'Havoc', { havoc: 40 }],
  ['Nightmare: Lampylumen Myriad', 273, 'Glacio', { glacio: 40 }],
  ['Dragon of Dirge', 180, 'Fusion', { fusion: 40 }],
  ['Nightmare: Hecate', 456, 'Havoc', { havoc: 40 }],
  ['Hecate', 553, 'Havoc', { havoc: 40 }],
  ['Nightmare: Crownless', 405, 'Havoc', { havoc: 40 }],
  ['Nightmare: Mourning Aix', 273, 'Spectro', { spectro: 40 }],
  ['Nightmare: Feilian Beringal', 269, 'Aero', { aero: 40 }],
  ['Nightmare: Inferno Rider', 688, 'Fusion', { fusion: 40 }],
  ['Nightmare: Tempest Mephis', 405, 'Electro', { electro: 40 }],
  ['Nightmare: Thundering Mephis', 405, 'Electro', { electro: 40 }],
  ['Reminiscence: Fleurdelys', 352, 'Aero', { aero: 40 }],
  ['Lioness of Glory', 273, 'Fusion', { fusion: 40 }],
  ['The False Sovereign', 625, 'Electro', { electro: 40 }],
  ['Lady of the Sea', 294, 'Aero', { aero: 40 }],
  ['Corrosaurus', 273, 'Fusion', { fusion: 40 }],
  ['Reminiscence: Threnodian - Leviathan', 454, 'Havoc', { havoc: 40 }],
  ['Hyvatia', 270, 'Spectro', { spectro: 40 }],
  ['Twin Nova - Nebulous Cannon', 160, 'Spectro', { spectro: 40 }],
  ['Sigillum', 273, 'Fusion', { fusion: 40 }],
  ['Reactor Husk', 553, 'Fusion', { fusion: 40 }],
  ['Nameless Explorer', 453, 'Aero', { aero: 40 }],
  ['Lorelei', 408, 'Havoc', { havoc: 40 }],
  ['Nightmare: Kelpie', 453, 'Glacio', { glacio: 40 }],
  ['Reminiscence: Fenrico', 459, 'Aero', { aero: 40 }],
