...
const CHARACTER_DATA = {
  ...
  'Rover': { rarity: 5, element: 'Spectro', elements: ['Spectro', 'Havoc', 'Aero'], weapon: 'Sword', role: 'Sub DPS',
    desc: 'A wanderer who awoke with no memory on the shores of Solaris. Adapts between Spectro, Havoc, and Aero Resonance forms.',
  ...
  'Jiyan': { rarity: 5, element: 'Aero', weapon: 'Broadblade', role: 'Main DPS',
    desc: 'General of the Midnight Rangers who commands the azure dragon. Devastating burst DPS through Qingloong Mode aerial combos.',
  ...
  'Calcharo': { rarity: 5, element: 'Electro', weapon: 'Broadblade', role: 'Main DPS',
    desc: 'Notorious mercenary known as "The Ghost." Relentless combo-chain Electro DPS who devours enemies in Death Messenger mode.',
  ...
  'Encore': { rarity: 5, element: 'Fusion', weapon: 'Rectifier', role: 'Main DPS',
    desc: 'Eccentric puppeteer who performs alongside Cosmos and Cloudy. Unleashes fiery Rampage mode for massive Fusion burst.',
  ...
  'Jianxin': { rarity: 5, element: 'Aero', weapon: 'Gauntlets', role: 'Support',
    desc: 'Martial artist who seeks inner peace through combat. Provides shields, enemy grouping, and Aero DMG buffs.',
  ...
  'Lingyang': { rarity: 5, element: 'Glacio', weapon: 'Gauntlets', role: 'Main DPS',
    desc: 'Opera performer possessed by the spirit of a lion. Soars through the air in Lion Form for sustained Glacio aerial combos.',
  ...
  'Verina': { rarity: 5, element: 'Spectro', weapon: 'Rectifier', role: 'Healer',
    desc: 'Gentle botanist devoted to the study of life. Premium healer whose blooming flowers grant ATK buffs and DMG Deepen.',
  ...
  'Yinlin': { rarity: 5, element: 'Electro', weapon: 'Rectifier', role: 'Sub DPS',
    desc: 'Covert government investigator who manipulates puppet Zapstring from the shadows. Off-field Electro Coordinated Attacks.',
  ...
  'Jinhsi': { rarity: 5, element: 'Spectro', weapon: 'Broadblade', role: 'Main DPS',
    desc: 'Magistrate of Jinzhou who bears a connection to the Sentinel Jué. Channels Incarnation for devastating Spectro AoE burst.',
  ...
  'Changli': { rarity: 5, element: 'Fusion', weapon: 'Sword', role: 'Sub DPS',
    desc: 'The True Sentinel who guards Jinzhou from the shadows. Blazing-fast Fusion combo chains with Fusion DMG Amplify.',
  ...
  'Zhezhi': { rarity: 5, element: 'Glacio', weapon: 'Rectifier', role: 'Sub DPS',
    desc: 'Shy painter whose ink creations spring to life. Provides off-field Glacio Coordinated Attacks from her living canvases.',
  ...
  'Xiangli Yao': { rarity: 5, element: 'Electro', weapon: 'Gauntlets', role: 'Main DPS',
    desc: 'Brilliant Huaxu Academy researcher who built his own combat mech. Transforms into Law of Reigns mode for Electro burst damage.',
  ...
  'Shorekeeper': { rarity: 5, element: 'Spectro', weapon: 'Rectifier', role: 'Healer',
    desc: 'Eternal guardian of the Tethys, keeper of the Black Shores. Premium healer who opens Stellarealm for team-wide Crit buffs.',
  ...
  'Camellya': { rarity: 5, element: 'Havoc', weapon: 'Sword', role: 'Main DPS',
    desc: 'Enigmatic assassin who blooms like a camellia flower. Stance-dancer shifting between Budding and Blossom modes for relentless Havoc pressure.',
  ...
  'Carlotta': { rarity: 5, element: 'Glacio', weapon: 'Pistols', role: 'Main DPS',
    desc: 'Refined heiress of Rinascita\'s Montelli family. Stylish Glacio gunslinger who shatters frozen crystals in devastating burst windows.',
  ...
  'Roccia': { rarity: 5, element: 'Havoc', weapon: 'Gauntlets', role: 'Sub DPS',
    desc: 'Warm-hearted clown performer from Rinascita with her companion Pero. Havoc support who amplifies Basic ATK DMG for the team.',
  ...
  'Phoebe': { rarity: 5, element: 'Spectro', weapon: 'Rectifier', role: 'Sub DPS',
    desc: 'Devoted acolyte of the Order of the Deep, guided by divine light. Premier Spectro Frazzle applicator through her sacred cards.',
  ...
  'Brant': { rarity: 5, element: 'Fusion', weapon: 'Sword', role: 'Main DPS',
    desc: 'Blazing knight from Rinascita whose soul burns with unflickering valor. Aggressive Fusion swordsman with dual DPS modes and self-heal.',
  ...
  'Cantarella': { rarity: 5, element: 'Havoc', weapon: 'Rectifier', role: 'Sub DPS',
    desc: 'Enigmatic head of Rinascita\'s Fisalia family, veiled in twilight. Havoc sub-DPS who weaves Coordinated Attacks with subtle healing.',
  ...
  'Zani': { rarity: 5, element: 'Spectro', weapon: 'Gauntlets', role: 'Main DPS',
    desc: 'Steadfast security officer of the Averardo Vault, devoted to justice. Spectro Frazzle DPS who counter-punches into powerful burst windows.',
  ...
  'Ciaccona': { rarity: 5, element: 'Aero', weapon: 'Pistols', role: 'Sub DPS',
    desc: 'Free-spirited wandering bard whose melodies command the wind. Aero Erosion applicator with off-field Aero buffs for the team.',
  ...
  'Cartethyia': { rarity: 5, element: 'Aero', weapon: 'Sword', role: 'Main DPS',
    desc: 'The Blessed Maiden of Rinascita, beloved by wind and sea. HP-scaling Aero Erosion hypercarry who shifts between sword and Fleurdelys forms.',
  ...
  'Lupa': { rarity: 5, element: 'Fusion', weapon: 'Broadblade', role: 'Sub DPS',
    desc: 'Lone wolf Star Gladiator of the arena who fights for herself alone. Mono-Fusion enabler with Fusion RES shred and team DMG buffs.',
  ...
  'Phrolova': { rarity: 5, element: 'Havoc', weapon: 'Rectifier', role: 'Main DPS',
    desc: 'Former violinist turned Fractsidus Overseer, death\'s euphoric companion. Havoc DPS who summons the three-headed Hecate for off-field devastation.',
  ...
  'Augusta': { rarity: 5, element: 'Electro', weapon: 'Broadblade', role: 'Main DPS',
    desc: 'Ephor of Septimont, a sun rising ablaze from the crucible of blood and sand. Electro DPS with time-stop and innate shielding.',
  ...
  'Iuno': { rarity: 5, element: 'Aero', weapon: 'Gauntlets', role: 'Sub DPS',
    desc: 'Priestess of Septimont\'s Tetragon Temple who grasps meaning in time\'s rhythm. Heavy ATK buffer with healing and shielding.',
  ...
  'Galbrena': { rarity: 5, element: 'Fusion', weapon: 'Pistols', role: 'Main DPS',
    desc: 'Black Shores Consultant known as the Discord Slayer, seizing power from darkness. Fusion hypercarry built around Echo Skill and Heavy ATK.',
  ...
  'Qiuyuan': { rarity: 5, element: 'Aero', weapon: 'Sword', role: 'Sub DPS',
    desc: 'Former Mingting intelligence agent, upright as bamboo seeking no vanity. Buffs Echo Skill DMG with Crit DMG Amplify for the team.',
  ...
  'Chisa': { rarity: 5, element: 'Havoc', weapon: 'Broadblade', role: 'Sub DPS',
    desc: 'Startorch Academy student who binds fate upon a crimson thread. Havoc support with DEF shred and Negative Status stacking.',
  ...
  'Lynae': { rarity: 5, element: 'Spectro', weapon: 'Pistols', role: 'Sub DPS',
    desc: 'Startorch Academy student and ex-mercenary with prismatic light at her fingertips. Tune Break DMG buffer for Off-Tune teams.',
  ...
  'Mornye': { rarity: 5, element: 'Fusion', weapon: 'Broadblade', role: 'Healer',
    desc: 'Startorch Academy professor who understands every phenomenon. DEF-scaling Fusion healer with Off-Tune Buildup support.',
  ...
  'Luuk Herssen': { rarity: 5, element: 'Spectro', weapon: 'Gauntlets', role: 'Main DPS',
    desc: 'Startorch Academy doctor who sees the mountains as the spine of the earth. Aerial Spectro DPS with relentless Basic ATK pressure.',
  ...
  'Aemeath': { rarity: 5, element: 'Fusion', weapon: 'Sword', role: 'Main DPS',
    desc: 'Digital ghost of Startorch Academy, stardust and loneliness remade into wings. Dual-system Fusion DPS with Tune Rupture and Fusion Burst modes.',
  ...
  'Baizhi': { rarity: 4, element: 'Glacio', weapon: 'Rectifier', role: 'Healer',
    desc: "Devoted Huaxu Academy researcher accompanied by her companion You'an. Accessible healer who keeps the team alive through gentle Glacio restoration.",
  ...
  'Chixia': { rarity: 4, element: 'Fusion', weapon: 'Pistols', role: 'Main DPS',
    desc: 'Energetic patroller who blazes through Jinzhou with dual pistols. Straightforward Fusion DPS with rapid-fire burst.',
  ...
  'Danjin': { rarity: 4, element: 'Havoc', weapon: 'Sword', role: 'Sub DPS',
    desc: 'Midnight Ranger who trades her own blood for power. Havoc sub-DPS whose HP consumption fuels DMG Bonus buffs.',
  ...
  'Yangyang': { rarity: 4, element: 'Aero', weapon: 'Sword', role: 'Sub DPS',
    desc: 'Cheerful Midnight Rangers outrider who rides the wind. Free starter Aero support and Energy battery for the team.',
  ...
  'Sanhua': { rarity: 4, element: 'Glacio', weapon: 'Sword', role: 'Sub DPS',
    desc: 'Jinhsi\'s stoic personal guard, cold as the frost she commands. Quick-swap Glacio sub-DPS who amplifies Basic ATK DMG.',
  ...
  'Taoqi': { rarity: 4, element: 'Havoc', weapon: 'Broadblade', role: 'Support',
    desc: 'Steadfast border defense director with an iron will. Shielder who deepens Resonance Skill DMG for the team.',
  ...
  'Yuanwu': { rarity: 4, element: 'Electro', weapon: 'Gauntlets', role: 'Support',
    desc: 'Veteran boxing gym owner who fights with thunderous fists. Electro support providing Coordinated Attacks and protective shields.',
  ...
  'Mortefi': { rarity: 4, element: 'Fusion', weapon: 'Pistols', role: 'Sub DPS',
    desc: 'Hot-tempered researcher whose music erupts in violent crescendos. Buffs Heavy ATK DMG through off-field Fusion Coordinated Attacks.',
  ...
  'Youhu': { rarity: 4, element: 'Glacio', weapon: 'Gauntlets', role: 'Support',
    desc: 'Whimsical antique appraiser who trusts her luck in all things. Glacio healer who amplifies Coordinated ATK DMG.',
  ...
  'Lumi': { rarity: 4, element: 'Electro', weapon: 'Broadblade', role: 'Sub DPS',
    desc: 'Lollo Logistics navigator who charts paths through thundering skies. Electro sub-DPS whose Outro amplifies Resonance Skill DMG.',
  ...
  'Buling': { rarity: 4, element: 'Electro', weapon: 'Rectifier', role: 'Healer',
    desc: 'Taoist feng shui master from Mengzhou and Black Shores Consultant. Universal support who deploys Electro Flare and buffs Resonance Skill DMG.',
...
const ECHO_DATA = {
  ...
  'Lorelei':                         { sets: ['Midnight Veil'], buff: 'Havoc DMG', desc: 'A siren-like Overlord that lures with haunting melodies. Skill summons Lorelei to attack enemies dealing Havoc DMG.' },
  'Nightmare: Kelpie':               { sets: ['Gusts of Welkin', 'Windward Pilgrimage'], buff: 'Glacio DMG', desc: 'A nightmare variant of a water-horse Overlord. Skill summons Nightmare: Kelpie to attack enemies dealing Glacio DMG.' },
  'Hecate':                          { sets: ['Empyrean Anthem'], buff: 'Havoc DMG', desc: 'The three-headed witch Calamity of the deep. Skill summons Hecate to attack enemies dealing Havoc DMG.' },
  'Reminiscence: Fenrico':           { sets: ['Dream of the Lost', 'Law of Harmony'], buff: 'Aero DMG', desc: 'A reminiscence of the wolf guardian Fenrico. Skill summons Reminiscence: Fenrico to attack enemies dealing Aero DMG.' },
  // ── 3-Cost Echoes ──
  ...
  'Flora Reindeer':                  { sets: ['Rite of Gilded Revelation'], buff: 'Aero DMG', desc: 'A gentle reindeer-like creature from Lahai-Roi. Skill summons Flora Reindeer to attack enemies dealing Aero DMG.' },
  'Windlash Coleoid':                { sets: ['Rite of Gilded Revelation'], buff: 'Aero DMG', desc: 'A wind-infused cephalopod creature. Skill summons Windlash Coleoid to attack enemies dealing Aero DMG.' },
  'Frostbite Coleoid':               { sets: ['Halo of Starry Radiance'], buff: 'Glacio DMG', desc: 'A frost-infused cephalopod creature. Skill summons Frostbite Coleoid to attack enemies dealing Glacio DMG.' },
  ...
  'Hurriclaw':                       { sets: ['Tidebreaking Courage', 'Gusts of Welkin', 'Crown of Valor'], buff: 'Aero DMG', desc: 'A wind-wielding claw beast. Skill summons Hurriclaw to attack enemies dealing Aero DMG.' },
  'Nightmare: Viridblaze Saurian':   { sets: ["Flamewing's Shadow"], buff: 'Fusion DMG', desc: 'A nightmare variant of the fire-breathing saurian. Skill summons Nightmare: Viridblaze Saurian to attack enemies dealing Fusion DMG.' },
  'Nightmare: Violet-Feathered Heron': { sets: ['Crown of Valor'], buff: 'Electro DMG', desc: 'A nightmare variant of the purple-winged heron. Skill summons Nightmare: Violet-Feathered Heron to attack enemies dealing Electro DMG.' },
  'Nightmare: Cyan-Feathered Heron': { sets: ['Law of Harmony'], buff: 'Aero DMG', desc: 'A nightmare variant of the cyan-winged heron. Skill summons Nightmare: Cyan-Feathered Heron to attack enemies dealing Aero DMG.' },
  'Nightmare: Roseshroom':           { sets: ['Thread of Severed Fate'], buff: 'Havoc DMG', desc: 'A nightmare variant of the dark fungal creature. Skill summons Nightmare: Roseshroom to attack enemies dealing Havoc DMG.' },
  'Nightmare: Tambourinist':         { sets: ['Dream of the Lost'], buff: 'Havoc DMG', desc: 'A nightmare variant of the rhythmic sound-weaponizer. Skill summons Nightmare: Tambourinist to attack enemies dealing Havoc DMG.' },
  'Diurnus Knight':                  { sets: ['Eternal Radiance', 'Tidebreaking Courage'], buff: 'Spectro DMG', desc: 'A daytime knight of the Order. Skill summons Diurnus Knight to attack enemies dealing Spectro DMG.' },
  'Nocturnus Knight':                { sets: ['Midnight Veil', 'Empyrean Anthem'], buff: 'Havoc DMG', desc: 'A nighttime knight of the Order. Skill summons Nocturnus Knight to attack enemies dealing Havoc DMG.' },
  'Questless Knight':                { sets: ['Frosty Resolve', 'Midnight Veil'], buff: 'Electro DMG', desc: 'A wandering knight without a quest. Skill summons Questless Knight to attack enemies dealing Electro DMG.' },
  'Abyssal Gladius':                 { sets: ['Midnight Veil', 'Tidebreaking Courage', 'Thread of Severed Fate'], buff: 'Glacio DMG', desc: 'A blade-wielding warrior from the abyss. Skill summons Abyssal Gladius to attack enemies dealing Glacio DMG.' },
  'Abyssal Patricius':               { sets: ['Frosty Resolve', 'Empyrean Anthem'], buff: 'Glacio DMG', desc: 'A noble warrior from the abyss. Skill summons Abyssal Patricius to attack enemies dealing Glacio DMG.' },
  'Rage Against the Statue':         { sets: ['Eternal Radiance', 'Gusts of Welkin', 'Law of Harmony'], buff: 'Spectro DMG', desc: 'An animated statue filled with rage. Skill summons Rage Against the Statue to attack enemies dealing Spectro DMG.' },
  'Vitreum Dancer':                  { sets: ['Eternal Radiance', 'Empyrean Anthem'], buff: 'Electro DMG', desc: 'A glass-like dancer that channels electricity. Skill summons Vitreum Dancer to attack enemies dealing Electro DMG.' },
  'Cuddle Wuddle':                   { sets: ['Frosty Resolve', 'Midnight Veil'], buff: 'Physical DMG', desc: 'A deceptively cuddly creature. Skill summons Cuddle Wuddle to attack enemies dealing Physical DMG.' },
  'Chop Chop':                       { sets: ['Empyrean Anthem', 'Tidebreaking Courage', 'Dream of the Lost'], buff: 'Fusion DMG', desc: 'A multi-armed chopping construct. Skill summons Chop Chop to attack enemies dealing Fusion DMG.' },
  'Lightcrusher':                    { sets: ['Celestial Light'], buff: 'Spectro DMG', desc: 'A light-infused crushing construct. Skill summons Lightcrusher to attack enemies dealing Spectro DMG.' },
  'Rocksteady Guardian':             { sets: ['Celestial Light', 'Rejuvenating Glow'], buff: 'Spectro DMG', desc: 'A steadfast rock guardian. Skill summons Rocksteady Guardian to support allies.' },
  // ── 1-Cost Echoes ──
  ...
  'Aero Predator':                   { sets: ['Void Thunder', 'Sierra Gale'], buff: 'Aero DMG', desc: 'A nimble humanoid Tacet Discord that fires air projectiles. Skill summons Aero Predator to attack enemies dealing Aero DMG.' },
  'Glacio Predator':                 { sets: ['Freezing Frost', 'Celestial Light'], buff: 'Glacio DMG', desc: 'A nimble humanoid Tacet Discord that fires ice projectiles. Skill summons Glacio Predator to attack enemies dealing Glacio DMG.' },
  'Gulpuff':                         { sets: ['Freezing Frost', 'Celestial Light'], buff: 'Glacio DMG', desc: 'A bubble-blowing Tacet Discord. Skill summons Gulpuff to attack enemies dealing Glacio DMG.' },
  'Aero Drake':                      { sets: ['Tidebreaking Courage', 'Gusts of Welkin', 'Flaming Clawprint'], buff: 'Aero DMG', desc: 'A wind-elemental drake. Skill summons Aero Drake to attack enemies dealing Aero DMG.' },
  'Electro Drake':                   { sets: ['Midnight Veil', 'Gusts of Welkin', 'Flaming Clawprint'], buff: 'Electro DMG', desc: 'A lightning-elemental drake. Skill summons Electro Drake to attack enemies dealing Electro DMG.' },
  'Fusion Drake':                    { sets: ['Windward Pilgrimage', 'Flaming Clawprint'], buff: 'Fusion DMG', desc: 'A fire-elemental drake. Skill summons Fusion Drake to attack enemies dealing Fusion DMG.' },
  'Glacio Drake':                    { sets: ['Gusts of Welkin', 'Windward Pilgrimage'], buff: 'Glacio DMG', desc: 'An ice-elemental drake. Skill summons Glacio Drake to attack enemies dealing Glacio DMG.' },
  'Havoc Drake':                     { sets: ['Windward Pilgrimage', 'Flaming Clawprint', 'Thread of Severed Fate'], buff: 'Havoc DMG', desc: 'A havoc-elemental drake. Skill summons Havoc Drake to attack enemies dealing Havoc DMG.' },
  'Spectro Drake':                   { sets: ['Windward Pilgrimage', 'Flaming Clawprint'], buff: 'Spectro DMG', desc: 'A spectro-elemental drake. Skill summons Spectro Drake to attack enemies dealing Spectro DMG.' },
  'Devotee\'s Flesh':                { sets: ['Gusts of Welkin', 'Windward Pilgrimage', 'Flaming Clawprint'], buff: 'Aero DMG', desc: 'A devout creature. Skill summons Devotee\'s Flesh to attack enemies dealing Aero DMG.' },
  'Sacerdos':                        { sets: ['Gusts of Welkin', 'Windward Pilgrimage'], buff: 'Aero DMG', desc: 'A priestly creature. Skill summons Sacerdos to attack enemies dealing Aero DMG.' },
  'Sagittario':                      { sets: ['Eternal Radiance', 'Gusts of Welkin', 'Flaming Clawprint'], buff: 'Spectro DMG', desc: 'An archer-like creature. Skill summons Sagittario to attack enemies dealing Spectro DMG.' },
  'La Guardia':                      { sets: ['Midnight Veil', 'Gusts of Welkin', 'Flaming Clawprint'], buff: 'Physical DMG', desc: 'A guard-like creature. Skill summons La Guardia to attack enemies dealing Physical DMG.' },
  'Calcified Junrock':               { sets: ['Empyrean Anthem', 'Tidebreaking Courage', 'Crown of Valor'], buff: 'Healing', desc: 'A calcified junrock variant. Skill summons Calcified Junrock to heal allies.' },
  'Fission Junrock':                 { sets: ['Void Thunder', 'Rejuvenating Glow', 'Moonlit Clouds'], buff: 'Healing', desc: 'A fission-powered junrock. Skill summons Fission Junrock to heal allies.' },
  'Golden Junrock':                  { sets: ['Frosty Resolve', 'Eternal Radiance', 'Law of Harmony'], buff: 'Spectro DMG', desc: 'A golden junrock variant. Skill summons Golden Junrock to attack enemies dealing Spectro DMG.' },
  'Vanguard Junrock':                { sets: ['Void Thunder', 'Rejuvenating Glow', 'Lingering Tunes'], buff: 'Physical DMG', desc: 'A vanguard junrock variant. Skill summons Vanguard Junrock to attack enemies dealing Physical DMG.' },
  'Diamondclaw':                     { sets: ['Moonlit Clouds', 'Lingering Tunes'], buff: 'Physical DMG', desc: 'A diamond-clawed creature. Skill summons Diamondclaw to attack enemies dealing Physical DMG.' },
  'Diggy Duggy':                     { sets: ['Eternal Radiance', 'Tidebreaking Courage'], buff: 'Physical DMG', desc: 'A digging creature. Skill summons Diggy Duggy to attack enemies dealing Physical DMG.' },
  'Fae Ignis':                       { sets: ['Eternal Radiance', 'Midnight Veil', 'Dream of the Lost'], buff: 'Havoc DMG', desc: 'A fairy flame creature. Skill summons Fae Ignis to attack enemies dealing Havoc DMG.' },
  'Frostscourge Stalker':            { sets: ['Eternal Radiance', 'Midnight Veil'], buff: 'Glacio DMG', desc: 'A frost-infused stalker. Skill summons Frostscourge Stalker to attack enemies dealing Glacio DMG.' },
  'Voltscourge Stalker':             { sets: ['Midnight Veil', 'Empyrean Anthem'], buff: 'Electro DMG', desc: 'A voltage-infused stalker. Skill summons Voltscourge Stalker to attack enemies dealing Electro DMG.' },
  'Galescourge Stalker':             { sets: ['Frosty Resolve', 'Empyrean Anthem'], buff: 'Aero DMG', desc: 'A gale-infused stalker. Skill summons Galescourge Stalker to attack enemies dealing Aero DMG.' },
  'Hocus Pocus':                     { sets: ['Frosty Resolve', 'Empyrean Anthem'], buff: 'Havoc DMG', desc: 'A magical trickster creature. Skill summons Hocus Pocus to attack enemies dealing Havoc DMG.' },
  'Nimbus Wraith':                   { sets: ['Midnight Veil', 'Empyrean Anthem', "Flamewing's Shadow"], buff: 'Healing', desc: 'A cloud-like wraith. Skill summons Nimbus Wraith to heal allies.' },
  'Hoartoise':                       { sets: ['Freezing Frost', 'Celestial Light'], buff: 'Healing', desc: 'A hoary tortoise creature. Skill summons Hoartoise to heal allies.' },
  'Sabyr Boar':                      { sets: ['Freezing Frost', 'Sierra Gale', 'Moonlit Clouds'], buff: 'Physical DMG', desc: 'A tusked boar creature. Skill summons Sabyr Boar to attack enemies dealing Physical DMG.' },
  'Traffic Illuminator':             { sets: ['Molten Rift', 'Void Thunder', 'Sierra Gale'], buff: 'Electro DMG', desc: 'A traffic-light-like construct. Skill summons Traffic Illuminator to attack enemies dealing Electro DMG.' },
  'Tick Tack':                       { sets: ['Havoc Eclipse', 'Rejuvenating Glow', 'Lingering Tunes'], buff: 'Havoc DMG', desc: 'A clock-like creature. Skill summons Tick Tack to attack enemies dealing Havoc DMG.' },
  'Chop Chop: Headless':             { sets: ['Eternal Radiance', 'Tidebreaking Courage'], buff: 'Fusion DMG', desc: 'The headless part of Chop Chop. Skill summons Chop Chop: Headless to attack enemies dealing Fusion DMG.' },
  'Chop Chop: Leftless':             { sets: ['Frosty Resolve', 'Tidebreaking Courage'], buff: 'Spectro DMG', desc: 'The leftless part of Chop Chop. Skill summons Chop Chop: Leftless to attack enemies dealing Spectro DMG.' },
  'Chop Chop: Rightless':            { sets: ['Frosty Resolve', 'Tidebreaking Courage'], buff: 'Havoc DMG', desc: 'The rightless part of Chop Chop. Skill summons Chop Chop: Rightless to attack enemies dealing Havoc DMG.' },
  'Geospider S4':                    { sets: ['Pact of Neonlight Leap', 'Halo of Starry Radiance', 'Trailblazing Star'], buff: 'Spectro DMG', desc: 'A mechanical spider from Lahai-Roi. Skill summons Geospider S4 to attack enemies dealing Spectro DMG.' },
  'Flora Drone':                     { sets: ['Pact of Neonlight Leap', 'Rite of Gilded Revelation', 'Sound of True Name'], buff: 'Aero DMG', desc: 'A botanical drone from Lahai-Roi. Skill summons Flora Drone to support allies.' },
  'Mining Drone':                    { sets: ['Halo of Starry Radiance', 'Rite of Gilded Revelation', 'Sound of True Name'], buff: 'Havoc DMG', desc: 'A mining drone from Lahai-Roi. Skill summons Mining Drone to attack enemies dealing Havoc DMG.' },
  'Zip Zap':                         { sets: ['Pact of Neonlight Leap', 'Rite of Gilded Revelation', 'Chromatic Foam'], buff: 'Electro DMG', desc: 'An electrical creature from Lahai-Roi. Skill summons Zip Zap to attack enemies dealing Electro DMG.' },
  'Iceglint Dancer':                 { sets: ['Trailblazing Star'], buff: 'Glacio DMG', desc: 'A crystalline dancer. Skill summons Iceglint Dancer to attack enemies dealing Glacio DMG.' },
  'Shadow Stepper':                  { sets: ['Trailblazing Star', 'Chromatic Foam'], buff: 'Havoc DMG', desc: 'A shadow-walking creature. Skill summons Shadow Stepper to attack enemies dealing Havoc DMG.' },
  'Tremor Warrior':                  { sets: ['Halo of Starry Radiance', 'Chromatic Foam', 'Sound of True Name'], buff: 'Electro DMG', desc: 'A tremor-inducing warrior. Skill summons Tremor Warrior to attack enemies dealing Electro DMG.' },
  'Nightmare: Aero Predator':        { sets: ['Crown of Valor'], buff: 'Aero DMG', desc: 'A nightmare variant of the Aero Predator. Skill summons Nightmare: Aero Predator to attack enemies dealing Aero DMG.' },
  'Nightmare: Electro Predator':     { sets: ['Crown of Valor'], buff: 'Electro DMG', desc: 'A nightmare variant of the Electro Predator. Skill summons Nightmare: Electro Predator to attack enemies dealing Electro DMG.' },
  'Nightmare: Glacio Predator':      { sets: ['Dream of the Lost'], buff: 'Glacio DMG', desc: 'A nightmare variant of the Glacio Predator. Skill summons Nightmare: Glacio Predator to attack enemies dealing Glacio DMG.' },
  'Nightmare: Baby Roseshroom':      { sets: ["Flamewing's Shadow"], buff: 'Havoc DMG', desc: 'A nightmare variant of the Baby Roseshroom. Skill summons Nightmare: Baby Roseshroom to attack enemies dealing Havoc DMG.' },
  'Nightmare: Baby Viridblaze Saurian': { sets: ["Flamewing's Shadow"], buff: 'Fusion DMG', desc: 'A nightmare variant of the Baby Viridblaze Saurian. Skill summons Nightmare: Baby Viridblaze Saurian to attack enemies dealing Fusion DMG.' },
  'Nightmare: Chirpuff':             { sets: ['Law of Harmony'], buff: 'Aero DMG', desc: 'A nightmare variant of Chirpuff. Skill summons Nightmare: Chirpuff to attack enemies dealing Aero DMG.' },
  'Nightmare: Dwarf Cassowary':      { sets: ['Thread of Severed Fate'], buff: 'Physical DMG', desc: 'A nightmare variant of the Dwarf Cassowary. Skill summons Nightmare: Dwarf Cassowary to attack enemies dealing Physical DMG.' },
  'Nightmare: Gulpuff':              { sets: ['Law of Harmony'], buff: 'Glacio DMG', desc: 'A nightmare variant of Gulpuff. Skill summons Nightmare: Gulpuff to attack enemies dealing Glacio DMG.' },
  'Nightmare: Havoc Warrior':        { sets: ['Dream of the Lost'], buff: 'Havoc DMG', desc: 'A nightmare variant of the Havoc Warrior. Skill summons Nightmare: Havoc Warrior to attack enemies dealing Havoc DMG.' },
  'Nightmare: Tick Tack':            { sets: ['Thread of Severed Fate'], buff: 'Havoc DMG', desc: 'A nightmare variant of Tick Tack. Skill summons Nightmare: Tick Tack to attack enemies dealing Havoc DMG.' },
};
...
const WEAPON_DATA = {
  ...
  "Bloodpact's Pledge": { rarity: 5, type: 'Sword', stat: 'Energy Regen', baseAtk: 587, subStatValue: '+38.8%',
    ...
    passive: 'Healing → Res. Skill DMG +10% for 6s. Aero DMG +10% for 30s', bestFor: ['Sword healers'],
    ascensionMaterials: { forgery: 'Metallic Drip', common: 'Howler Core' } },
  'Solsworn Ciphers': { rarity: 5, type: 'Gauntlets', stat: 'Crit DMG', baseAtk: 587, subStatValue: '+48.6%',
    ...
    passive: 'ATK +12%. Intro/Echo Skill → Echo Skill DMG Amp +32% for 15s', bestFor: ['Gauntlet DPS'],
    ascensionMaterials: { forgery: 'Cadence', common: 'Howler Core' } },
  // 4★ Weapons
  ...
  'Lunar Cutter': { rarity: 4, type: 'Sword', stat: 'ATK%', baseAtk: 412, subStatValue: '+30.4%',
    ...
    passive: 'Swap-in → 6 Oath stacks, each +2% ATK (max +12%, 12s CD)', bestFor: ['Sword users'],
    ascensionMaterials: { forgery: 'Metallic Drip', common: 'Howler Core' } },
  'Thunderbolt': { rarity: 4, type: 'Pistols', stat: 'ATK%', baseAtk: 387, subStatValue: '+36.4%',
    ...
    passive: 'Basic/Heavy ATK hit → Res. Skill DMG +7% (max x3, 7s)', bestFor: ['Chixia', 'Pistol users'],
    ascensionMaterials: { forgery: 'Phlogiston', common: 'Ring' } },
  ...
  'Waltz in Masquerade': { rarity: 4, type: 'Rectifier', stat: 'ATK%', baseAtk: 462, subStatValue: '+18.2%',
    ...
    passive: 'DMG to Negative Status enemies → ATK +4% (max x4, 10s)', bestFor: ['Rectifier DPS'] },
  'Legend of Drunken Hero': { rarity: 4, type: 'Gauntlets', stat: 'ATK%', baseAtk: 462, subStatValue: '+18.2%',
    ...
    passive: 'DMG to Negative Status enemies → ATK +4% (max x4, 10s)', bestFor: ['Gauntlet DPS'] },
  'Romance in Farewell': { rarity: 4, type: 'Pistols', stat: 'ATK%', baseAtk: 462, subStatValue: '+18.2%',
    ...
    passive: 'DMG to Negative Status enemies → ATK +4% (max x4, 10s)', bestFor: ['Pistol DPS'] },
  'Fables of Wisdom': { rarity: 4, type: 'Sword', stat: 'ATK%', baseAtk: 462, subStatValue: '+18.2%',
    ...
    passive: 'DMG to Negative Status enemies → ATK +4% (max x4, 10s)', bestFor: ['Sword DPS'] },
  'Meditations on Mercy': { rarity: 4, type: 'Broadblade', stat: 'ATK%', baseAtk: 462, subStatValue: '+18.2%',
    ...
    passive: 'DMG to Negative Status enemies → ATK +4% (max x4, 10s)', bestFor: ['Broadblade DPS'] },
  ...
  'Somnoire Anchor': { rarity: 4, type: 'Sword', stat: 'ATK%', baseAtk: 462, subStatValue: '+18.2%',
    ...
    passive: 'Dealing DMG → +2% ATK per 1s (max x10, 3s per stack)', bestFor: ['Sword DPS'] },
  'Fusion Accretion': { rarity: 4, type: 'Rectifier', stat: 'ATK%', baseAtk: 462, subStatValue: '+18.2%',
    ...
    passive: 'Resonance Skill → +6 Resonance Energy, ATK +10% for 16s', bestFor: ['Rectifier DPS'] },
  'Celestial Spiral': { rarity: 4, type: 'Gauntlets', stat: 'ATK%', baseAtk: 462, subStatValue: '+18.2%',
    ...
    passive: 'Resonance Skill → +6 Resonance Energy, ATK +10% for 16s', bestFor: ['Gauntlet DPS'] },
  'Relativistic Jet': { rarity: 4, type: 'Pistols', stat: 'ATK%', baseAtk: 462, subStatValue: '+18.2%',
    ...
    passive: 'Resonance Skill → +6 Resonance Energy, ATK +10% for 16s', bestFor: ['Pistol DPS'] },
  'Endless Collapse': { rarity: 4, type: 'Sword', stat: 'ATK%', baseAtk: 462, subStatValue: '+18.2%',
    ...
    passive: 'Resonance Skill → +6 Resonance Energy, ATK +10% for 16s', bestFor: ['Sword DPS'] },
  'Waning Redshift': { rarity: 4, type: 'Broadblade', stat: 'ATK%', baseAtk: 462, subStatValue: '+18.2%',
    ...
    passive: 'Resonance Skill → +6 Resonance Energy, ATK +10% for 16s', bestFor: ['Broadblade DPS'] },
  'Lumingloss': { rarity: 4, type: 'Sword', stat: 'ATK%', baseAtk: 387, subStatValue: '+36.4%',
    ...
    passive: 'Resonance Skill → Basic & Heavy ATK DMG +20% for 10s', bestFor: ['Sword DPS'] },
  'Commando of Conviction': { rarity: 4, type: 'Sword', stat: 'ATK%', baseAtk: 412, subStatValue: '+30.4%',
    ...
    passive: 'Intro Skill → ATK +15% for 15s', bestFor: ['Sword users'] },
  'Jinzhou Keeper': { rarity: 4, type: 'Rectifier', stat: 'ATK%', baseAtk: 387, subStatValue: '+36.4%',
    ...
    passive: 'Intro Skill → ATK +8%, HP +10% for 15s', bestFor: ['Rectifier supports'] },
  ...
  'Augment': { rarity: 4, type: 'Rectifier', stat: 'Crit Rate', baseAtk: 412, subStatValue: '+20.3%',
    ...
    passive: 'Liberation → ATK +15% for 15s', bestFor: ['Rectifier DPS'] },
  'Hollow Mirage': { rarity: 4, type: 'Gauntlets', stat: 'ATK%', baseAtk: 412, subStatValue: '+30.4%',
    ...
    passive: 'Liberation → 3 Iron Armor stacks, each +3% ATK and +3% DEF', bestFor: ['Gauntlet users'] },
  'Stonard': { rarity: 4, type: 'Gauntlets', stat: 'Crit Rate', baseAtk: 412, subStatValue: '+20.3%',
    ...
    passive: 'Resonance Skill → Liberation DMG +18% for 15s', bestFor: ['Gauntlet DPS'] },
  'Amity Accord': { rarity: 4, type: 'Gauntlets', stat: 'DEF%', baseAtk: 337, subStatValue: '+61.6%',
    ...
    passive: 'Intro Skill → Liberation DMG +20% for 15s', bestFor: ['Gauntlet supports'] },
  'Novaburst': { rarity: 4, type: 'Pistols', stat: 'ATK%', baseAtk: 412, subStatValue: '+30.4%',
    ...
    passive: 'Dash/dodge → ATK +4% (max x3, 8s)', bestFor: ['Pistol DPS'] },
  'Undying Flame': { rarity: 4, type: 'Pistols', stat: 'ATK%', baseAtk: 412, subStatValue: '+30.4%',
    ...
    passive: 'Intro Skill → Res. Skill DMG +20% for 15s', bestFor: ['Pistol DPS'] },
  'Helios Cleaver': { rarity: 4, type: 'Broadblade', stat: 'ATK%', baseAtk: 412, subStatValue: '+30.4%',
    ...
    passive: 'After Res. Skill → ATK +3% every 2s (max x4, 12s)', bestFor: ['Broadblade DPS'] },
  'Dauntless Evernight': { rarity: 4, type: 'Broadblade', stat: 'DEF%', baseAtk: 337, subStatValue: '+61.6%',
    ...
    passive: 'Intro Skill → ATK +8%, DEF +15% for 15s', bestFor: ['Broadblade supports'] },
  'Autumntrace': { rarity: 4, type: 'Broadblade', stat: 'Crit Rate', baseAtk: 412, subStatValue: '+20.3%',
    ...
    passive: 'Basic/Heavy ATK DMG → ATK +4% (max x5, 7s)', bestFor: ['Broadblade DPS'] },
  'Solar Flame': { rarity: 4, type: 'Pistols', stat: 'Crit Rate', baseAtk: 412, subStatValue: '+20.2%',
    ...
    passive: 'Basic/Heavy ATK → ATK +2.2%, Heavy ATK DMG +2.2% (max x4, 7s)', bestFor: ['Pistol DPS'] },
  'Feather Edge': { rarity: 4, type: 'Sword', stat: 'Crit Rate', baseAtk: 412, subStatValue: '+20.2%',
    ...
    passive: 'Liberation → ATK +7.2%, Liberation DMG +10.8% for 15s', bestFor: ['Sword DPS'] },
  // ── 4★ Craftable ──
  'Broadblade#41': { rarity: 4, type: 'Broadblade', stat: 'Energy Regen', baseAtk: 412, subStatValue: '+32.3%',
    ...
    passive: 'HP >80% → ATK +12%. HP <40% → heal 5% on ATK', bestFor: ['Broadblade users'],
    ascensionMaterials: { forgery: 'Waveworn Residue', common: 'Ring' } },
  ...
  'Aureate Zenith': { rarity: 4, type: 'Broadblade', stat: 'Crit DMG', baseAtk: 412, subStatValue: '+40.5%',
    ...
    passive: 'Oath of Tide Hunters: After Liberation → ATK +7.2%, Heavy ATK DMG +10.8% for 15s', bestFor: ['Augusta', 'Broadblade DPS'],
  ...
  'Aether Strike': { rarity: 4, type: 'Gauntlets', stat: 'Crit DMG', baseAtk: 412, subStatValue: '+40.5%',
    ...
    passive: 'Oath of Tide Hunters: After Liberation → ATK +7.2%, Liberation DMG +10.8% for 15s', bestFor: ['Iuno', 'Gauntlet DPS'],
    ascensionMaterials: { forgery: 'Cadence', common: 'Howler Core' } },
  'Radiant Dawn': { rarity: 4, type: 'Rectifier', stat: 'Crit DMG', baseAtk: 412, subStatValue: '+40.5%',
    ...
    passive: 'Oath of Tide Hunters: After Skill → ATK +9%, Basic ATK DMG +9% for 10s', bestFor: ['Rectifier DPS'],
    ascensionMaterials: { forgery: 'Helix', common: 'Ring' } },
  ...
  'Guardian Sword': { rarity: 3, type: 'Sword', stat: 'HP%', baseAtk: 300, subStatValue: '+30.4%',
    ...
    passive: 'Unified: Resonance Skill DMG +12%', bestFor: ['Cartethyia', 'Changli', 'Yangyang'],
    ascensionMaterials: { forgery: 'Metallic Drip', common: 'Howler Core' } },
  'Guardian Pistols': { rarity: 3, type: 'Pistols', stat: 'ATK%', baseAtk: 300, subStatValue: '+30.4%',
    ...
    passive: 'Unity: Resonance Skill DMG +12%', bestFor: ['Carlotta', 'Chixia'],
    ascensionMaterials: { forgery: 'Phlogiston', common: 'Ring' } },
  'Guardian Gauntlets': { rarity: 3, type: 'Gauntlets', stat: 'DEF%', baseAtk: 300, subStatValue: '+38.5%',
    ...
    passive: 'Collective Strength: Resonance Liberation DMG +12%', bestFor: ['Jianxin', 'Yuanwu'],
    ascensionMaterials: { forgery: 'Cadence', common: 'Howler Core' } },
