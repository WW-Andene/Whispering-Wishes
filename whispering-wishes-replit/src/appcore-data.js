...
const ECHO_DATA = {
  ...
  'Impermanence Heron':              { sets: ['Moonlit Clouds'], buff: 'Spectro DMG', desc: 'A spectral crane-like Overlord. Skill transforms into Impermanence Heron dealing 310% Havoc DMG on dive; hold to spit flames (55% Havoc DMG each). Restores 10 Resonance Energy on hit and boosts next character\'s DMG by 12% for 15s after Outro.' },
  ...
  'Fallacy of No Return':            { sets: ['Rejuvenating Glow'], buff: 'Havoc DMG', desc: 'An otherworldly Overlord that bends reality. Skill blasts surrounding area for 15.86% Max HP Spectro DMG; hold to flurry at 1.58% Max HP per hit, ending with 19.82% Max HP. Grants +10% Energy Regen and +10% ATK to all team members for 20s.' },
  ...
  'Nightmare: Impermanence Heron':   { sets: ['Midnight Veil'], buff: 'Spectro DMG', desc: 'A nightmare variant of the spectral crane wreathed in prismatic energy. Skill transforms and delivers up to 10 strikes of 40% Havoc DMG each. Main slot grants +12% Havoc DMG and +12% Heavy ATK DMG passively.' },
  ...
  'Dragon of Dirge':                 { sets: ['Tidebreaking Courage'], buff: 'Spectro DMG', desc: 'A grieving dragon from the depths of Rinascita. Skill transforms and summons a Grief Rift lasting 5s, periodically dealing 36% Fusion DMG to enemies in the area. Main slot grants +12% Fusion DMG and +12% Basic ATK DMG.' },
  'Nightmare: Hecate':               { sets: ['Empyrean Anthem'], buff: 'Electro DMG', desc: 'A nightmare variant of the three-headed witch of the deep. Skill transforms into Nightmare Hecate, leaping up and smashing down for 3 stages of Havoc DMG (152% each). Main slot passively grants +12% Havoc DMG and +20% Echo Skill DMG.' },
  'Capitaneus':                      { sets: ['Eternal Radiance', 'Gusts of Welkin', 'Windward Pilgrimage'], buff: 'Aero DMG', desc: 'The supreme commander of the Order, carrying out judgment on transgressors. Skill summons Capitaneus to jump and smash for 118% Spectro DMG, generating 4 Merciless Judgements at 59% Spectro DMG each. Main slot grants +12% Spectro DMG and +12% Heavy ATK DMG.' },
  ...
  'Twin Nova: Nebulous Cannon':      { sets: ['Trailblazing Star', 'Chromatic Foam'], buff: 'Spectro DMG', desc: 'The ranged model of a Spacetrek Collective combat mech pair. Skill transforms to slash enemies twice for 80% Spectro DMG each. Main slot grants +12% Spectro DMG and +12% Basic ATK DMG. Pairing with Collapsar Blade enables combo attacks and Dyad Origins stacks (+10% Echo Skill DMG each, up to 6).' },
  ...
  'Spearback':                       { sets: ['Moonlit Clouds', 'Lingering Tunes'], buff: 'Electro DMG', desc: 'A ferocious bear-like beast covered in arrow-shaped Tacetite spines. Skill summons Spearback for 5 attacks: first 4 deal 29% Physical DMG each, final hit deals 51% Physical DMG.' },
  ...
  'Violet-Feathered Heron':          { sets: ['Molten Rift', 'Void Thunder'], buff: 'Fusion DMG', desc: 'A purple-winged heron that only spreads its wings in thunderstorms. Skill transforms into a Parry Stance; counterattack deals 288% Electro DMG. If attacked during parry, counters early and recovers 5 Concerto Energy.' },
  ...
  'Mist Avatar':                     { sets: ['Havoc Eclipse', 'Moonlit Clouds'], buff: 'Havoc DMG', desc: 'A shadowy humanoid Tacet Discord that creates illusory copies. Skill summons a Mist Avatar to taunt nearby targets, generating Mist Bullets that deal Aero DMG around it.' },
  ...
  'Dreamless':                       { sets: ['Havoc Eclipse', 'Midnight Veil'], buff: 'Havoc DMG', desc: 'A humanoid Calamity of pure Havoc tied to Rover\'s past. Skill transforms for 6 strikes: first 5 deal 54% Havoc DMG each, final hit deals 270% Havoc DMG. DMG increased by 50% within 5s of Rover: Havoc\'s Resonance Liberation.' },
  ...
  'Glacio Prism':                    { sets: ['Havoc Eclipse', 'Moonlit Clouds'], buff: 'Glacio DMG', desc: 'A mineral TD filled with freezing energy. Skill summons Glacio Prism to fire 3 crystal shards, each dealing 38% Glacio DMG.' },
  ...
  'Havoc Prism':                     { sets: ['Void Thunder', 'Celestial Light'], buff: 'Havoc DMG', desc: 'A mineral TD filled with Havoc energy. Skill summons Havoc Prism to fire 5 crystal shards, each dealing 23% Havoc DMG.' },
  ...
  'Lottie':                          { sets: ['Tidebreaking Courage', 'Frosty Resolve'], buff: 'Glacio DMG', desc: 'A small whimsical Tacet Discord that wanders aimlessly. Skill summons Lottie Lost to attack enemies dealing 129% Spectro DMG.' },
  'Chest Mimic':                     { sets: ['Empyrean Anthem', 'Frosty Resolve', 'Midnight Veil'], buff: 'Havoc DMG', desc: 'A deceptive Tacet Discord disguised as a treasure chest. Skill summons Chest Mimic to attack with 3 consecutive strikes, each dealing 64% Spectro DMG.' },
