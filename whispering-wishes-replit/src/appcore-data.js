...
const WEAPON_DATA = {
  ...
  'Sword#18': { rarity: 4, type: 'Sword', stat: 'ATK%', baseAtk: 387, subStatValue: '+36.4%',
    desc: 'Craftable sword from Huanglong. Heavy ATK synergy with HP sustain.',
    passive: 'HP <40%: Heavy ATK DMG +18%, restore 5% HP on Heavy ATK hit (8s CD)',
    bestFor: ['Danjin', 'Sword users'],
    ascensionMaterials: { forgery: 'Metallic Drip', common: 'Howler Core' } },
  'Gauntlets#21': { rarity: 4, type: 'Gauntlets', stat: 'Energy Regen', baseAtk: 337, subStatValue: '+51.8%',
    desc: 'Craftable gauntlets. Counter-focused playstyle with sustain.',
    passive: 'Dodge/counter boosts ATK and restores HP',
    bestFor: ['Jianxin', 'Gauntlet users'],
    ascensionMaterials: { forgery: 'Cadence', common: 'Howler Core' } },
  'Rectifier#25': { rarity: 4, type: 'Rectifier', stat: 'Energy Regen', baseAtk: 337, subStatValue: '+51.8%',
    desc: 'Craftable rectifier. Energy support with emergency healing.',
    passive: 'HP <60%: Resonance Skill restores 5% HP (8s CD)',
    bestFor: ['Rectifier users'],
    ascensionMaterials: { forgery: 'Helix', common: 'Ring' } },
  'Pistols#26': { rarity: 4, type: 'Pistols', stat: 'ATK%', baseAtk: 387, subStatValue: '+36.4%',
    desc: 'Craftable pistols. ATK boost with adaptive sustain.',
    passive: 'No damage taken: ATK buff. Damage taken: ATK buff + HP restore',
    bestFor: ['Pistol users'],
    ascensionMaterials: { forgery: 'Phlogiston', common: 'Ring' } },

  // ── 4★ Battle Pass Weapons (Hunter\'s Growl series) ──
  'Aureate Zenith': { rarity: 4, type: 'Broadblade', stat: 'Crit Rate', baseAtk: 412, subStatValue: '+24.3%',
    desc: 'Battle Pass broadblade. Liberation burst synergy.',
    passive: 'Liberation: ATK +7.2%, Heavy ATK DMG +10.8% for 15s',
    bestFor: ['Augusta', 'Broadblade users'],
    ascensionMaterials: { forgery: 'Waveworn Residue', common: 'Howler Core' } },
  'Radiant Dawn': { rarity: 4, type: 'Rectifier', stat: 'Crit Rate', baseAtk: 412, subStatValue: '+24.3%',
    desc: 'Battle Pass rectifier. Sustained DPS with repeatable buff windows.',
    passive: 'Resonance Skill: DMG bonus +12% for 15s',
    bestFor: ['Rectifier users'],
    ascensionMaterials: { forgery: 'Helix', common: 'Ring' } },
  'Aether Strike': { rarity: 4, type: 'Gauntlets', stat: 'Crit Rate', baseAtk: 412, subStatValue: '+24.3%',
    desc: 'Battle Pass gauntlets. Liberation burst cycle synergy.',
    passive: 'Liberation: ATK +7.2%, Resonance Skill DMG +10.8% for 15s',
    bestFor: ['Iuno', 'Gauntlet users'],
    ascensionMaterials: { forgery: 'Cadence', common: 'Howler Core' } },

  // ── 3★ Guardian Series (Craftable) ──
  'Guardian Sword': { rarity: 3, type: 'Sword', stat: 'HP%', baseAtk: 300, subStatValue: '+30.4%',
    desc: 'Craftable sword. Boosts Resonance Skill damage.',
    passive: 'Resonance Skill DMG +12%', bestFor: ['Sword users'],
    ascensionMaterials: { forgery: 'Metallic Drip', common: 'Howler Core' } },
  'Guardian Pistols': { rarity: 3, type: 'Pistols', stat: 'ATK%', baseAtk: 300, subStatValue: '+30.4%',
    desc: 'Craftable pistols. Boosts Resonance Skill damage.',
    passive: 'Resonance Skill DMG +12%', bestFor: ['Pistol users'],
    ascensionMaterials: { forgery: 'Phlogiston', common: 'Ring' } },
  'Guardian Gauntlets': { rarity: 3, type: 'Gauntlets', stat: 'DEF%', baseAtk: 300, subStatValue: '+38.5%',
    desc: 'Craftable gauntlets. Boosts Liberation damage.',
    passive: 'Resonance Liberation DMG +12%', bestFor: ['Gauntlet users'],
    ascensionMaterials: { forgery: 'Cadence', common: 'Howler Core' } },
  'Guardian Rectifier': { rarity: 3, type: 'Rectifier', stat: 'ATK%', baseAtk: 325, subStatValue: '+24.3%',
    desc: 'Craftable rectifier. Boosts Basic ATK and Heavy ATK damage.',
    passive: 'Basic ATK and Heavy ATK DMG +12%', bestFor: ['Rectifier users'],
    ascensionMaterials: { forgery: 'Helix', common: 'Ring' } },

  // ── 3★ Voyager Series ──
  'Sword of Voyager': { rarity: 3, type: 'Sword', stat: 'Energy Regen', baseAtk: 300, subStatValue: '+32.3%',
    desc: 'Energy support sword. Restores Resonance Energy on Skill use.',
    passive: 'Resonance Skill: +8 Resonance Energy (20s CD)', bestFor: ['Sword supports'],
    ascensionMaterials: { forgery: 'Metallic Drip', common: 'Howler Core' } },
  'Pistols of Voyager': { rarity: 3, type: 'Pistols', stat: 'ATK%', baseAtk: 300, subStatValue: '+30.4%',
    desc: 'Energy support pistols. Restores Resonance Energy on Skill use.',
    passive: 'Resonance Skill: +8 Resonance Energy (20s CD)', bestFor: ['Pistol supports'],
    ascensionMaterials: { forgery: 'Phlogiston', common: 'Ring' } },
  'Gauntlets of Voyager': { rarity: 3, type: 'Gauntlets', stat: 'DEF%', baseAtk: 325, subStatValue: '+30.8%',
    desc: 'Energy support gauntlets. Restores Resonance Energy on Skill use.',
    passive: 'Resonance Skill: +8 Resonance Energy (20s CD)', bestFor: ['Gauntlet supports'],
    ascensionMaterials: { forgery: 'Cadence', common: 'Howler Core' } },
  'Rectifier of Voyager': { rarity: 3, type: 'Rectifier', stat: 'Energy Regen', baseAtk: 300, subStatValue: '+32.3%',
    desc: 'Energy support rectifier. Restores Resonance Energy on Skill use.',
    passive: 'Resonance Skill: +8 Resonance Energy (20s CD)', bestFor: ['Rectifier supports'],
    ascensionMaterials: { forgery: 'Helix', common: 'Ring' } },
  'Broadblade of Voyager': { rarity: 3, type: 'Broadblade', stat: 'Energy Regen', baseAtk: 300, subStatValue: '+32.3%',
    desc: 'Energy support broadblade. Restores Resonance Energy on Skill use.',
    passive: 'Resonance Skill: +8 Resonance Energy (20s CD)', bestFor: ['Broadblade supports'],
    ascensionMaterials: { forgery: 'Waveworn Residue', common: 'Howler Core' } },

  // ── 3★ Night Series ──
  'Sword of Night': { rarity: 3, type: 'Sword', stat: 'ATK%', baseAtk: 325, subStatValue: '+24.3%',
    desc: 'Intro Skill synergy sword. ATK boost on character swap-in.',
    passive: 'Intro Skill: ATK +8% for 10s', bestFor: ['Sword users'],
    ascensionMaterials: { forgery: 'Metallic Drip', common: 'Howler Core' } },
  'Pistols of Night': { rarity: 3, type: 'Pistols', stat: 'ATK%', baseAtk: 325, subStatValue: '+24.3%',
    desc: 'Intro Skill synergy pistols. ATK boost on character swap-in.',
    passive: 'Intro Skill: ATK +8% for 10s', bestFor: ['Pistol users'],
    ascensionMaterials: { forgery: 'Phlogiston', common: 'Ring' } },
  'Gauntlets of Night': { rarity: 3, type: 'Gauntlets', stat: 'ATK%', baseAtk: 325, subStatValue: '+24.3%',
    desc: 'Intro Skill synergy gauntlets. ATK boost on character swap-in.',
    passive: 'Intro Skill: ATK +8% for 10s', bestFor: ['Gauntlet users'],
    ascensionMaterials: { forgery: 'Cadence', common: 'Howler Core' } },
  'Rectifier of Night': { rarity: 3, type: 'Rectifier', stat: 'ATK%', baseAtk: 325, subStatValue: '+24.3%',
    desc: 'Intro Skill synergy rectifier. ATK boost on character swap-in.',
    passive: 'Intro Skill: ATK +8% for 10s', bestFor: ['Rectifier users'],
    ascensionMaterials: { forgery: 'Helix', common: 'Ring' } },
  'Broadblade of Night': { rarity: 3, type: 'Broadblade', stat: 'ATK%', baseAtk: 325, subStatValue: '+24.3%',
    desc: 'Intro Skill synergy broadblade. ATK boost on character swap-in.',
    passive: 'Intro Skill: ATK +8% for 10s', bestFor: ['Broadblade users'],
    ascensionMaterials: { forgery: 'Waveworn Residue', common: 'Howler Core' } },

  // ── 3★ Originite Series ──
  'Originite: Type I': { rarity: 3, type: 'Broadblade', stat: 'DEF%', baseAtk: 300, subStatValue: '+38.5%',
    desc: 'Huaxu Academy broadblade. Heals on Resonance Skill use.',
    passive: 'Resonance Skill: heal 3% Max HP (12s CD)', bestFor: ['Broadblade users'],
    ascensionMaterials: { forgery: 'Waveworn Residue', common: 'Howler Core' } },
  'Originite: Type II': { rarity: 3, type: 'Sword', stat: 'ATK%', baseAtk: 325, subStatValue: '+24.3%',
    desc: 'Huaxu Academy sword. Heals on Liberation use.',
    passive: 'Resonance Liberation: heal 5% Max HP', bestFor: ['Sword users'],
    ascensionMaterials: { forgery: 'Metallic Drip', common: 'Howler Core' } },
  'Originite: Type III': { rarity: 3, type: 'Pistols', stat: 'ATK%', baseAtk: 325, subStatValue: '+24.3%',
    desc: 'Huaxu Academy pistols. Heals on Dodge Counter.',
    passive: 'Dodge Counter: heal 1.6% Max HP (6s CD)', bestFor: ['Pistol users'],
    ascensionMaterials: { forgery: 'Phlogiston', common: 'Ring' } },
  'Originite: Type IV': { rarity: 3, type: 'Gauntlets', stat: 'Crit DMG', baseAtk: 300, subStatValue: '+40.4%',
    desc: 'Huaxu Academy gauntlets. Heals on Basic ATK hit.',
    passive: 'Basic ATK: heal 0.5% Max HP (3s CD)', bestFor: ['Gauntlet users'],
    ascensionMaterials: { forgery: 'Cadence', common: 'Howler Core' } },
  'Originite: Type V': { rarity: 3, type: 'Rectifier', stat: 'HP%', baseAtk: 300, subStatValue: '+30.4%',
    desc: 'Huaxu Academy rectifier. Heals on Intro Skill.',
    passive: 'Intro Skill: heal 5% Max HP (20s CD)', bestFor: ['Rectifier users'],
    ascensionMaterials: { forgery: 'Helix', common: 'Ring' } },

  // ── 2★ Tyro Series ──
  'Tyro Sword': { rarity: 2, type: 'Sword', stat: 'ATK%', baseAtk: 200, subStatValue: '+18.2%',
    desc: 'Novice sword. Simple but effective early-game weapon.',
    passive: 'ATK +5%', bestFor: [] },
  'Tyro Rectifier': { rarity: 2, type: 'Rectifier', stat: 'ATK%', baseAtk: 200, subStatValue: '+18.2%',
    desc: 'Novice rectifier. Simple but effective early-game weapon.',
    passive: 'ATK +5%', bestFor: [] },
  'Tyro Gauntlets': { rarity: 2, type: 'Gauntlets', stat: 'ATK%', baseAtk: 200, subStatValue: '+18.2%',
    desc: 'Novice gauntlets. Simple but effective early-game weapon.',
    passive: 'ATK +5%', bestFor: [] },
  'Tyro Pistols': { rarity: 2, type: 'Pistols', stat: 'ATK%', baseAtk: 200, subStatValue: '+18.2%',
    desc: 'Novice pistols. Simple but effective early-game weapon.',
    passive: 'ATK +5%', bestFor: [] },

  // ── 1★ Training Series ──
  'Training Sword': { rarity: 1, type: 'Sword', stat: 'ATK%', baseAtk: 100, subStatValue: '+12.1%',
    desc: 'Starter sword. Basic training weapon for new Resonators.',
    passive: 'ATK +4%', bestFor: [] },
  'Training Rectifier': { rarity: 1, type: 'Rectifier', stat: 'ATK%', baseAtk: 100, subStatValue: '+12.1%',
    desc: 'Starter rectifier. Basic training weapon for new Resonators.',
    passive: 'ATK +4%', bestFor: [] },
  'Training Gauntlets': { rarity: 1, type: 'Gauntlets', stat: 'ATK%', baseAtk: 100, subStatValue: '+12.1%',
    desc: 'Starter gauntlets. Basic training weapon for new Resonators.',
    passive: 'ATK +4%', bestFor: [] },
  'Training Pistols': { rarity: 1, type: 'Pistols', stat: 'ATK%', baseAtk: 100, subStatValue: '+12.1%',
    desc: 'Starter pistols. Basic training weapon for new Resonators.',
    passive: 'ATK +4%', bestFor: [] },
};
