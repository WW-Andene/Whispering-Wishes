...
const CHARACTER_DATA = {
  ...
  'Yinlin': { rarity: 5, element: 'Electro', weapon: 'Rectifier', role: 'Sub DPS',
    ...
    skillMaterials: { weeklyDrop: 'Dreamless Feather', forgery: 'Cadence' },
  ...
  'Changli': { rarity: 5, element: 'Fusion', weapon: 'Sword', role: 'Sub DPS',
    ...
    skillMaterials: { weeklyDrop: "Sentinel's Dagger", forgery: 'Cadence' },
  ...
  'Phrolova': { rarity: 5, element: 'Havoc', weapon: 'Rectifier', role: 'Main DPS',
    ...
    skillMaterials: { weeklyDrop: 'Curse of the Abyss', forgery: 'Combustor' },
  ...
  'Iuno': { rarity: 5, element: 'Aero', weapon: 'Gauntlets', role: 'Sub DPS',
    ...
    skillMaterials: { weeklyDrop: 'Gold in Memory', forgery: 'Mask' },
...
const WEAPON_DATA = {
  ...
  'Verdant Summit': { rarity: 5, type: 'Broadblade', stat: 'Crit Rate',
    ...
    ascensionMaterials: { forgery: 'Helix', common: 'Howler Core' } },
  'Lustrous Razor': { rarity: 5, type: 'Broadblade', stat: 'ATK%',
    ...
    ascensionMaterials: { forgery: 'Cadence', common: 'Ring' } },
  'Emerald of Genesis': { rarity: 5, type: 'Sword', stat: 'Crit Rate',
    ...
    ascensionMaterials: { forgery: 'Helix', common: 'Whisperin Core' } },
  'Static Mist': { rarity: 5, type: 'Pistols', stat: 'Crit Rate',
    ...
    ascensionMaterials: { forgery: 'Cadence', common: 'Whisperin Core' } },
  ...
  'The Last Dance': { rarity: 5, type: 'Pistols', stat: 'Crit DMG',
    ...
    ascensionMaterials: { forgery: 'Metallic Drip', common: 'Polygon Core' } },
  'Tragicomedy': { rarity: 5, type: 'Gauntlets', stat: 'ATK%',
    ...
    ascensionMaterials: { forgery: 'Metallic Drip', common: 'Tidal Residuum' } },
  'Luminous Hymn': { rarity: 5, type: 'Rectifier', stat: 'Crit DMG',
    ...
    ascensionMaterials: { forgery: 'Phlogiston', common: 'Whisperin Core' } },
  ...
  'Whispers of Sirens': { rarity: 5, type: 'Rectifier', stat: 'Crit DMG',
    ...
    ascensionMaterials: { forgery: 'Phlogiston', common: 'Polygon Core' } },
  ...
  'Woodland Aria': { rarity: 5, type: 'Pistols', stat: 'Crit Rate',
    ...
    ascensionMaterials: { forgery: 'Phlogiston', common: 'Tidal Residuum' } },
  ...
  'Lethean Elegy': { rarity: 5, type: 'Rectifier', stat: 'ATK%',
    ...
    ascensionMaterials: { forgery: 'Combustor', common: 'Polygon Core' } },
  'Thunderflare Dominion': { rarity: 5, type: 'Broadblade', stat: 'Crit DMG',
    ...
    ascensionMaterials: { forgery: 'Combustor', common: 'Tidal Residuum' } },
  "Moongazer's Sigil": { rarity: 5, type: 'Gauntlets', stat: 'Energy Regen',
    ...
    ascensionMaterials: { forgery: 'Mask', common: 'Polygon Core' } },
  ...
  'Emerald Sentence': { rarity: 5, type: 'Sword', stat: 'Crit DMG',
    ...
    ascensionMaterials: { forgery: 'Mask', common: 'Whisperin Core' } },
  ...
  'Spectrum Blaster': { rarity: 5, type: 'Pistols', stat: 'Crit DMG',
    ...
    ascensionMaterials: { forgery: 'Waveworn Residue', common: 'Polygon Core' } },
