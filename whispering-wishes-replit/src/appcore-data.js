...
[
  ...
  ['Mourning Aix', 393, 'Spectro', { spectro: 30 }],
  ['Feilian Beringal', 514, 'Aero', { aero: 30 }],
  ['Tempest Mephis', 379, 'Electro', { electro: 30 }],
  ['Thundering Mephis', 453, 'Electro', { electro: 30 }],
  ['Inferno Rider', 806, 'Fusion', { fusion: 30 }],
  ['Bell-Borne Geochelone', 145, 'Glacio', { glacio: 30 }],
  ['Impermanence Heron', 420, 'Havoc', { havoc: 30 }],
  ['Lampylumen Myriad', 686, 'Glacio', { glacio: 30 }],
  ['Mech Abomination', 528, 'Electro', { electro: 30 }],
  ['Crownless', 435, 'Havoc', { havoc: 30 }],
  ['Jué', 287, 'Spectro', { spectro: 30 }],
  ['Fallacy of No Return', 0, 'Spectro', { spectro: 30 }],
  ['Sentry Construct', 810, 'Glacio', { glacio: 30 }],
  ['Dreamless', 540, 'Havoc', { havoc: 30 }],
  ['Nightmare: Impermanence Heron', 400, 'Havoc', { havoc: 30 }],
  ['Nightmare: Lampylumen Myriad', 273, 'Glacio', { glacio: 30 }],
  ['Dragon of Dirge', 180, 'Fusion', { fusion: 30 }],
  ['Nightmare: Hecate', 456, 'Havoc', { havoc: 30 }],
  ['Hecate', 553, 'Havoc', { havoc: 30 }],
  ['Nightmare: Crownless', 405, 'Havoc', { havoc: 30 }],
  ['Nightmare: Mourning Aix', 273, 'Spectro', { spectro: 30 }],
  ['Nightmare: Feilian Beringal', 269, 'Aero', { aero: 30 }],
  ['Nightmare: Inferno Rider', 688, 'Fusion', { fusion: 30 }],
  ['Nightmare: Tempest Mephis', 405, 'Electro', { electro: 30 }],
  ['Nightmare: Thundering Mephis', 405, 'Electro', { electro: 30 }],
  ['Reminiscence: Fleurdelys', 352, 'Aero', { aero: 20 }],
  ['Lioness of Glory', 273, 'Fusion', { fusion: 30 }],
  ['The False Sovereign', 625, 'Electro', { electro: 30 }],
  ['Lady of the Sea', 294, 'Aero', { aero: 30 }],
  ['Corrosaurus', 273, 'Fusion', { fusion: 30 }],
  ['Reminiscence: Threnodian - Leviathan', 454, 'Havoc', { havoc: 30 }],
  ['Hyvatia', 270, 'Spectro', { spectro: 20 }],
  ['Twin Nova - Nebulous Cannon', 160, 'Spectro', { spectro: 20 }],
  ['Sigillum', 273, 'Fusion', { fusion: 20 }],
  ['Reactor Husk', 553, 'Fusion', { fusion: 20 }],
  ['Nameless Explorer', 453, 'Aero', { aero: 20 }],
  ['Lorelei', 408, 'Havoc', { havoc: 30 }],
  ['Nightmare: Kelpie', 453, 'Glacio', { glacio: 30 }],
  ['Reminiscence: Fenrico', 459, 'Aero', { aero: 20 }],
  ['Capitaneus', 354, 'Spectro', null],
  // ── 3-Cost Echoes (Elites) ──
  ['Havoc Dreadmane', 309, 'Havoc', null],
  ['Lumiscale Construct', 553, 'Glacio', null],
  ['Tambourinist', 140, 'Havoc', null],
  ['Spearback', 167, 'Physical', null],
  ['Carapace', 280, 'Aero', null],
  ['Roseshroom', 171, 'Havoc', null],
  ['Violet-Feathered Heron', 288, 'Electro', null],
  ['Cyan-Feathered Heron', 236, 'Aero', null],
  ['Flautist', 530, 'Electro', null],
  ['Hoochief', 268, 'Aero', null],
  ['Stonewall Bracer', 280, 'Physical', null],
  ['Autopuppet Scout', 272, 'Glacio', null],
  ['Viridblaze Saurian', 170, 'Fusion', null],
  ['Glacio Dreadmane', 406, 'Glacio', null],
  ['Chasm Guardian', 273, 'Havoc', null],
  ['Abyssal Mercator', 288, 'Glacio', null],
  ['Twin Nova - Collapsar Blade', 336, 'Electro', null],
  ['Sabercat Prowler', 278, 'Fusion', null],
  ['Sabercat Reaver', 288, 'Fusion', null],
  ['Spacetrek Explorer', 0, 'Healing', null],
  ['Flora Reindeer', 268, 'Aero', null],
  ['Windlash Coleoid', 288, 'Aero', null],
  ['Frostbite Coleoid', 288, 'Glacio', null],
  ['Glommoth', 259, 'Glacio', null],
  ['Ironhoof', 288, 'Fusion', null],
  ['Mining Reindeer', 289, 'Electro', null],
  ['Reminiscence - Kronaclaw', 288, 'Aero', null],
  ['Kronablight', 300, 'Electro', null],
  ["Pilgrim's Shell", 288, 'Aero', null],
  ['Kerasaur', 288, 'Aero', null],
  ['Hurriclaw', 288, 'Aero', null],
  ['Nightmare: Viridblaze Saurian', 288, 'Fusion', null],
  ['Nightmare: Violet-Feathered Heron', 288, 'Electro', null],
  ['Nightmare: Cyan-Feathered Heron', 272, 'Aero', null],
  ['Nightmare: Roseshroom', 308, 'Havoc', null],
  ['Nightmare: Tambourinist', 288, 'Havoc', null],
  ['Diurnus Knight', 288, 'Spectro', null],
  ['Nocturnus Knight', 288, 'Havoc', null],
  ['Questless Knight', 288, 'Electro', null],
  ['Abyssal Gladius', 288, 'Glacio', null],
  ['Abyssal Patricius', 240, 'Glacio', null],
  ['Rage Against the Statue', 288, 'Spectro', null],
  ['Vitreum Dancer', 288, 'Electro', null],
  ['Cuddle Wuddle', 288, 'Physical', null],
  ['Chop Chop', 360, 'Fusion', null],
  ['Lightcrusher', 288, 'Spectro', null],
  ['Rocksteady Guardian', 36, 'Spectro', null],
  // ── 1-Cost Echoes ──
  ['Electro Predator', 114, 'Electro', null],
  ['Fusion Dreadmane', 96, 'Fusion', null],
  ['Lava Larva', 114, 'Fusion', null],
  ['Whiff Whaff', 165, 'Aero', null],
  ['Cruisewing', 0, 'Healing', null],
  ['Chirpuff', 114, 'Aero', null],
  ['Fusion Warrior', 288, 'Fusion', null],
  ['Havoc Warrior', 288, 'Havoc', null],
  ['Snip Snap', 96, 'Fusion', null],
  ['Zig Zag', 144, 'Spectro', null],
  ['Hooscamp', 144, 'Aero', null],
  ['Fusion Prism', 96, 'Fusion', null],
  ['Glacio Prism', 114, 'Glacio', null],
  ['Aero Prism', 19, 'Aero', null],
  ['Havoc Prism', 115, 'Havoc', null],
  ['Spectro Prism', 112, 'Spectro', null],
  ['Baby Viridblaze Saurian', 0, 'Healing', null],
  ['Young Roseshroom', 96, 'Havoc', null],
  ['Clang Bang', 96, 'Glacio', null],
  ['Dwarf Cassowary', 114, 'Physical', null],
  ['Excarat', 0, 'Physical', null],
  ['Lottie Lost', 129, 'Spectro', null],
  ['Chest Mimic', 192, 'Spectro', null],
  ['Aero Predator', 114, 'Aero', null],
  ['Glacio Predator', 114, 'Glacio', null],
  ['Gulpuff', 114, 'Glacio', null],
  ['Aero Drake', 96, 'Aero', null],
  ['Electro Drake', 96, 'Electro', null],
  ['Fusion Drake', 120, 'Fusion', null],
  ['Glacio Drake', 96, 'Glacio', null],
  ['Havoc Drake', 96, 'Havoc', null],
  ['Spectro Drake', 96, 'Spectro', null],
  ["Devotee's Flesh", 96, 'Aero', null],
  ['Sacerdos', 96, 'Aero', null],
  ['Sagittario', 84, 'Spectro', null],
  ['La Guardia', 96, 'Physical', null],
  ['Calcified Junrock', 0, 'Healing', null],
  ['Fission Junrock', 0, 'Healing', null],
  ['Golden Junrock', 96, 'Spectro', null],
  ['Vanguard Junrock', 96, 'Physical', null],
  ['Diamondclaw', 100, 'Physical', null],
  ['Diggy Duggy', 96, 'Physical', null],
  ['Fae Ignis', 95, 'Havoc', null],
  ['Frostscourge Stalker', 102, 'Glacio', null],
  ['Voltscourge Stalker', 96, 'Electro', null],
  ['Galescourge Stalker', 96, 'Aero', null],
  ['Hocus Pocus', 96, 'Havoc', null],
  ['Nimbus Wraith', 0, 'Healing', null],
  ['Hoartoise', 0, 'Healing', null],
  ['Sabyr Boar', 96, 'Physical', null],
  ['Traffic Illuminator', 96, 'Electro', null],
  ['Tick Tack', 96, 'Havoc', null],
  ['Chop Chop: Headless', 96, 'Fusion', null],
  ['Chop Chop: Leftless', 96, 'Spectro', null],
  ['Chop Chop: Rightless', 96, 'Havoc', null],
  ['Geospider S4', 96, 'Spectro', null],
  ['Flora Drone', 0, 'Healing', null],
  ['Mining Drone', 95, 'Havoc', null],
  ['Zip Zap', 113, 'Electro', null],
  ['Iceglint Dancer', 96, 'Glacio', null],
  ['Shadow Stepper', 96, 'Havoc', null],
  ['Tremor Warrior', 134, 'Electro', null],
  ['Nightmare: Aero Predator', 149, 'Aero', null],
  ['Nightmare: Electro Predator', 149, 'Electro', null],
  ['Nightmare: Glacio Predator', 149, 'Glacio', null],
  ['Nightmare: Baby Roseshroom', 182, 'Havoc', null],
  ['Nightmare: Baby Viridblaze Saurian', 182, 'Fusion', null],
  ['Nightmare: Chirpuff', 144, 'Aero', null],
  ['Nightmare: Dwarf Cassowary', 144, 'Physical', null],
  ['Nightmare: Gulpuff', 144, 'Glacio', null],
  ['Nightmare: Havoc Warrior', 336, 'Havoc', null],
  ['Nightmare: Tick Tack', 128, 'Havoc', null],
