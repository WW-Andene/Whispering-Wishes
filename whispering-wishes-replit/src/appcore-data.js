...
const ECHO_DATA = {
  ...
  'Nightmare: Hecate':               { sets: ['Dream of the Lost'], buff: 'Electro DMG', desc: 'A nightmare variant of the three-headed witch of the deep. Skill transforms into Nightmare Hecate, leaping up and smashing down for 3 stages of Havoc DMG (152% each). Main slot passively grants +12% Havoc DMG and +20% Echo Skill DMG.' },
