...
[
  ...
  ['Mourning Aix', 0, 'Spectro', { spectro: 40 }],
  ['Feilian Beringal', 0, 'Aero', { aero: 40 }],
  ['Tempest Mephis', 0, 'Electro', { electro: 40 }],
  ['Thundering Mephis', 0, 'Electro', { electro: 40 }],
  ['Inferno Rider', 0, 'Fusion', { fusion: 40 }],
  ['Bell-Borne Geochelone', 0, 'Glacio', { glacio: 40 }],
  ['Impermanence Heron', 0, 'Havoc', { havoc: 40 }],
  ['Lampylumen Myriad', 0, 'Glacio', { glacio: 40 }],
  ['Mech Abomination', 0, 'Electro', { electro: 40 }],
  ['Crownless', 0, 'Havoc', { havoc: 40 }],
  ['Jué', 0, 'Spectro', { spectro: 40 }],
  ['Fallacy of No Return', 0, 'Spectro', { spectro: 40 }],
  ['Sentry Construct', 0, 'Glacio', { glacio: 40 }],
  ['Dreamless', 0, 'Havoc', { havoc: 40 }],
  ['Nightmare: Impermanence Heron', 0, 'Havoc', { havoc: 40 }],
  ['Nightmare: Lampylumen Myriad', 0, 'Glacio', { glacio: 40 }],
  ['Dragon of Dirge', 0, 'Fusion', { fusion: 40 }],
  ['Nightmare: Hecate', 0, 'Havoc', { havoc: 40 }],
  ['Hecate', 0, 'Havoc', { havoc: 40 }],
  ['Nightmare: Crownless', 0, 'Havoc', { havoc: 40 }],
  ['Nightmare: Mourning Aix', 0, 'Spectro', { spectro: 40 }],
  ['Nightmare: Feilian Beringal', 0, 'Aero', { aero: 40 }],
  ['Nightmare: Inferno Rider', 0, 'Fusion', { fusion: 40 }],
  ['Nightmare: Tempest Mephis', 0, 'Electro', { electro: 40 }],
  ['Nightmare: Thundering Mephis', 0, 'Electro', { electro: 40 }],
  ['Reminiscence: Fleurdelys', 0, 'Aero', { aero: 40 }],
  ['Lioness of Glory', 0, 'Fusion', { fusion: 40 }],
  ['The False Sovereign', 0, 'Electro', { electro: 40 }],
  ['Lady of the Sea', 0, 'Aero', { aero: 40 }],
  ['Corrosaurus', 0, 'Fusion', { fusion: 40 }],
  ['Reminiscence: Threnodian - Leviathan', 0, 'Havoc', { havoc: 40 }],
  ['Hyvatia', 0, 'Spectro', { spectro: 40 }],
  ['Twin Nova - Nebulous Cannon', 0, 'Spectro', { spectro: 40 }],
  ['Sigillum', 0, 'Fusion', { fusion: 40 }],
  ['Reactor Husk', 0, 'Fusion', { fusion: 40 }],
  ['Nameless Explorer', 0, 'Aero', { aero: 40 }],
  ['Lorelei', 0, 'Havoc', { havoc: 40 }],
  ['Nightmare: Kelpie', 0, 'Glacio', { glacio: 40 }],
  ['Reminiscence: Fenrico', 0, 'Aero', { aero: 40 }],
  ['Capitaneus', 0, 'Spectro', null],
  // ── 3-Cost Echoes (Elites) ──
  ['Havoc Dreadmane', 0, 'Havoc', null],
  ['Lumiscale Construct', 0, 'Glacio', null],
  ['Tambourinist', 0, 'Havoc', null],
  ['Spearback', 0, 'Physical', null],
  ['Carapace', 0, 'Aero', null],
  ['Roseshroom', 0, 'Havoc', null],
  ['Violet-Feathered Heron', 0, 'Electro', null],
  ['Cyan-Feathered Heron', 0, 'Aero', null],
  ['Flautist', 0, 'Electro', null],
  ['Hoochief', 0, 'Aero', null],
  ['Stonewall Bracer', 0, 'Physical', null],
  ['Autopuppet Scout', 0, 'Glacio', null],
  ['Viridblaze Saurian', 0, 'Fusion', null],
  ['Glacio Dreadmane', 0, 'Glacio', null],
  ['Chasm Guardian', 0, 'Havoc', null],
  ['Abyssal Mercator', 0, 'Glacio', null],
  ['Twin Nova - Collapsar Blade', 0, 'Electro', null],
  ['Sabercat Prowler', 0, 'Fusion', null],
  ['Sabercat Reaver', 0, 'Fusion', null],
  ['Spacetrek Explorer', 0, 'Healing', null],
  ['Flora Reindeer', 0, 'Aero', null],
  ['Windlash Coleoid', 0, 'Aero', null],
  ['Frostbite Coleoid', 0, 'Glacio', null],
  ['Glommoth', 0, 'Glacio', null],
  ['Ironhoof', 0, 'Fusion', null],
  ['Mining Reindeer', 0, 'Electro', null],
  ['Reminiscence - Kronaclaw', 0, 'Aero', null],
  ['Kronablight', 0, 'Electro', null],
  ["Pilgrim's Shell", 288, 'Aero', null],
  ['Kerasaur', 0, 'Aero', null],
  ['Hurriclaw', 0, 'Aero', null],
  ['Nightmare: Viridblaze Saurian', 0, 'Fusion', null],
  ['Nightmare: Violet-Feathered Heron', 0, 'Electro', null],
  ['Nightmare: Cyan-Feathered Heron', 0, 'Aero', null],
  ['Nightmare: Roseshroom', 0, 'Havoc', null],
  ['Nightmare: Tambourinist', 0, 'Havoc', null],
  ['Diurnus Knight', 0, 'Spectro', null],
  ['Nocturnus Knight', 0, 'Havoc', null],
  ['Questless Knight', 0, 'Electro', null],
  ['Abyssal Gladius', 0, 'Glacio', null],
  ['Abyssal Patricius', 0, 'Glacio', null],
  ['Rage Against the Statue', 0, 'Spectro', null],
  ['Vitreum Dancer', 0, 'Electro', null],
  ['Cuddle Wuddle', 0, 'Physical', null],
  ['Chop Chop', 0, 'Fusion', null],
  ['Lightcrusher', 0, 'Spectro', null],
  ['Rocksteady Guardian', 0, 'Spectro', null],
  // ── 1-Cost Echoes ──
  ['Electro Predator', 0, 'Electro', null],
  ['Fusion Dreadmane', 0, 'Fusion', null],
  ['Lava Larva', 0, 'Fusion', null],
  ['Whiff Whaff', 0, 'Aero', null],
  ['Cruisewing', 0, 'Healing', null],
  ['Chirpuff', 0, 'Aero', null],
  ['Fusion Warrior', 0, 'Fusion', null],
  ['Havoc Warrior', 0, 'Havoc', null],
  ['Snip Snap', 0, 'Fusion', null],
  ['Zig Zag', 0, 'Spectro', null],
  ['Hooscamp', 0, 'Aero', null],
  ['Fusion Prism', 0, 'Fusion', null],
  ['Glacio Prism', 0, 'Glacio', null],
  ['Aero Prism', 0, 'Aero', null],
  ['Havoc Prism', 0, 'Havoc', null],
  ['Spectro Prism', 0, 'Spectro', null],
  ['Baby Viridblaze Saurian', 0, 'Healing', null],
  ['Young Roseshroom', 0, 'Havoc', null],
  ['Clang Bang', 0, 'Glacio', null],
  ['Dwarf Cassowary', 0, 'Physical', null],
  ['Excarat', 0, 'Physical', null],
  ['Lottie Lost', 0, 'Spectro', null],
  ['Chest Mimic', 0, 'Spectro', null],
  ['Aero Predator', 0, 'Aero', null],
  ['Glacio Predator', 0, 'Glacio', null],
  ['Gulpuff', 0, 'Glacio', null],
  ['Aero Drake', 0, 'Aero', null],
  ['Electro Drake', 0, 'Electro', null],
  ['Fusion Drake', 0, 'Fusion', null],
  ['Glacio Drake', 0, 'Glacio', null],
  ['Havoc Drake', 0, 'Havoc', null],
  ['Spectro Drake', 0, 'Spectro', null],
  ["Devotee's Flesh", 96, 'Aero', null],
  ['Sacerdos', 0, 'Aero', null],
  ['Sagittario', 0, 'Spectro', null],
  ['La Guardia', 0, 'Physical', null],
  ['Calcified Junrock', 0, 'Healing', null],
  ['Fission Junrock', 0, 'Healing', null],
  ['Golden Junrock', 0, 'Spectro', null],
  ['Vanguard Junrock', 0, 'Physical', null],
  ['Diamondclaw', 0, 'Physical', null],
  ['Diggy Duggy', 0, 'Physical', null],
  ['Fae Ignis', 0, 'Havoc', null],
  ['Frostscourge Stalker', 0, 'Glacio', null],
  ['Voltscourge Stalker', 0, 'Electro', null],
  ['Galescourge Stalker', 0, 'Aero', null],
  ['Hocus Pocus', 0, 'Havoc', null],
  ['Nimbus Wraith', 0, 'Healing', null],
  ['Hoartoise', 0, 'Healing', null],
  ['Sabyr Boar', 0, 'Physical', null],
  ['Traffic Illuminator', 0, 'Electro', null],
  ['Tick Tack', 0, 'Havoc', null],
  ['Chop Chop: Headless', 0, 'Fusion', null],
  ['Chop Chop: Leftless', 0, 'Spectro', null],
  ['Chop Chop: Rightless', 0, 'Havoc', null],
  ['Geospider S4', 0, 'Spectro', null],
  ['Flora Drone', 0, 'Healing', null],
  ['Mining Drone', 0, 'Havoc', null],
  ['Zip Zap', 0, 'Electro', null],
  ['Iceglint Dancer', 0, 'Glacio', null],
  ['Shadow Stepper', 0, 'Havoc', null],
  ['Tremor Warrior', 0, 'Electro', null],
  ['Nightmare: Aero Predator', 0, 'Aero', null],
  ['Nightmare: Electro Predator', 0, 'Electro', null],
  ['Nightmare: Glacio Predator', 0, 'Glacio', null],
  ['Nightmare: Baby Roseshroom', 0, 'Havoc', null],
  ['Nightmare: Baby Viridblaze Saurian', 0, 'Fusion', null],
  ['Nightmare: Chirpuff', 0, 'Aero', null],
  ['Nightmare: Dwarf Cassowary', 0, 'Physical', null],
  ['Nightmare: Gulpuff', 0, 'Glacio', null],
  ['Nightmare: Havoc Warrior', 0, 'Havoc', null],
  ['Nightmare: Tick Tack', 0, 'Havoc', null],
