...
const ECHO_DATA = {
  ...
  'Lava Larva':                      { sets: ['Molten Rift', 'Lingering Tunes'], buff: 'Fusion DMG', desc: 'A small molten creature that persistently burns. Skill summons Lava Larva to continuously attack enemies dealing 38% Fusion DMG per hit. Disappears when summoner switches out or moves too far.' , imageUrl: 'https://i.ibb.co/HLXTGZwZ/show-18.png'},
  ...
  'Cruisewing':                      { sets: ['Celestial Light', 'Rejuvenating Glow', 'Moonlit Clouds'], buff: 'Healing', desc: 'A gentle avian Tacet Discord. Skill summons Cruisewing to heal all team members for 1.8% Max HP + 80 HP, up to 4 times.' , imageUrl: 'https://i.ibb.co/mrn1KCwW/show-15.png'},
  ...
  'Fusion Prism':                    { sets: ['Freezing Frost', 'Molten Rift', 'Lingering Tunes'], buff: 'Fusion DMG', desc: 'A mineral TD filled with thermal energy. Skill summons Fusion Prism to fire a crystal shard dealing 32% + 64 Fusion DMG.' , imageUrl: 'https://i.ibb.co/gbw1jyD1/show-30.png'},
  'Glacio Prism':                    { sets: ['Freezing Frost', 'Havoc Eclipse', 'Moonlit Clouds'], buff: 'Glacio DMG', desc: 'A mineral TD filled with freezing energy. Skill summons Glacio Prism to fire 3 crystal shards, each dealing 38% Glacio DMG.' , imageUrl: 'https://i.ibb.co/SDH285Pc/show-29.png'},
  ...
  'Havoc Prism':                     { sets: ['Void Thunder', 'Celestial Light', 'Havoc Eclipse'], buff: 'Havoc DMG', desc: 'A mineral TD filled with Havoc energy. Skill summons Havoc Prism to fire 5 crystal shards, each dealing 23% Havoc DMG.' , imageUrl: 'https://i.ibb.co/4gZtg5nn/show-31.png'},
  'Spectro Prism':                   { sets: ['Molten Rift', 'Void Thunder', 'Celestial Light'], buff: 'Spectro DMG', desc: 'A mineral TD that emits Spectro light to buff nearby allies. Skill summons Spectro Prism to emit a laser hitting up to 8 times for 14% Spectro DMG each.' , imageUrl: 'https://i.ibb.co/tTWghQ5k/show-32.png'},
  'Baby Viridblaze Saurian':         { sets: ['Molten Rift', 'Void Thunder', 'Lingering Tunes'], buff: 'Fusion DMG', desc: 'A small amphibian-like creature found in forests. Skill transforms into Baby Viridblaze Saurian to rest in place and slowly restore HP.' , imageUrl: 'https://i.ibb.co/NdvTSMqn/show-11.png'},
  ...
  'Dwarf Cassowary':                 { sets: ['Sierra Gale', 'Rejuvenating Glow'], buff: 'Physical DMG', desc: 'A small flightless bird-like Tacet Discord. Skill summons Dwarf Cassowary to track and attack the enemy dealing 38% Physical DMG x3.' , imageUrl: 'https://i.ibb.co/gMqJ3BgQ/show-19.png'},
  ...
  'Lottie Lost':                     { sets: ['Tidebreaking Courage', 'Frosty Resolve'], buff: 'Spectro DMG', desc: 'A small whimsical Tacet Discord that wanders aimlessly. Skill summons Lottie Lost to attack enemies dealing 129% Spectro DMG.' , imageUrl: 'https://i.ibb.co/DfzWYrQx/show-40.png'},
  ...
  'Aero Drake':                      { sets: ['Tidebreaking Courage', 'Gusts of Welkin', 'Flaming Clawprint'], buff: 'Aero DMG', desc: 'A wind-elemental drake. Skill summons Aero Drake to swoop forward dealing 48% Aero DMG, then flap its wings to release a gust dealing 48% Aero DMG and knocking enemies back.' , imageUrl: 'https://i.ibb.co/Q72cVTkv/show-23.png'},
  'Electro Drake':                   { sets: ['Midnight Veil', 'Gusts of Welkin', 'Flaming Clawprint'], buff: 'Electro DMG', desc: 'A lightning-elemental drake. Skill summons Electro Drake to swoop forward dealing 48% Electro DMG, then discharge a bolt from its jaws dealing 48% Electro DMG that chains to 1 nearby enemy.' , imageUrl: 'https://i.ibb.co/N64L3hhD/show-24.png'},
  'Fusion Drake':                    { sets: ['Windward Pilgrimage', 'Flaming Clawprint'], buff: 'Fusion DMG', desc: 'A fire-elemental drake. Skill summons Fusion Drake to swoop forward dealing 48% Fusion DMG, then breathe a flame jet dealing 24% Fusion DMG x3.' , imageUrl: 'https://i.ibb.co/MDNfkd8C/show-26.png'},
  ...
  'Spectro Drake':                   { sets: ['Windward Pilgrimage', 'Flaming Clawprint'], buff: 'Spectro DMG', desc: 'A spectro-elemental drake. Skill summons Spectro Drake to swoop forward dealing 48% Spectro DMG, then fire a light beam dealing 48% Spectro DMG in a line.' , imageUrl: 'https://i.ibb.co/672Pj7yR/show-27.png'},
  ...
  'Diggy Duggy':                     { sets: ['Eternal Radiance', 'Tidebreaking Courage'], buff: 'Physical DMG', desc: 'A burrowing creature that attacks from underground. Skill summons Diggy Duggy to tunnel beneath the target and erupt upward dealing 96% Physical DMG, launching hit enemies airborne.' , imageUrl: 'https://i.ibb.co/5h2mJXR5/show-41.png'},
  'Fae Ignis':                       { sets: ['Eternal Radiance', 'Midnight Veil', 'Dream of the Lost'], buff: 'Havoc DMG', desc: 'A fairy flame creature flickering with dark fire. Skill summons Fae Ignis to orbit the Resonator for 5s, shooting will-o-wisps at nearby enemies dealing 19% Havoc DMG per hit, up to 5 hits.' , imageUrl: 'https://i.ibb.co/zH8vmSfM/show-37.png'},
  ...
  'Nimbus Wraith':                   { sets: ['Midnight Veil', 'Empyrean Anthem', "Flamewing's Shadow"], buff: 'Healing', desc: 'A cloud-like wraith that drifts through mist. Skill summons Nimbus Wraith to envelope the active Resonator in healing fog for 4s, restoring 1.0% Max HP + 50 per second.' , imageUrl: 'https://i.ibb.co/tpFvDp6x/show-38.png'},
  'Hoartoise':                       { sets: ['Freezing Frost', 'Celestial Light'], buff: 'Healing', desc: 'A hoary tortoise creature with a frost-covered shell. Skill summons Hoartoise to retract into its shell and emit a restorative aura, healing the active Resonator for 2.0% Max HP + 80.' , imageUrl: 'https://i.ibb.co/Tx5sZfc7/show-16.png'},
  'Sabyr Boar':                      { sets: ['Freezing Frost', 'Sierra Gale', 'Moonlit Clouds'], buff: 'Physical DMG', desc: 'A tusked boar creature that charges with reckless force. Skill summons Sabyr Boar to gore enemies with a charging headbutt dealing 96% Physical DMG. Hits from behind deal +25% bonus DMG.' , imageUrl: 'https://i.ibb.co/LXW0sxPK/show-12.png'},
  ...
  'Chop Chop: Headless':             { sets: ['Eternal Radiance', 'Tidebreaking Courage'], buff: 'Fusion DMG', desc: 'The headless body of Chop Chop, swinging blindly. Skill summons Chop Chop: Headless to flail its arms wildly dealing 24% Fusion DMG x4 in a wide arc around it.' , imageUrl: 'https://i.ibb.co/DPxd7hnh/show-34.png'},
  'Chop Chop: Leftless':             { sets: ['Frosty Resolve', 'Tidebreaking Courage'], buff: 'Spectro DMG', desc: 'Chop Chop missing its left arm, compensating with spectral energy. Skill summons Chop Chop: Leftless to deliver a right-arm overhead chop for 64% Spectro DMG, then fire a spectral bolt from its stump for 32% Spectro DMG.' , imageUrl: 'https://i.ibb.co/F4m58zj0/show-35.png'},
  ...
  'Nightmare: Aero Predator':        { sets: ['Crown of Valor'], buff: 'Aero DMG', desc: 'A nightmare variant of the Aero Predator with enhanced wind projectiles. Skill summons Nightmare: Aero Predator to shoot 5 times: first 4 deal 23% Aero DMG, last deals 57% Aero DMG.' , imageUrl: 'https://i.ibb.co/XZsKpLsF/show-65.png'},
  'Nightmare: Electro Predator':     { sets: ['Crown of Valor'], buff: 'Electro DMG', desc: 'A nightmare variant of the Electro Predator with overcharged bolts. Skill summons Nightmare: Electro Predator to shoot 5 times: first 4 deal 23% Electro DMG, last deals 57% Electro DMG.' , imageUrl: 'https://i.ibb.co/xtvhpyqw/show-70.png'},
  'Nightmare: Glacio Predator':      { sets: ['Dream of the Lost'], buff: 'Glacio DMG', desc: 'A nightmare variant of the Glacio Predator with piercing ice shards. Skill summons Nightmare: Glacio Predator to shoot 5 times: first 4 deal 23% Glacio DMG, last deals 57% Glacio DMG.' , imageUrl: 'https://i.ibb.co/LddgyQDf/show-71.png'},
  ...
  'Nightmare: Dwarf Cassowary':      { sets: ['Thread of Severed Fate'], buff: 'Physical DMG', desc: 'A nightmare variant of the Dwarf Cassowary with razor-edged feathers. Skill summons Nightmare: Dwarf Cassowary to track and kick the enemy dealing 48% Physical DMG x3.' , imageUrl: 'https://i.ibb.co/xpqtmS6/show-69.png'},
