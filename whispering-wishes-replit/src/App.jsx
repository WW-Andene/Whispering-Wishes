...
const BannerCard = ({ item, type, stats, bannerImage }) => {
  ...
  return (
    <div className={`relative overflow-hidden rounded-xl border ${style.border}`} style={{ minHeight: imgUrl ? '180px' : 'auto' }}>
      ...
      {imgUrl && <div className="absolute inset-0" style={{background: 'linear-gradient(to right, rgba(0,0,0,1) 5%, rgba(0,0,0,0.95) 10%, rgba(0,0,0,0.85) 15%, rgba(0,0,0,0.80) 20%, rgba(0,0,0,0.75) 25%, rgba(0,0,0,0.70) 30%, rgba(0,0,0,0.65) 35%, rgba(0,0,0,0.60) 40%, rgba(0,0,0,0.55) 45%, rgba(0,0,0,0) 50%)'}} />}
                ...
                <div className="relative overflow-hidden rounded-xl border border-cyan-500/30" style={{ minHeight: activeBanners.standardCharBannerImage ? '180px' : 'auto' }}>
                  {activeBanners.standardCharBannerImage && (
                    <>
                      ...
                      />
                      <div className="absolute inset-0" style={{background: 'linear-gradient(to right, rgba(0,0,0,1) 5%, rgba(0,0,0,0.95) 10%, rgba(0,0,0,0.85) 15%, rgba(0,0,0,0.80) 20%, rgba(0,0,0,0.75) 25%, rgba(0,0,0,0.70) 30%, rgba(0,0,0,0.65) 35%, rgba(0,0,0,0.60) 40%, rgba(0,0,0,0.55) 45%, rgba(0,0,0,0) 50%)'}} />
                    </>
                  )}
