...
const BannerCard = ({ item, type, stats, bannerImage }) => {
  ...
  return (
    <div className={`relative overflow-hidden rounded-xl border ${style.border}`} style={{ minHeight: imgUrl ? '180px' : 'auto' }}>
      ...
      {imgUrl && <div className="absolute inset-0" style={{background: 'linear-gradient(to right, rgba(0,0,0,1) 0%, rgba(0,0,0,0.80) 10%, rgba(0,0,0,0.60) 20%, rgba(0,0,0,0.50) 30%, rgba(0,0,0,0.30) 40%, rgba(0,0,0,0.10) 50%, rgba(0,0,0,0) 60%)'}} />}
                ...
                <div className="relative overflow-hidden rounded-xl border border-cyan-500/30" style={{ minHeight: activeBanners.standardCharBannerImage ? '180px' : 'auto' }}>
                  {activeBanners.standardCharBannerImage && (
                    <>
                      ...
                      />
                      <div className="absolute inset-0" style={{background: 'linear-gradient(to right, rgba(0,0,0,1) 0%, rgba(0,0,0,0.80) 10%, rgba(0,0,0,0.60) 20%, rgba(0,0,0,0.50) 30%, rgba(0,0,0,0.30) 40%, rgba(0,0,0,0.10) 50%, rgba(0,0,0,0) 60%)'}} />
                    </>
                  )}
