...
const TabBackground = ({ id, glowColor = 'neutral' }) => {
  return (
    <>
      {/* Dark deep blue base — uniform to prevent visible seams at scroll boundaries */}
      <div style={{ position:'fixed', inset:0, zIndex:0, pointerEvents:'none', background:'#020306' }} />
