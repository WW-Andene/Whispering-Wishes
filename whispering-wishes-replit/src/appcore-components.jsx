      ...
      // ===== BATTLEGROUND — ground-plan projected sword field =====
      {
        ...
        for (const s of swords) {
          ...
          for (var _si = 0; _si <= _nCuts; _si++) {
            ...
            var _floatAmp = (1.5 + _cr() * 2.5) * s.size * 0.01;
          ...
          for (var _shi = 0; _shi < _cuts.length; _shi++) {
            ...
            var _shFloat = Math.sin(cloudTime * 0.01 * (0.5 + _cr() * 0.5) + _cr() * Math.PI * 2) * (1 + _cr() * 2) * s.size * 0.01;
            _sy += _shFloat;
          ...
          for (var _sni = 0; _sni < _notchL.length; _sni++) {
            ...
            if (_cr() > 0.5) continue;
            var _nfL = Math.sin(cloudTime * 0.01 * (0.4 + _cr() * 0.5) + _cr() * Math.PI * 2) * (1 + _cr() * 1.5) * s.size * 0.01;
          ...
          for (var _sri2 = 0; _sri2 < _notchR.length; _sri2++) {
            ...
            if (_cr() > 0.5) continue;
            var _nfR = Math.sin(cloudTime * 0.01 * (0.4 + _cr() * 0.5) + _cr() * Math.PI * 2) * (1 + _cr() * 1.5) * s.size * 0.01;
