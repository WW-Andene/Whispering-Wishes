  ...
  useEffect(() => {
    ...
    const draw = (t) => {
      ...
      // ===== BATTLEGROUND — ground-plan projected sword field =====
      {
        ...
        {
          const total = H * 0.35;
          const bL = total * 0.65, bW = bL * 0.08;
          const gW2 = bW * 2.2, gH2 = bW * 0.4;
          const grH = total * 0.18, grW = bW * 0.7;
          const pR = bW * 0.9;
          ...
          // How deep blade is buried
          const bury = bL * 0.45;

          // Blade — left half
          ctx.fillStyle = 'rgb(170,165,150)';
          ctx.beginPath();
          ctx.moveTo(0, -bL + bury);
          ctx.lineTo(-bW * 0.2, -bL * 0.25 + bury);
          ctx.lineTo(-bW, -bL * 0.22 + bury);
          ctx.lineTo(-bW, bury);
          ctx.lineTo(0, bury);
          ctx.closePath();
          ctx.fill();
          ...
          // Ridge
          ctx.strokeStyle = 'rgba(210,205,190,0.4)';
          ...
          ctx.beginPath();
          ctx.ellipse(0, bury + gH2 / 2, gW2, gH2, 0, 0, Math.PI * 2);
          ctx.fill();

          // Grip
          ctx.fillStyle = 'rgb(35,18,10)';
          ctx.beginPath();
          ctx.moveTo(-grW, bury + gH2);
          ctx.quadraticCurveTo(-grW * 0.55, bury + gH2 + grH * 0.4, -grW * 0.75, bury + gH2 + grH * 0.5);
          ctx.quadraticCurveTo(-grW * 0.5, bury + gH2 + grH * 0.6, -grW * 0.7, bury + gH2 + grH);
          ctx.lineTo(grW * 0.7, bury + gH2 + grH);
          ctx.quadraticCurveTo(grW * 0.5, bury + gH2 + grH * 0.6, grW * 0.75, bury + gH2 + grH * 0.5);
          ctx.quadraticCurveTo(grW * 0.55, bury + gH2 + grH * 0.4, grW, bury + gH2);
          ctx.closePath();
          ctx.fill();

          // Pommel
          ctx.fillStyle = 'rgb(110,102,90)';
          ctx.beginPath();
          ctx.arc(0, bury + gH2 + grH + pR * 0.7, pR, 0, Math.PI * 2);
          ctx.fill();
