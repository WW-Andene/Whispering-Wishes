    ...
    const draw = (t) => {
      ...
      // ===== BATTLEGROUND — ground-plan projected sword field =====
      {
        ...
        for (const s of swords) {
          ...
          ctx.clip();
          var _sFloat = Math.sin(cloudTime * 0.008 + s.idx * 2.3) * overall * 0.018;
          ...
          for (var _si = 0; _si <= _nCuts; _si++) {
            ...
            var _floatAmp = overall * (0.015 + _cr() * 0.025);
          ...
          for (var _shi = 0; _shi < _cuts.length; _shi++) {
            ...
            var _shFloat = Math.sin(cloudTime * 0.01 * (0.5 + _cr() * 0.5) + _cr() * Math.PI * 2) * overall * (0.01 + _cr() * 0.02);
            _sy += _shFloat;
          ...
          for (var _sni = 0; _sni < _notchL.length; _sni++) {
            ...
            if (_cr() > 0.5) continue;
            var _nfL = Math.sin(cloudTime * 0.01 * (0.4 + _cr() * 0.5) + _cr() * Math.PI * 2) * overall * (0.01 + _cr() * 0.015);
          ...
          for (var _sri2 = 0; _sri2 < _notchR.length; _sri2++) {
            ...
            if (_cr() > 0.5) continue;
            var _nfR = Math.sin(cloudTime * 0.01 * (0.4 + _cr() * 0.5) + _cr() * Math.PI * 2) * overall * (0.01 + _cr() * 0.015);
