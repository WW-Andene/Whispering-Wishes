      ...
      // ===== BATTLEGROUND — ground-plan projected sword field =====
      {
        ...
        for (const s of swords) {
          ...
          for (var _sni = 0; _sni < _notchL.length; _sni++) {
            ...
            var _sw2 = Math.max(3, _sn2.h * 0.6);
            var _sh2 = Math.max(2, _sn2.d * 0.4);
            ctx.beginPath();
          ...
          for (var _sri2 = 0; _sri2 < _notchR.length; _sri2++) {
            ...
            var _swr2 = Math.max(3, _snr2.h * 0.6);
            var _shr2 = Math.max(2, _snr2.d * 0.4);
            ctx.beginPath();
            ctx.moveTo(_sxr2, _snr2.y + _snr2.h * 0.1);
            ctx.lineTo(_sxr2 - _shr2, _snr2.y + _snr2.h * 0.4);
