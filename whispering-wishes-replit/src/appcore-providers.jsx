...
const KuroStyles = memo(({ oledMode }) => (
  <style>{`
    ...
    *, *::before, *::after {
    ...
    /* OS reduced-motion is handled by the JS toggle (animationsEnabled defaults to 'off'
       when prefers-reduced-motion: reduce) which adds .no-animations class above.
       No CSS @media fallback here — it would conflict with the user's explicit toggle
       by permanently killing animations even after the user enables them. */
